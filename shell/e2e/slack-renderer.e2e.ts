...
test.describe('Slack renderer in Composer', () => {
  test('registers the Slack catalog and renders Button, Table, and MarketSnapshot Gallery usages', async ({
    ...
    await expect(page.locator('.usage-code')).toContainText('"component": "Button"');
    await expect(page.locator('.usage-code')).toContainText('"name": "acknowledge"');
    await expect(
    ...
    await expect(page.locator('.usage-code')).toContainText('"component": "Table"');
    ...
    await expect(page.locator('.usage-code')).toContainText('"component": "MarketSnapshot"');
    await expect(page.locator('.usage-code')).toContainText('Brent crude');
    await expect(
