...
describe('Events', () => {
  ...
  it('hydrates eventsLog with pre-existing SEND_TO_SERVER events from HostCommunication.consumeEnvelopeHistory()', async () => {
      ...
      providers: [
        provideNoopAnimations(),
        {
          ...
          useValue: {
            ...
            consumeEnvelopeHistory: () => historicalEnvelopes,
          },
        },
      ],
    }).compileComponents();
