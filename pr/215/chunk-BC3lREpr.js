import {_,V as an,s as se$1,g as gg,c as ct,$ as $Le,Y as _u,Z as LLe,a0 as Gt,a1 as na,a2 as ra,a3 as Up,q as ue$1,C as Cl,a4 as Hn,P as Pr,X,a5 as Xa,a6 as s,a7 as r,a8 as St,a9 as _y,aa as vy,E as Es,u as ud}from'./main.js';import {e}from'./chunk-CLNpRTgV.js';import {y,p,g,d}from'./chunk-BAoc1Dk-.js';var re=`[
  {
    "version": "v0.9",
    "createSurface": {
...
`;var P="updateComponents",F="components",ge="registerMockRules",ye="mockRulesConfig",ve="rules",Se="id",Ie="children",oe="mock_rules_container",R=class s{destroyRef=_(an);chatState=_(y);catalogManagement=_(se$1);startupConfigState=_(gg);previousCatalogId=null;isDraftModified=false;lastSynchronizedLayout=null;_activeDraft=ct("");activeDraft=this._activeDraft.asReadonly();_draftInput=ct("");constructor(){$Le(this.startupConfigState.selectedRendererId).pipe(_u(1),LLe(this.destroyRef)).subscribe(()=>{this.flushDraft();}),$Le(this.catalogManagement.activeCatalog).pipe(Gt(t=>!!t),LLe(this.destroyRef)).subscribe(t=>{let a=t.catalogId||t.$id||"",n=this.previousCatalogId===null,r=this.previousCatalogId!==null&&this.previousCatalogId!==a;if((n||r)&&!this.isDraftModified){let o=this.getInitialDraft(a);this._activeDraft.set(o),this._draftInput.set(o);}this.previousCatalogId=a;}),(this.startupConfigState.sharedA2uiPayload?$Le(this.startupConfigState.sharedA2uiPayload):na(null)).pipe(Gt(t=>!!t),LLe(this.destroyRef)).subscribe(t=>{this.injectExternalDraft(t);}),$Le(this._draftInput).pipe(_u(1),ra(300),Up(),LLe(this.destroyRef)).subscribe(t=>{this.syncLayoutToHistory(t);});}updateDraft(e){this.isDraftModified=true,this._activeDraft.set(e),this._draftInput.set(e);}injectExternalDraft(e){this.isDraftModified=true,this._activeDraft.set(e),this._draftInput.set(e);}syncActiveDraftToHistory(){this.syncLayoutToHistory(this._activeDraft());}hydrateActiveDraft(){return this._activeDraft()}commitLayoutFromLlm(e){this.isDraftModified=true,this.lastSynchronizedLayout=null,this._activeDraft.set(e);}flushDraft(){this.isDraftModified=false,this.lastSynchronizedLayout=null,this.previousCatalogId=null;let e=this.catalogManagement.activeCatalog(),t=e&&(e.catalogId||e.$id)||"";!this.startupConfigState.activeRenderer()?.samplePayload&&!t&&(t="https://a2ui.org/specification/v0_9/basic_catalog.json");let n=this.getInitialDraft(t);this._activeDraft.set(n),this._draftInput.set(n);}getInitialDraft(e){let t=this.startupConfigState.activeRenderer();return t?.samplePayload?t.samplePayload:e==="https://a2ui.org/specification/v0_9/basic_catalog.json"?re:e?p([{version:"v0.9",createSurface:{surfaceId:"sample-surface",catalogId:e,sendDataModel:true}}]):""}syncLayoutToHistory(e){if(e!==this._activeDraft())return;let t=this.sanitizeLayout(e);if(!t)return;let a=this.chatState.chatHistory();if(a.length>0&&t===this.lastSynchronizedLayout)return;if(this.lastSynchronizedLayout=t,a.length===0){this.chatState.setChatHistory([{role:"user",content:t}]);return}let n=a[a.length-1];if(n.role==="user"&&n.content.trim().startsWith("[")){let o=[...a];o[o.length-1]={role:"user",content:t},this.chatState.setChatHistory(o);}else this.chatState.updateChatHistory(o=>[...o,{role:"user",content:t}]);}sanitizeLayout(e){let t=e.trim();if(!t)return "";let a=g(t);if(a.success){let n=a.data.map(r=>r&&typeof r=="object"&&!Array.isArray(r)?this.sanitizeBlock(r):r).filter(r=>r!==null);return p(n)}return console.warn("[StateSync] Discarding malformed layout JSON during sanitization: not a valid JSON array"),""}sanitizeBlock(e){if(e[ge]||e[ye])return null;if(e[P]&&typeof e[P]=="object"&&e[P]!==null){let t=e[P];if(Array.isArray(t[F])){let a=t[F].filter(n=>n!==null&&typeof n=="object"&&!Array.isArray(n)?n[Se]!==oe:true);t[F]=a.map(n=>n!==null&&typeof n=="object"&&!Array.isArray(n)?this.sanitizeComponentObject(n):n);}}return e}sanitizeComponentObject(e){let t={};for(let[a,n]of Object.entries(e))a===ve||/^mock/i.test(a)||(a===Ie&&Array.isArray(n)?t[a]=n.filter(r=>r!==oe):n!==null&&typeof n=="object"&&!Array.isArray(n)?t[a]=this.sanitizeComponentObject(n):Array.isArray(n)?t[a]=n.map(r=>r!==null&&typeof r=="object"&&!Array.isArray(r)?this.sanitizeComponentObject(r):r):t[a]=n);return t}static \u0275fac=function(t){return new(t||s)};static \u0275prov=ue$1({token:s,factory:s.\u0275fac,providedIn:"root"})};var ie=/```(?:jsonl?|jsonlines|a2ui|html|xml)?\s*([\s\S]*?)\s*```/gi,se=/<(thought|thinking|reasoning)>([\s\S]*?)(?:<\/\1>|$)/gi,ce=/\s*●●●\s*$/g;function le(s){return s.length>0&&s.some(e=>{if(e&&typeof e=="object"&&!Array.isArray(e)){let t=Object.keys(e);return t.includes("version")||t.includes("createSurface")||t.includes("updateComponents")||t.includes("updateDataModel")||t.includes("deleteSurface")}return  false})}var E=class s{PULSE_INDICATOR="\u25CF\u25CF\u25CF";appendPulse(e){return `${e??""} ${this.PULSE_INDICATOR}`}stripPulse(e){return e?(ce.lastIndex=0,e.replace(ce,"").trim()):""}stripThinkingTags(e){return e?(se.lastIndex=0,e.replace(se,"").trim()):""}extractCodeFences(e){if(!e)return {extracted:"",hasFences:false};ie.lastIndex=0;let t=Array.from(e.matchAll(ie));return t.length>0?{extracted:t.map(a=>a[1].trim()).join(`
`),hasFences:true}:{extracted:e.trim(),hasFences:false}}cleanPayload(e){if(!e)return "";let t=this.stripPulse(e);if(t=this.stripThinkingTags(t),t=this.extractCodeFences(t).extracted,!t.startsWith("{")&&!t.startsWith("[")){let n=Array.from(t.matchAll(/[\{\[]/g));for(let r of n)if(r.index!==void 0&&r.index>=0){let o=t.substring(r.index).trim();if(o.startsWith("{")&&o.includes('"version"')||o.startsWith("[")&&/^\[\s*[\{\"]/.test(o)&&(o.includes('"version"')||o.includes('"createSurface"')||o.includes('"updateComponents"'))){t=o;break}let l=g(o);if(l.success&&le(l.data)){t=o;break}}}return t.trim()}isLayoutSnapshot(e){if(!e)return  false;let t=this.cleanPayload(e);if(t.startsWith('{"version"')||t.startsWith("{")&&t.includes('"version"')||t.startsWith("[")&&(t.includes('"version"')||t.includes('"createSurface"')||t.includes('"updateComponents"')))return  true;let a=g(t);return a.success&&le(a.data)}static \u0275fac=function(t){return new(t||s)};static \u0275prov=ue$1({token:s,factory:s.\u0275fac,providedIn:"root"})};function de(s){if(s==null||s.trim().length===0)return {success:true,isConversational:true,blocks:[],count:0};let e=g(s);if(e.success)return {success:true,isConversational:false,blocks:e.data,count:z(e.data)};let t=s.trim();if(t.startsWith("{")||t.startsWith("[")){let i=ue(s);if(i!==null&&typeof i=="object"){let c=Array.isArray(i)?i:[i];return {success:true,isConversational:false,blocks:c,count:z(c)}}}let n=s.split(`
`).map((i,c)=>({text:(i||"").trim(),originalIndex:c})).filter(i=>i.text.length>0),r=[],o=false,l=null;for(let i of n)if(!(i.text.startsWith("```")||!i.text.startsWith("{")&&!i.text.startsWith("["))){o=true;try{r.push(JSON.parse(i.text));}catch(c){let u=ue(i.text);if(u!==null)r.push(u);else if(!l){let d$1=d(c,i.text);l={success:false,error:c?.message??"Syntax recovery failed",line:i.originalIndex+1,column:d$1.column,snippet:i.text};}}}if(r.length===0){if(l)return l;if(o){let i=e.error;return {success:false,error:i?.message??"Syntax recovery failed",line:i?.line,column:i?.column,snippet:i?.snippet}}return {success:true,isConversational:true,blocks:[],count:0}}return {success:true,isConversational:false,blocks:r,count:z(r)}}function ue(s){if(s==null||s.trim().length===0)return null;let e=s.trim();if(e.length>256*1024)return null;e=e.replace(/,\s*([\]}])/g,"$1");try{return JSON.parse(e)}catch{for(let a=1;a<=5;a++)try{return JSON.parse(e+"}".repeat(a))}catch{}for(let a=1;a<=3;a++)for(let n=1;n<=3;n++)try{return JSON.parse(e+"}".repeat(a)+"]".repeat(n))}catch{}for(let a=1;a<=3;a++)for(let n=1;n<=3;n++)try{return JSON.parse(e+"]".repeat(a)+"}".repeat(n))}catch{}}return null}function be(s){if(!s||typeof s!="object")return  false;let e=s;if(!e.updateComponents||typeof e.updateComponents!="object")return  false;let t=e.updateComponents;return Array.isArray(t.components)}function pe(s,e){let t=false,a={};if(e)for(let r of Object.keys(e)){let o=r.toLowerCase().replace(/[^a-z]/g,"");a[o]=r;}let n={textbox:"textfield",textinput:"textfield",rowlayout:"row",columnlayout:"column",choice:"choicepicker",datepicker:"datetimeinput",datetimepicker:"datetimeinput"};for(let r of s){if(!be(r))continue;let o=r.updateComponents,l=[];for(let i of o.components){if(!i||typeof i!="object"||Array.isArray(i)){l.push(i);continue}let c=i,u=c.component;if(c.name&&!c.component&&(t=true,u=c.name,c.component=u,delete c.name),typeof u!="string")throw new Error("Component declaration is missing component type name string.");let d=u;if(e&&!e[u]){let p=u.toLowerCase().replace(/[^a-z]/g,""),g=a[p];if(!g){let f=n[p];f&&(g=a[f]);}if(g&&e[g])t=true,d=g;else {let f=p?Object.keys(e).find(k=>k.toLowerCase().includes(p)||p.includes(k.toLowerCase())):void 0;if(f)t=true,d=f;else throw new Error(`Validation failure: Component type "${u}" is not registered in the active custom catalog.`)}}let h=Ce(c);h.component=d,l.push(h);}o.components=l;}return t}function J(s){if(s===null||typeof s!="object")return s;if(Array.isArray(s))return s.map(a=>J(a));let e=s,t={};for(let[a,n]of Object.entries(e))a==="__proto__"||a==="constructor"||a==="prototype"||(t[a]=J(n));return t}function Ce(s){return J(s)}function z(s){return s.reduce((e,t)=>!t||typeof t!="object"?e:t.updateComponents&&Array.isArray(t.updateComponents.components)?e+t.updateComponents.components.length:t.createSurface?e+1:e,0)}var O=class s{catalogManagement=_(se$1);mcpManager=_(vy);localStorageInteractions=_(Es);customInstructionsState=ct(this.loadInitialState());presets=ud(()=>this.customInstructionsState().presets);activePresetId=ud(()=>this.customInstructionsState().activePresetId);activePreset=ud(()=>{let e=this.customInstructionsState();return e.presets.find(t=>t.id===e.activePresetId)??null});customInstructions=ud(()=>this.activePreset()?.content??"");hasCustomInstructions=ud(()=>this.customInstructions().trim().length>0);systemPrompt=ud(()=>{let e=this.catalogManagement.activeCatalog(),a=this.mcpManager.doesCatalogSupportMcp(e)?this.mcpManager.getActiveServersWithTools():[],n=this.buildMcpInstructions(a),r=this.customInstructions().trim(),o=r?`
...
${r}`:"";return e?(this.generateSystemPrompt(p(e))+n).trimEnd()+o:`
  ...
  ### Available MCP Tools
  ${Array.from(t.values()).map(r=>{let o=r.description?` - ${r.description}`:"",l=JSON.stringify(r.inputSchema||{type:"object",properties:{}}),i=JSON.stringify(r.outputSchema||a);return `- **\`${r.name}\`**${o}
  - **Input Schema**: \`${l}\`
  - **Output Schema**: \`${i}\``}).join(`
`)}
`}generateSystemPrompt(e$1){return `
  ...
  **IMPORTANT**: The component names used in the examples below (Column, Text,
  ...
  \`\`\`
  `}static \u0275fac=function(t){return new(t||s)};static \u0275prov=ue$1({token:s,factory:s.\u0275fac,providedIn:"root"})};var L=class s{isConnectivityError(e){return e?e.includes("failed to fetch")||e.includes("fetch")||e.includes("timeout")||e.includes("504")||e.includes("proxy")||e.includes("networkerror")||e.includes("connection")||e.includes("401")||e.includes("403")||e.includes("credential")||e.includes("quota")||e.includes("blocked")||e.includes("503")||e.includes("unavailable")||e.includes("api key")||e.includes("apikey"):false}parseError(e,t,a=false){let n=e??"",r=t??"",o="Connectivity Failure",l=r.trim().startsWith("{"),i=l?"A connectivity error occurred.":r,c=l?"Details: "+r:void 0,u="Tip: Please check your network proxy configurations or verify your settings to restore connections.",d=a,h=true,p=this.isConnectivityError(n);return n.includes("validation")||n.includes("syntax recovery")||n.includes("validation failure")?{errorTitle:"Validation Failure",errorMessage:"The generated layout contains invalid components or structure.",errorTip:"Tip: Try rephrasing your prompt to guide the model to generate valid components.",isRetryable:a,showDetails:true,errorDetails:"Details: "+r,isConnectivityFailure:p}:n.includes("503")||n.includes("unavailable")?{errorTitle:"Service Unavailable",errorMessage:"The generative service is temporarily unavailable. Please try again later.",errorTip:"",isRetryable:true,showDetails:false,isConnectivityFailure:p}:n.includes("high demand")?{errorTitle:"Model High Demand",errorMessage:"This model is currently experiencing high demand. Spikes in demand are usually temporary. Please try again later.",errorTip:"",isRetryable:true,showDetails:false,isConnectivityFailure:p}:n.includes("timeout")||n.includes("504")?{errorTitle:"REST Gateway Timeout",errorMessage:"Remote generation service did not respond.",errorDetails:"Details: "+r,errorTip:u,isRetryable:d,showDetails:true,isConnectivityFailure:p}:n.includes("api key")||n.includes("apikey")?{errorTitle:"Invalid API Key",errorMessage:"The provided Gemini API key is invalid or missing.",errorDetails:"Details: "+r,errorTip:"Tip: Please update your third-party Gemini developer API key on the settings page to restore connections.",isRetryable:d,showDetails:true,isConnectivityFailure:p}:n.includes("auth")||n.includes("401")||n.includes("403")||n.includes("credential")?{errorTitle:"Authentication Refused",errorMessage:"Authentication failed. Please verify your credentials in Settings.",errorDetails:"Details: "+r,errorTip:u,isRetryable:d,showDetails:true,isConnectivityFailure:p}:n.includes("quota")||n.includes("blocked")||n.includes("429")?{errorTitle:"GenAI Service Blocked",errorMessage:"Resource quota depleted or content safety limits triggered.",errorDetails:"Details: "+r,errorTip:u,isRetryable:d,showDetails:true,isConnectivityFailure:p}:{errorTitle:o,errorMessage:i,errorTip:u,isRetryable:d,showDetails:h,errorDetails:c,isConnectivityFailure:p}}static \u0275fac=function(t){return new(t||s)};static \u0275prov=ue$1({token:s,factory:s.\u0275fac,providedIn:"root"})};function me(s){let e=/^([a-zA-Z0-9_]*Error|[a-zA-Z0-9_]*Exception|API_KEY_INVALID)\s*(\[[^\]]+\])?:\s*/i,t=s.replace(e,"");if(t.startsWith("{"))try{let a=JSON.parse(t);if(a.error&&a.error.message)return a.error.message}catch{}return t}function N(s){if(!s)return s;let e=s.replace(/AIzaSy[A-Za-z0-9_-]+/g,"redacted for your protection");return e=e.replace(/(Invalid API key:\s*)(redacted for your protection|[A-Za-z0-9_-]+)/gi,(t,a,n)=>n.toLowerCase()==="redacted for your protection"?t:a+"redacted for your protection"),e=e.replace(/(API key:\s*)(redacted for your protection|[A-Za-z0-9_-]+)/gi,(t,a,n)=>n.toLowerCase()==="redacted for your protection"?t:a+"redacted for your protection"),e}var he=class s$1{catalogManagement=_(se$1);configProvider=_(Cl);stateSync=_(R);chatState=_(y);llmClient=_(Hn);errorLogger=_(Pr);chatCleaner=_(E);usageTrackingService=_(X);promptFactory=_(O);errorPresenter=_(L);pipelineStatus=this.chatState.pipelineStatus;isProgrammaticStreamActive=this.chatState.isProgrammaticStreamActive;currentTurnIndex=ct(0);systemPrompt=this.promptFactory.systemPrompt;activePromptId=null;constructor(){$Le(this.configProvider.rendererUrl).pipe(_u(1),LLe()).subscribe(()=>{queueMicrotask(()=>this.wipeEnvironmentCache());});}wipeEnvironmentCache(){this.currentTurnIndex.set(0),this.activePromptId=null,this.chatState.setChatHistory([]),this.finalizeStream("idle"),this.chatState.clearRawLlmHistory(),this.stateSync.flushDraft();}finalizeStream(e="idle"){this.chatState.setPipelineStatus(e),this.chatState.setProgrammaticStreamActive(false);}getFullMessageContext(){return [{role:"system",content:this.promptFactory.systemPrompt()},...this.chatState.chatHistory().filter(e=>e.role!=="error")]}activeStreamResponse;isCancelRequested=false;cancelActiveStream(){this.isCancelRequested=true,this.activePromptId&&this.usageTrackingService.trackChatCancel({promptId:this.activePromptId,turnIndex:this.currentTurnIndex(),pipelineStatus:this.pipelineStatus()}),this.activeStreamResponse&&this.activeStreamResponse.cancel&&this.activeStreamResponse.cancel();}emitPromptTracking(e,t,a){let n=!!a?.retryOfPromptId,r=a?.promptTurnIndex??this.currentTurnIndex()+1;this.currentTurnIndex.set(r);let o=this.catalogManagement.activeCatalog(),l=o&&(o.catalogId||o.$id)||"",i=t.some(u=>u.name==="screenshot.png"||u.mimeType?.startsWith("image/")),c=t.filter(u=>u.name!=="screenshot.png"&&!u.mimeType?.startsWith("image/"));return n?this.usageTrackingService.trackChatRetry({promptId:a?.promptId,catalogId:l,turnIndex:r,attemptNumber:2,retryOfPromptId:a?.retryOfPromptId}):this.usageTrackingService.trackChatPrompt({promptId:a?.promptId,catalogId:l,turnType:r===1?"initial":"followup",turnIndex:r,attemptNumber:1,hasScreenshot:i,attachmentCount:c.length})}async submitPrompt(e,t=[],a){if(this.chatState.isProgrammaticStreamActive()){console.warn("[ChatCoordinator] Blocked submitPrompt: programmatic stream is active.");return}let n=e.trim();if(!n&&t.length===0)return;this.stateSync.syncActiveDraftToHistory();let r$1=this.emitPromptTracking(n,t,a);this.activePromptId=r$1,this.chatState.setProgrammaticStreamActive(true),this.chatState.setPipelineStatus("receiving_stream"),this.chatState.updateChatHistory(l=>[...l,{role:"user",content:n,attachments:t.length>0?t:void 0,promptId:r$1}]);let o=this.getFullMessageContext();this.chatState.addRawLlmLog("LLM_REQUEST",o),this.chatState.updateChatHistory(l=>[...l,{role:"model",content:this.chatCleaner.appendPulse("")}]);try{this.isCancelRequested=!1;let l=await this.llmClient.chatStream(o);if(this.isCancelRequested){l.cancel&&l.cancel();let d=new Error("Cancelled");throw d.name=Xa,d}this.activeStreamResponse=l;let i="",c="";for await(let d of l.contentStream)i+=d.content,d.thinking&&(c+=d.thinking),this.chatState.updateChatHistory(h=>{let p=[...h],g=p.length-1;return p[g]?.role==="model"&&(p[g]={role:"model",content:this.chatCleaner.appendPulse(i),thinking:c}),p});let u=await l.complete;this.chatState.addRawLlmLog("LLM_RESPONSE",u),this.chatState.updateChatHistory(d=>{let h=[...d],p=h.length-1;return h[p]?.role==="model"&&(h[p]={role:"model",content:u,thinking:c}),h}),this.chatState.setPipelineStatus("received_raw"),await this.processRawLlmPayload(u,r$1);}catch(l){l&&typeof l=="object"&&"name"in l&&l.name===Xa?(this.finalizeStream("idle"),this.chatState.updateChatHistory(i=>{let c=[...i],u=c.length-1;return c[u]?.role==="model"&&(c[u]=s(r({},c[u]),{content:"*You stopped this response.*"})),c})):this.handleConnectivityError(l,n,t,r$1);}finally{this.activeStreamResponse=void 0;}}async processRawLlmPayload(e,t){let a=[],n=0;try{this.chatCleaner.extractCodeFences(e).hasFences&&this.chatState.setPipelineStatus("healing");let r$1=this.chatCleaner.cleanPayload(e),o=de(r$1);if(o.success&&o.isConversational){this.finalizeStream("idle");return}if(!o.success){let l=t?`[prompt:${t}] `:"";this.errorLogger.error({sourceTag:"[ChatParser]",message:`${l}${o.error}`,line:o.line,column:o.column,snippet:o.snippet}),this.chatState.updateChatHistory(i=>{let c=[...i],u=c.length-1;return c[u]?.role==="model"&&(c[u]=s(r({},c[u]),{parseError:o})),c}),this.finalizeStream("idle");return}a=o.blocks,n=o.count;}catch(r){throw this.finalizeStream("failed"),r}this.chatState.setPipelineStatus("validating");try{let r$1={type:St.RENDER_A2UI,payload:a},o=[];if(!_y.validateOutgoingMessage(r$1,o))throw new Error(`Outgoing message envelope validation failed:
${o.join(`
`)}`);pe(a,this.catalogManagement.activeCatalog()?.components)&&this.chatState.setPipelineStatus("healing"),a=this.resolveLayoutUpdate(a),this.chatState.setPipelineStatus("ready");let c=p(a);this.chatState.updateChatHistory(u=>{let d=[...u],h=d.length-1;return d[h]?.role==="model"&&(d[h]=s(r({},d[h]),{content:c,isSnapshot:!0,componentCount:n})),d}),this.stateSync.commitLayoutFromLlm(c),this.chatState.setProgrammaticStreamActive(!1);}catch(r){throw this.finalizeStream("failed"),r}}resolveLayoutUpdate(e){let t=(l,i)=>{if(!l||typeof l!="object"||!(i in l))return;let c=Reflect.get(l,i);return c&&typeof c=="object"&&"surfaceId"in c&&typeof c.surfaceId=="string"?c.surfaceId:void 0},a=e.some(l=>t(l,"createSurface")!==void 0),n=g(this.stateSync.activeDraft()),r=!a&&n.success?n.data:[],o=new Set;for(let l of r){let i=t(l,"createSurface"),c=t(l,"deleteSurface");i!==void 0&&o.add(i),c!==void 0&&o.delete(c);}for(let l of e){let i=t(l,"createSurface");i!==void 0&&o.add(i);for(let c of ["updateComponents","updateDataModel","deleteSurface"]){let u=t(l,c);if(u!==void 0&&!o.has(u))throw new Error(`Surface validation failed: cannot apply ${c}: surface "${u}" does not exist in the current draft. The draft was preserved.`);u!==void 0&&c==="deleteSurface"&&o.delete(u);}}return [...r,...e]}handleConnectivityError(e,t,a=[],n){let r$1=e instanceof Error?e.message:String(e),o=r$1.toLowerCase(),l=me(r$1);this.errorPresenter.isConnectivityError(o)?this.finalizeStream("idle"):this.finalizeStream("failed");let i=this.errorPresenter.parseError(o,l,!!t),c="";e instanceof Error?c="Exception: "+e.message+`
Stack: `+(e.stack||"None"):c="Unknown Exception: "+JSON.stringify(e);let u="";i.errorDetails&&(u+=i.errorDetails+`

`),u+=c;let d=N(i.errorMessage),h=i.showDetails?N(u):void 0,p=i.showDetails?N(i.errorTip):void 0;console.error("Gemini chat execution failed:",e),this.chatState.updateChatHistory(g=>{let f=[...g],k=f.length-1,H=r({role:"error",content:d,errorTitle:i.errorTitle,errorMessage:d,errorDetails:h,errorTip:p,promptId:n},i.isRetryable?{isRetryable:true,originalPrompt:t,attachments:a}:{});return k>=0&&f[k].role==="model"?(f[k]=H,f):(f.push(H),f)});}static \u0275fac=function(t){return new(t||s$1)};static \u0275prov=ue$1({token:s$1,factory:s$1.\u0275fac,providedIn:"root"})};export{E,O,R,be as b,de as d,he as h};