import {f,U as pe,a as fe,c as bc,K,V as zq,X as Uo,$ as $q,_ as ie,a0 as Wn,a1 as Gn,a2 as Bs,M,v as vo,a3 as Fn,a4 as Xc,n as ne,a5 as Xa,a6 as s,a7 as r$1,a8 as ge,a9 as Zc,aa as bx,ab as F$1,ac as Jf,ad as g$1,ae as Jt,af as Io,ag as He,ah as wr,ai as o3,aj as dn,ak as Sr,al as xo,am as ts,an as I,Q,u as G,ao as ns,ap as Cr,r as r_,z as dt$1,R as Ri,d as de,e as n_,h as Oe,Y as Yt,W as We,I as Ii,S as St$1,i as bf,t as Si,aq as So,ar as O,H as H$1,as as ac,A as ee,k,at as T,au as Rt$1,av as zt,aw as Ji,ax as Ie,ay as uo,o as ov,x as xt$1,J as Ja,G as Ge,az as Ai,F as ec,L as tc,P as Z,aA as _S,aB as wS,aC as em,aD as tm}from'./main.js';import {e}from'./chunk-CLNpRTgV.js';import {y,p,g,u}from'./chunk-B4VpqScK.js';function vt(r,n){if(r&1){let e=_S();Oe(0,"div",1)(1,"button",2),Ja("click",function(){em(e);let a=wS();return tm(a.action())}),Yt(2),We()();}if(r&2){let e=wS();St$1(2),bf(" ",e.data.action," ");}}var bt=["label"];function _t(r,n){}var St=Math.pow(2,31)-1,E=class{_overlayRef;instance;containerInstance;_afterDismissed=new T;_afterOpened=new T;_onAction=new T;_durationTimeoutId;_dismissedByAction=false;constructor(n,e){this._overlayRef=e,this.containerInstance=n,n._onExit.subscribe(()=>this._finishDismiss());}dismiss(){this._afterDismissed.closed||this.containerInstance.exit(),clearTimeout(this._durationTimeoutId);}dismissWithAction(){this._onAction.closed||(this._dismissedByAction=true,this._onAction.next(),this._onAction.complete(),this.dismiss()),clearTimeout(this._durationTimeoutId);}closeWithAction(){this.dismissWithAction();}_dismissAfter(n){this._durationTimeoutId=setTimeout(()=>this.dismiss(),Math.min(n,St));}_open(){this._afterOpened.closed||(this._afterOpened.next(),this._afterOpened.complete());}_finishDismiss(){this._overlayRef.dispose(),this._onAction.closed||this._onAction.complete(),this._afterDismissed.next({dismissedByAction:this._dismissedByAction}),this._afterDismissed.complete(),this._dismissedByAction=false;}afterDismissed(){return this._afterDismissed}afterOpened(){return this.containerInstance._onEnter}onAction(){return this._onAction}},rt=new g$1("MatSnackBarData"),A=class{politeness="polite";announcementMessage="";viewContainerRef;duration=0;panelClass;direction;data=null;horizontalPosition="center";verticalPosition="bottom"},kt=(()=>{class r{static \u0275fac=function(t){return new(t||r)};static \u0275dir=Z({type:r,selectors:[["","matSnackBarLabel",""]],hostAttrs:[1,"mat-mdc-snack-bar-label","mdc-snackbar__label"]})}return r})(),Ct=(()=>{class r{static \u0275fac=function(t){return new(t||r)};static \u0275dir=Z({type:r,selectors:[["","matSnackBarActions",""]],hostAttrs:[1,"mat-mdc-snack-bar-actions","mdc-snackbar__actions"]})}return r})(),It=(()=>{class r{static \u0275fac=function(t){return new(t||r)};static \u0275dir=Z({type:r,selectors:[["","matSnackBarAction",""]],hostAttrs:[1,"mat-mdc-snack-bar-action","mdc-snackbar__action"]})}return r})(),ot=(()=>{class r{snackBarRef=f(E);data=f(rt);action(){this.snackBarRef.dismissWithAction();}get hasAction(){return !!this.data.action}static \u0275fac=function(t){return new(t||r)};static \u0275cmp=de({type:r,selectors:[["simple-snack-bar"]],hostAttrs:[1,"mat-mdc-simple-snack-bar"],exportAs:["matSnackBar"],decls:3,vars:2,consts:[["matSnackBarLabel",""],["matSnackBarActions",""],["matButton","","matSnackBarAction","",3,"click"]],template:function(t,a){t&1&&(Oe(0,"div",0),Yt(1),We(),Ii(2,vt,3,1,"div",1)),t&2&&(St$1(),bf(" ",a.data.message,`
`),St$1(),Si(a.hasAction?2:-1));},dependencies:[n_,kt,Ct,It],styles:[`.mat-mdc-simple-snack-bar {
  display: flex;
}
...
`],encapsulation:2,changeDetection:1})}return r})(),At=new g$1("mat-snack-bar-default-options",{providedIn:"root",factory:()=>new A}),Dt=(()=>{class r{_live=f(bx);_injector=f(F$1);_breakpointObserver=f(Jf);_parentSnackBar=f(r,{optional:true,skipSelf:true});_defaultConfig=f(At);_animationsDisabled=Jt();_snackBarRefAtThisLevel=null;simpleSnackBarComponent=ot;snackBarContainerComponent=xt;handsetCssClass="mat-mdc-snack-bar-handset";get _openedSnackBarRef(){let e=this._parentSnackBar;return e?e._openedSnackBarRef:this._snackBarRefAtThisLevel}set _openedSnackBarRef(e){this._parentSnackBar?this._parentSnackBar._openedSnackBarRef=e:this._snackBarRefAtThisLevel=e;}openFromComponent(e,t){return this._attach(e,t)}openFromTemplate(e,t){return this._attach(e,t)}open(e,t="",a){let i=r$1(r$1({},this._defaultConfig),a);return i.data={message:e,action:t},i.announcementMessage===e&&(i.announcementMessage=void 0),this.openFromComponent(this.simpleSnackBarComponent,i)}dismiss(){this._openedSnackBarRef&&this._openedSnackBarRef.dismiss();}ngOnDestroy(){this._snackBarRefAtThisLevel&&this._snackBarRefAtThisLevel.dismiss();}_attachSnackBarContainer(e,t){let a=t&&t.viewContainerRef&&t.viewContainerRef.injector,i=F$1.create({parent:a||this._injector,providers:[{provide:A,useValue:t}]}),s=new Io(this.snackBarContainerComponent,t.viewContainerRef,i),o=e.attach(s);return o.instance.snackBarConfig=t,o.instance}_attach(e,t){let a=r$1(r$1(r$1({},new A),this._defaultConfig),t),i=this._createOverlay(a),s=this._attachSnackBarContainer(i,a),o=new E(s,i);if(e instanceof He){let c=new wr(e,null,{$implicit:a.data,snackBarRef:o});o.instance=s.attachTemplatePortal(c);}else {let c=this._createInjector(a,o),d=new Io(e,void 0,c),l=s.attachComponentPortal(d);o.instance=l.instance;}return this._breakpointObserver.observe(o3.HandsetPortrait).pipe(dn(i.detachments())).subscribe(c=>{i.overlayElement.classList.toggle(this.handsetCssClass,c.matches);}),a.announcementMessage&&s._onAnnounce.subscribe(()=>{this._live.announce(a.announcementMessage,a.politeness);}),this._animateSnackBar(o,a),this._openedSnackBarRef=o,this._openedSnackBarRef}_animateSnackBar(e,t){e.afterDismissed().subscribe(()=>{this._openedSnackBarRef==e&&(this._openedSnackBarRef=null),t.announcementMessage&&this._live.clear();}),t.duration&&t.duration>0&&e.afterOpened().subscribe(()=>e._dismissAfter(t.duration)),this._openedSnackBarRef?(this._openedSnackBarRef.afterDismissed().subscribe(()=>{e.containerInstance.enter();}),this._openedSnackBarRef.dismiss()):e.containerInstance.enter();}_createOverlay(e){let t=new Sr;t.direction=e.direction;let a=xo(this._injector),i=e.direction==="rtl",s=e.horizontalPosition==="left"||e.horizontalPosition==="start"&&!i||e.horizontalPosition==="end"&&i,o=!s&&e.horizontalPosition!=="center";return s?a.left("0"):o?a.right("0"):a.centerHorizontally(),e.verticalPosition==="top"?a.top("0"):a.bottom("0"),t.positionStrategy=a,t.disableAnimations=this._animationsDisabled,ts(this._injector,t)}_createInjector(e,t){let a=e&&e.viewContainerRef&&e.viewContainerRef.injector;return F$1.create({parent:a||this._injector,providers:[{provide:E,useValue:t},{provide:rt,useValue:e.data}]})}static \u0275fac=function(t){return new(t||r)};static \u0275prov=I({token:r,factory:r.\u0275fac})}return r})();var en=(()=>{class r{static \u0275fac=function(t){return new(t||r)};static \u0275mod=Q({type:r});static \u0275inj=G({providers:[Dt],imports:[ns,Cr,r_,ot,dt$1]})}return r})();var st=`[
  {
    "version": "v0.9",
    "createSurface": {
...
`;var U="updateComponents",se="components",Tt="registerMockRules",Rt="mockRulesConfig",Mt="rules",Et="id",Pt="children",ct="mock_rules_container",F=class r{destroyRef=f(pe);chatState=f(y);catalogManagement=f(fe);startupConfigState=f(bc);previousCatalogId=null;isDraftModified=false;lastSynchronizedLayout=null;_activeDraft=K("");activeDraft=this._activeDraft.asReadonly();_draftInput=K("");constructor(){zq(this.startupConfigState.selectedRendererId).pipe(Uo(1),$q(this.destroyRef)).subscribe(()=>{this.flushDraft();}),zq(this.catalogManagement.activeCatalog).pipe(ie(e=>!!e),$q(this.destroyRef)).subscribe(e=>{let t=e.catalogId||e.$id||"",a=this.previousCatalogId===null,i=this.previousCatalogId!==null&&this.previousCatalogId!==t;if((a||i)&&!this.isDraftModified){let s=this.getInitialDraft(t);this._activeDraft.set(s),this._draftInput.set(s);}this.previousCatalogId=t;}),(this.startupConfigState.sharedA2uiPayload?zq(this.startupConfigState.sharedA2uiPayload):Wn(null)).pipe(ie(e=>!!e),$q(this.destroyRef)).subscribe(e=>{this.injectExternalDraft(e);}),zq(this._draftInput).pipe(Uo(1),Gn(300),Bs(),$q(this.destroyRef)).subscribe(e=>{this.syncLayoutToHistory(e);});}updateDraft(n){this.isDraftModified=true,this._activeDraft.set(n),this._draftInput.set(n);}injectExternalDraft(n){this.isDraftModified=true,this._activeDraft.set(n),this._draftInput.set(n);}syncActiveDraftToHistory(){this.syncLayoutToHistory(this._activeDraft());}hydrateActiveDraft(){return this._activeDraft()}commitLayoutFromLlm(n){this.isDraftModified=true,this.lastSynchronizedLayout=null,this._activeDraft.set(n);}flushDraft(){this.isDraftModified=false,this.lastSynchronizedLayout=null,this.previousCatalogId=null;let n=this.catalogManagement.activeCatalog(),e=n&&(n.catalogId||n.$id)||"";!this.startupConfigState.activeRenderer()?.samplePayload&&!e&&(e="https://a2ui.org/specification/v0_9/basic_catalog.json");let a=this.getInitialDraft(e);this._activeDraft.set(a),this._draftInput.set(a);}getInitialDraft(n){let e=this.startupConfigState.activeRenderer();return e?.samplePayload?e.samplePayload:n==="https://a2ui.org/specification/v0_9/basic_catalog.json"?st:n?p([{version:"v0.9",createSurface:{surfaceId:"sample-surface",catalogId:n,sendDataModel:true}}]):""}syncLayoutToHistory(n){if(n!==this._activeDraft())return;let e=this.sanitizeLayout(n);if(!e)return;let t=this.chatState.chatHistory();if(t.length>0&&e===this.lastSynchronizedLayout)return;if(this.lastSynchronizedLayout=e,t.length===0){this.chatState.setChatHistory([{role:"user",content:e}]);return}let a=t[t.length-1];if(a.role==="user"&&a.content.trim().startsWith("[")){let s=[...t];s[s.length-1]={role:"user",content:e},this.chatState.setChatHistory(s);}else this.chatState.updateChatHistory(s=>[...s,{role:"user",content:e}]);}sanitizeLayout(n){let e=n.trim();if(!e)return "";let t=g(e);if(t.success){let a=t.data.map(i=>i&&typeof i=="object"&&!Array.isArray(i)?this.sanitizeBlock(i):i).filter(i=>i!==null);return p(a)}return console.warn("[StateSync] Discarding malformed layout JSON during sanitization: not a valid JSON array"),""}sanitizeBlock(n){if(n[Tt]||n[Rt])return null;if(n[U]&&typeof n[U]=="object"&&n[U]!==null){let e=n[U];if(Array.isArray(e[se])){let t=e[se].filter(a=>a!==null&&typeof a=="object"&&!Array.isArray(a)?a[Et]!==ct:true);e[se]=t.map(a=>a!==null&&typeof a=="object"&&!Array.isArray(a)?this.sanitizeComponentObject(a):a);}}return n}sanitizeComponentObject(n){let e={};for(let[t,a]of Object.entries(n))t===Mt||/^mock/i.test(t)||(t===Pt&&Array.isArray(a)?e[t]=a.filter(i=>i!==ct):a!==null&&typeof a=="object"&&!Array.isArray(a)?e[t]=this.sanitizeComponentObject(a):Array.isArray(a)?e[t]=a.map(i=>i!==null&&typeof i=="object"&&!Array.isArray(i)?this.sanitizeComponentObject(i):i):e[t]=a);return e}static \u0275fac=function(e){return new(e||r)};static \u0275prov=M({token:r,factory:r.\u0275fac,providedIn:"root"})};var lt=/```(?:jsonl?|jsonlines|a2ui|html|xml)?\s*([\s\S]*?)\s*```/gi,dt=/<(thought|thinking|reasoning)>([\s\S]*?)(?:<\/\1>|$)/gi,ut=/\s*●●●\s*$/g;function mt(r){return r.length>0&&r.some(n=>{if(n&&typeof n=="object"&&!Array.isArray(n)){let e=Object.keys(n);return e.includes("version")||e.includes("createSurface")||e.includes("updateComponents")||e.includes("updateDataModel")||e.includes("deleteSurface")}return  false})}var z=class r{PULSE_INDICATOR="\u25CF\u25CF\u25CF";appendPulse(n){return `${n??""} ${this.PULSE_INDICATOR}`}stripPulse(n){return n?(ut.lastIndex=0,n.replace(ut,"").trim()):""}stripThinkingTags(n){return n?(dt.lastIndex=0,n.replace(dt,"").trim()):""}extractCodeFences(n){if(!n)return {extracted:"",hasFences:false};lt.lastIndex=0;let e=Array.from(n.matchAll(lt));return e.length>0?{extracted:e.map(t=>t[1].trim()).join(`
`),hasFences:true}:{extracted:n.trim(),hasFences:false}}cleanPayload(n){if(!n)return "";let e=this.stripPulse(n);if(e=this.stripThinkingTags(e),e=this.extractCodeFences(e).extracted,!e.startsWith("{")&&!e.startsWith("[")){let a=Array.from(e.matchAll(/[\{\[]/g));for(let i of a)if(i.index!==void 0&&i.index>=0){let s=e.substring(i.index).trim();if(s.startsWith("{")&&s.includes('"version"')||s.startsWith("[")&&/^\[\s*[\{\"]/.test(s)&&(s.includes('"version"')||s.includes('"createSurface"')||s.includes('"updateComponents"'))){e=s;break}let o=g(s);if(o.success&&mt(o.data)){e=s;break}}}return e.trim()}isLayoutSnapshot(n){if(!n)return  false;let e=this.cleanPayload(n);if(e.startsWith('{"version"')||e.startsWith("{")&&e.includes('"version"')||e.startsWith("[")&&(e.includes('"version"')||e.includes('"createSurface"')||e.includes('"updateComponents"')))return  true;let t=g(e);return t.success&&mt(t.data)}static \u0275fac=function(e){return new(e||r)};static \u0275prov=M({token:r,factory:r.\u0275fac,providedIn:"root"})};function ht(r){if(r==null||r.trim().length===0)return {success:false,error:"No valid A2UI JSON layout command block could be parsed or recovered."};let n=g(r);if(n.success)return {success:true,isConversational:false,blocks:n.data,count:ce(n.data)};let e=r.trim();if(e.startsWith("{")||e.startsWith("[")){let o=pt(r);if(o!==null&&typeof o=="object"){let c=Array.isArray(o)?o:[o];return {success:true,isConversational:false,blocks:c,count:ce(c)}}}let a=r.split(`
`).map((o,c)=>({text:(o||"").trim(),originalIndex:c})).filter(o=>o.text.length>0),i=[],s=false;for(let o of a)if(!(o.text.startsWith("```")||!o.text.startsWith("{")&&!o.text.startsWith("["))){s=true;try{i.push(JSON.parse(o.text));}catch(c){let d=pt(o.text);if(d!==null)i.push(d);else {let l=u(c,o.text);return {success:false,error:c?.message??"Syntax recovery failed",line:o.originalIndex+1,column:l.column,snippet:o.text}}}}if(i.length===0){if(s){let o=n.error;return {success:false,error:o?.message??"Syntax recovery failed",line:o?.line,column:o?.column,snippet:o?.snippet}}return {success:true,isConversational:true,blocks:[],count:0}}return {success:true,isConversational:false,blocks:i,count:ce(i)}}function pt(r){if(r==null||r.trim().length===0)return null;let n=r.trim();n=n.replace(/,\s*([\]}])/g,"$1");try{return JSON.parse(n)}catch{for(let t=1;t<=5;t++)try{return JSON.parse(n+"}".repeat(t))}catch{}for(let t=1;t<=3;t++)for(let a=1;a<=3;a++)try{return JSON.parse(n+"}".repeat(t)+"]".repeat(a))}catch{}for(let t=1;t<=3;t++)for(let a=1;a<=3;a++)try{return JSON.parse(n+"]".repeat(t)+"}".repeat(a))}catch{}}return null}function Ot(r){if(!r||typeof r!="object")return  false;let n=r;if(!n.updateComponents||typeof n.updateComponents!="object")return  false;let e=n.updateComponents;return Array.isArray(e.components)}function ft(r,n){let e=false,t={};if(n)for(let i of Object.keys(n)){let s=i.toLowerCase().replace(/[^a-z]/g,"");t[s]=i;}let a={textbox:"textfield",textinput:"textfield",rowlayout:"row",columnlayout:"column",choice:"choicepicker",datepicker:"datetimeinput",datetimepicker:"datetimeinput"};for(let i of r){if(!Ot(i))continue;let s=i.updateComponents,o=[];for(let c of s.components){if(!c||typeof c!="object"||Array.isArray(c)){o.push(c);continue}let d=c,l=d.component;if(d.name&&!d.component&&(e=true,l=d.name,d.component=l,delete d.name),typeof l!="string")throw new Error("Component declaration is missing component type name string.");let m=l;if(n&&!n[l]){let p=l.toLowerCase().replace(/[^a-z]/g,""),g=t[p];if(!g){let f=a[p];f&&(g=t[f]);}if(g&&n[g])e=true,m=g;else {let f=p?Object.keys(n).find(I=>I.toLowerCase().includes(p)||p.includes(I.toLowerCase())):void 0;if(f)e=true,m=f;else throw new Error(`Validation failure: Component type "${l}" is not registered in the active custom catalog.`)}}let h=Lt(d);h.component=m,o.push(h);}s.components=o;}return e}function le(r){if(r===null||typeof r!="object")return r;if(Array.isArray(r))return r.map(t=>le(t));let n=r,e={};for(let[t,a]of Object.entries(n))t==="__proto__"||t==="constructor"||t==="prototype"||(e[t]=le(a));return e}function Lt(r){return le(r)}function ce(r){return r.reduce((n,e)=>!e||typeof e!="object"?n:e.updateComponents&&Array.isArray(e.updateComponents.components)?n+e.updateComponents.components.length:e.createSurface?n+1:n,0)}var H=class r{catalogManagement=f(fe);systemPrompt=Ri(()=>{let n=this.catalogManagement.activeCatalog();return n?this.generateSystemPrompt(p(n)):`
  ...
  **IMPORTANT**: The component names used in the examples below (Column, Text,
  ...
  \`\`\`
  `}static \u0275fac=function(e){return new(e||r)};static \u0275prov=M({token:r,factory:r.\u0275fac,providedIn:"root"})};var V=class r{isConnectivityError(n){return n?n.includes("failed to fetch")||n.includes("fetch")||n.includes("timeout")||n.includes("504")||n.includes("proxy")||n.includes("networkerror")||n.includes("connection")||n.includes("401")||n.includes("403")||n.includes("credential")||n.includes("quota")||n.includes("blocked")||n.includes("503")||n.includes("unavailable")||n.includes("api key")||n.includes("apikey"):false}parseError(n,e,t=false){let a=n??"",i=e??"",s="Connectivity Failure",o=i.trim().startsWith("{"),c=o?"A connectivity error occurred.":i,d=o?"Details: "+i:void 0,l="Tip: Please check your network proxy configurations or verify your settings to restore connections.",m=t,h=true,p=this.isConnectivityError(a);return a.includes("validation")||a.includes("syntax recovery")||a.includes("validation failure")?{errorTitle:"Validation Failure",errorMessage:"The generated layout contains invalid components or structure.",errorTip:"Tip: Try rephrasing your prompt to guide the model to generate valid components.",isRetryable:t,showDetails:true,errorDetails:"Details: "+i,isConnectivityFailure:p}:a.includes("503")||a.includes("unavailable")?{errorTitle:"Service Unavailable",errorMessage:"The generative service is temporarily unavailable. Please try again later.",errorTip:"",isRetryable:true,showDetails:false,isConnectivityFailure:p}:a.includes("high demand")?{errorTitle:"Model High Demand",errorMessage:"This model is currently experiencing high demand. Spikes in demand are usually temporary. Please try again later.",errorTip:"",isRetryable:true,showDetails:false,isConnectivityFailure:p}:a.includes("timeout")||a.includes("504")?{errorTitle:"REST Gateway Timeout",errorMessage:"Remote generation service did not respond.",errorDetails:"Details: "+i,errorTip:l,isRetryable:m,showDetails:true,isConnectivityFailure:p}:a.includes("api key")||a.includes("apikey")?{errorTitle:"Invalid API Key",errorMessage:"The provided Gemini API key is invalid or missing.",errorDetails:"Details: "+i,errorTip:"Tip: Please update your third-party Gemini developer API key on the settings page to restore connections.",isRetryable:m,showDetails:true,isConnectivityFailure:p}:a.includes("auth")||a.includes("401")||a.includes("403")||a.includes("credential")?{errorTitle:"Authentication Refused",errorMessage:"Authentication failed. Please verify your credentials in Settings.",errorDetails:"Details: "+i,errorTip:l,isRetryable:m,showDetails:true,isConnectivityFailure:p}:a.includes("quota")||a.includes("blocked")||a.includes("429")?{errorTitle:"GenAI Service Blocked",errorMessage:"Resource quota depleted or content safety limits triggered.",errorDetails:"Details: "+i,errorTip:l,isRetryable:m,showDetails:true,isConnectivityFailure:p}:{errorTitle:s,errorMessage:c,errorTip:l,isRetryable:m,showDetails:h,errorDetails:d,isConnectivityFailure:p}}static \u0275fac=function(e){return new(e||r)};static \u0275prov=M({token:r,factory:r.\u0275fac,providedIn:"root"})};function gt(r){let n=/^([a-zA-Z0-9_]*Error|[a-zA-Z0-9_]*Exception|API_KEY_INVALID)\s*(\[[^\]]+\])?:\s*/i,e=r.replace(n,"");if(e.startsWith("{"))try{let t=JSON.parse(e);if(t.error&&t.error.message)return t.error.message}catch{}return e}function J(r){if(!r)return r;let n=r.replace(/AIzaSy[A-Za-z0-9_-]+/g,"redacted for your protection");return n=n.replace(/(Invalid API key:\s*)(redacted for your protection|[A-Za-z0-9_-]+)/gi,(e,t,a)=>a.toLowerCase()==="redacted for your protection"?e:t+"redacted for your protection"),n=n.replace(/(API key:\s*)(redacted for your protection|[A-Za-z0-9_-]+)/gi,(e,t,a)=>a.toLowerCase()==="redacted for your protection"?e:t+"redacted for your protection"),n}var yt=class r{catalogManagement=f(fe);configProvider=f(vo);stateSync=f(F);chatState=f(y);llmClient=f(Fn);errorLogger=f(Xc);chatCleaner=f(z);usageTrackingService=f(ne);promptFactory=f(H);errorPresenter=f(V);pipelineStatus=this.chatState.pipelineStatus;isProgrammaticStreamActive=this.chatState.isProgrammaticStreamActive;currentTurnIndex=K(0);activePromptId=null;constructor(){zq(this.configProvider.rendererUrl).pipe(Uo(1),$q()).subscribe(()=>{queueMicrotask(()=>this.wipeEnvironmentCache());});}wipeEnvironmentCache(){this.currentTurnIndex.set(0),this.activePromptId=null,this.chatState.setChatHistory([]),this.chatState.setPipelineStatus("idle"),this.chatState.setProgrammaticStreamActive(false),this.chatState.clearRawLlmHistory(),this.stateSync.flushDraft();}getFullMessageContext(){return [{role:"system",content:this.promptFactory.systemPrompt()},...this.chatState.chatHistory().filter(n=>n.role!=="error")]}activeStreamResponse;isCancelRequested=false;cancelActiveStream(){this.isCancelRequested=true,this.activePromptId&&this.usageTrackingService.trackChatCancel({promptId:this.activePromptId,turnIndex:this.currentTurnIndex(),pipelineStatus:this.pipelineStatus()}),this.activeStreamResponse&&this.activeStreamResponse.cancel&&this.activeStreamResponse.cancel();}emitPromptTracking(n,e,t){let a=!!t?.retryOfPromptId,i=t?.promptTurnIndex??this.currentTurnIndex()+1;this.currentTurnIndex.set(i);let s=this.catalogManagement.activeCatalog(),o=s&&(s.catalogId||s.$id)||"",c=e.some(l=>l.name==="screenshot.png"||l.mimeType?.startsWith("image/")),d=e.filter(l=>l.name!=="screenshot.png"&&!l.mimeType?.startsWith("image/"));return a?this.usageTrackingService.trackChatRetry({promptId:t?.promptId,catalogId:o,turnIndex:i,attemptNumber:2,retryOfPromptId:t?.retryOfPromptId}):this.usageTrackingService.trackChatPrompt({promptId:t?.promptId,catalogId:o,turnType:i===1?"initial":"followup",turnIndex:i,attemptNumber:1,hasScreenshot:c,attachmentCount:d.length})}async submitPrompt(n,e=[],t){if(this.chatState.isProgrammaticStreamActive()){console.warn("[ChatCoordinator] Blocked submitPrompt: programmatic stream is active.");return}let a=n.trim();if(!a&&e.length===0)return;this.stateSync.syncActiveDraftToHistory();let i=this.emitPromptTracking(a,e,t);this.activePromptId=i,this.chatState.setProgrammaticStreamActive(true),this.chatState.setPipelineStatus("receiving_stream"),this.chatState.updateChatHistory(o=>[...o,{role:"user",content:a,attachments:e.length>0?e:void 0,promptId:i}]);let s$1=this.getFullMessageContext();this.chatState.addRawLlmLog("LLM_REQUEST",s$1),this.chatState.updateChatHistory(o=>[...o,{role:"model",content:this.chatCleaner.appendPulse("")}]);try{this.isCancelRequested=!1;let o=await this.llmClient.chatStream(s$1);if(this.isCancelRequested){o.cancel&&o.cancel();let m=new Error("Cancelled");throw m.name=Xa,m}this.activeStreamResponse=o;let c="",d="";for await(let m of o.contentStream)c+=m.content,m.thinking&&(d+=m.thinking),this.chatState.updateChatHistory(h=>{let p=[...h],g=p.length-1;return p[g]?.role==="model"&&(p[g]={role:"model",content:this.chatCleaner.appendPulse(c),thinking:d}),p});let l=await o.complete;this.chatState.addRawLlmLog("LLM_RESPONSE",l),this.chatState.updateChatHistory(m=>{let h=[...m],p=h.length-1;return h[p]?.role==="model"&&(h[p]={role:"model",content:l,thinking:d}),h}),this.chatState.setPipelineStatus("received_raw"),await this.processRawLlmPayload(l,i);}catch(o){o&&typeof o=="object"&&"name"in o&&o.name===Xa?(this.chatState.setPipelineStatus("idle"),this.chatState.setProgrammaticStreamActive(false),this.chatState.updateChatHistory(c=>{let d=[...c],l=d.length-1;return d[l]?.role==="model"&&(d[l]=s(r$1({},d[l]),{content:"*You stopped this response.*"})),d})):this.handleConnectivityError(o,a,e,i);}finally{this.activeStreamResponse=void 0;}}async processRawLlmPayload(n,e){let t=[];try{this.chatCleaner.extractCodeFences(n).hasFences&&this.chatState.setPipelineStatus("healing");let a=this.chatCleaner.cleanPayload(n),i=ht(a);if(i.success&&i.isConversational){this.chatState.setPipelineStatus("idle"),this.chatState.setProgrammaticStreamActive(!1);return}if(!i.success){this.errorLogger.error({sourceTag:"[ChatParser]",message:i.error,line:i.line,column:i.column,snippet:i.snippet}),this.chatState.updateChatHistory(s$1=>{let o=[...s$1],c=o.length-1;return o[c]?.role==="model"&&(o[c]=s(r$1({},o[c]),{parseError:i})),o}),this.chatState.setPipelineStatus("idle"),this.chatState.setProgrammaticStreamActive(!1);return}t=i.blocks;}catch(a){throw this.chatState.setPipelineStatus("failed"),this.chatState.setProgrammaticStreamActive(false),a}this.chatState.setPipelineStatus("validating");try{let a={type:ge.RENDER_A2UI,payload:t},i=[];if(!Zc.validateOutgoingMessage(a,i))throw new Error(`Outgoing message envelope validation failed:
${i.join(`
`)}`);ft(t,this.catalogManagement.activeCatalog()?.components)&&this.chatState.setPipelineStatus("healing"),t=this.resolveLayoutUpdate(t),this.chatState.setPipelineStatus("ready");let c=p(t);this.chatState.updateChatHistory(d=>{let l=[...d],m=l.length-1;return l[m]?.role==="model"&&(l[m]=s(r$1({},l[m]),{content:c})),l}),this.stateSync.commitLayoutFromLlm(c),this.chatState.setProgrammaticStreamActive(!1);}catch(a){throw this.chatState.setPipelineStatus("failed"),this.chatState.setProgrammaticStreamActive(false),a}}resolveLayoutUpdate(n){let e=(o,c)=>{if(!o||typeof o!="object"||!(c in o))return;let d=Reflect.get(o,c);return d&&typeof d=="object"&&"surfaceId"in d&&typeof d.surfaceId=="string"?d.surfaceId:void 0},t=n.some(o=>e(o,"createSurface")!==void 0),a=g(this.stateSync.activeDraft()),i=!t&&a.success?a.data:[],s=new Set;for(let o of i){let c=e(o,"createSurface"),d=e(o,"deleteSurface");c!==void 0&&s.add(c),d!==void 0&&s.delete(d);}for(let o of n){let c=e(o,"createSurface");c!==void 0&&s.add(c);for(let d of ["updateComponents","updateDataModel","deleteSurface"]){let l=e(o,d);if(l!==void 0&&!s.has(l))throw new Error(`Surface validation failed: cannot apply ${d}: surface "${l}" does not exist in the current draft. The draft was preserved.`);l!==void 0&&d==="deleteSurface"&&s.delete(l);}}return [...i,...n]}handleConnectivityError(n,e,t=[],a){let i=n instanceof Error?n.message:String(n),s=i.toLowerCase(),o=gt(i);this.errorPresenter.isConnectivityError(s)?this.chatState.setPipelineStatus("idle"):this.chatState.setPipelineStatus("failed"),this.chatState.setProgrammaticStreamActive(false);let c=this.errorPresenter.parseError(s,o,!!e),d="";n instanceof Error?d="Exception: "+n.message+`
Stack: `+(n.stack||"None"):d="Unknown Exception: "+JSON.stringify(n);let l="";c.errorDetails&&(l+=c.errorDetails+`

`),l+=d;let m=J(c.errorMessage),h=c.showDetails?J(l):void 0,p=c.showDetails?J(c.errorTip):void 0;console.error("Gemini chat execution failed:",n),this.chatState.updateChatHistory(g=>{let f=[...g],I=f.length-1,de=r$1({role:"error",content:m,errorTitle:c.errorTitle,errorMessage:m,errorDetails:h,errorTip:p,promptId:a},c.isRetryable?{isRetryable:true,originalPrompt:e,attachments:t}:{});return I>=0&&f[I].role==="model"?(f[I]=de,f):(f.push(de),f)});}systemPrompt=this.promptFactory.systemPrompt;static \u0275fac=function(e){return new(e||r)};static \u0275prov=M({token:r,factory:r.\u0275fac,providedIn:"root"})};export{Dt as D,F,Ot as O,en as e,ht as h,yt as y,z};