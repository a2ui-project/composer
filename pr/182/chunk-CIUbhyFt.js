import {f,a6 as pe,a as fe,h as hc,Y,ac as iq,aM as Hn,aN as gl,P as oq,aj as ce,aO as Po,ad as zn,ae as Os,T,b as fo,aP as Fn,n as ne,aQ as Xa,am as Z,an as _,V as ge,aR as zc,aS as $M,aT as P,aU as Kf,aV as y,aW as Zt,aX as bo,aY as Ve,aZ as _r,a_ as yG,a$ as an,b0 as wr,b1 as wo,b2 as qi,b3 as C,Q,r as q,b4 as Yi,b5 as Er,L as Lb,t as st$1,C as Ci,e as ue,F as Fb,A as Ae,W as Wt,H as He,v as vi,i as wt$1,m as mf,l as bi,b6 as _o,b7 as R,U as U$1,a8 as tc,J,d as O,ai as S,b8 as Mt$1,av as Ut,b9 as Wi,ba as De,aq as oo,K as Ky,S as St$1,q as qa,j as $e,bb as wi,D as Ya,E as Ka,G as K,aB as ZI,as as JI,aC as Qp,aD as Jp}from'./main.js';import {l,a,c}from'./chunk-BDDmS4bT.js';import {s}from'./chunk-D8BA0m4-.js';function ft(r,n){if(r&1){let e=ZI();Ae(0,"div",1)(1,"button",2),qa("click",function(){Qp(e);let a=JI();return Jp(a.action())}),Wt(2),He()();}if(r&2){let e=JI();wt$1(2),mf(" ",e.data.action," ");}}var gt=["label"];function yt(r,n){}var vt=Math.pow(2,31)-1,E=class{_overlayRef;instance;containerInstance;_afterDismissed=new S;_afterOpened=new S;_onAction=new S;_durationTimeoutId;_dismissedByAction=false;constructor(n,e){this._overlayRef=e,this.containerInstance=n,n._onExit.subscribe(()=>this._finishDismiss());}dismiss(){this._afterDismissed.closed||this.containerInstance.exit(),clearTimeout(this._durationTimeoutId);}dismissWithAction(){this._onAction.closed||(this._dismissedByAction=true,this._onAction.next(),this._onAction.complete(),this.dismiss()),clearTimeout(this._durationTimeoutId);}closeWithAction(){this.dismissWithAction();}_dismissAfter(n){this._durationTimeoutId=setTimeout(()=>this.dismiss(),Math.min(n,vt));}_open(){this._afterOpened.closed||(this._afterOpened.next(),this._afterOpened.complete());}_finishDismiss(){this._overlayRef.dispose(),this._onAction.closed||this._onAction.complete(),this._afterDismissed.next({dismissedByAction:this._dismissedByAction}),this._afterDismissed.complete(),this._dismissedByAction=false;}afterDismissed(){return this._afterDismissed}afterOpened(){return this.containerInstance._onEnter}onAction(){return this._onAction}},nt=new y("MatSnackBarData"),A=class{politeness="polite";announcementMessage="";viewContainerRef;duration=0;panelClass;direction;data=null;horizontalPosition="center";verticalPosition="bottom"},bt=(()=>{class r{static \u0275fac=function(t){return new(t||r)};static \u0275dir=K({type:r,selectors:[["","matSnackBarLabel",""]],hostAttrs:[1,"mat-mdc-snack-bar-label","mdc-snackbar__label"]})}return r})(),_t=(()=>{class r{static \u0275fac=function(t){return new(t||r)};static \u0275dir=K({type:r,selectors:[["","matSnackBarActions",""]],hostAttrs:[1,"mat-mdc-snack-bar-actions","mdc-snackbar__actions"]})}return r})(),kt=(()=>{class r{static \u0275fac=function(t){return new(t||r)};static \u0275dir=K({type:r,selectors:[["","matSnackBarAction",""]],hostAttrs:[1,"mat-mdc-snack-bar-action","mdc-snackbar__action"]})}return r})(),it=(()=>{class r{snackBarRef=f(E);data=f(nt);action(){this.snackBarRef.dismissWithAction();}get hasAction(){return !!this.data.action}static \u0275fac=function(t){return new(t||r)};static \u0275cmp=ue({type:r,selectors:[["simple-snack-bar"]],hostAttrs:[1,"mat-mdc-simple-snack-bar"],exportAs:["matSnackBar"],decls:3,vars:2,consts:[["matSnackBarLabel",""],["matSnackBarActions",""],["matButton","","matSnackBarAction","",3,"click"]],template:function(t,a){t&1&&(Ae(0,"div",0),Wt(1),He(),vi(2,ft,3,1,"div",1)),t&2&&(wt$1(),mf(" ",a.data.message,`
`),wt$1(),bi(a.hasAction?2:-1));},dependencies:[Fb,bt,_t,kt],styles:[`.mat-mdc-simple-snack-bar {
  display: flex;
}
...
`],encapsulation:2})}return r})(),ie="_mat-snack-bar-enter",re="_mat-snack-bar-exit",St=(()=>{class r extends _o{_ngZone=f(R);_elementRef=f(U$1);_changeDetectorRef=f(tc);_platform=f(J);_animationsDisabled=Zt();snackBarConfig=f(A);_document=f(O);_trackedModals=new Set;_enterFallback;_exitFallback;_injector=f(P);_announceDelay=150;_announceTimeoutId;_destroyed=false;_portalOutlet;_onAnnounce=new S;_onExit=new S;_onEnter=new S;_animationState="void";_live;_label;_role;_liveElementId=f(Mt$1).getId("mat-snack-bar-container-live-");constructor(){super();let e=this.snackBarConfig;e.politeness==="assertive"&&!e.announcementMessage?this._live="assertive":e.politeness==="off"?this._live="off":this._live="polite",this._platform.FIREFOX&&(this._live==="polite"&&(this._role="status"),this._live==="assertive"&&(this._role="alert"));}attachComponentPortal(e){this._assertNotAttached();let t=this._portalOutlet.attachComponentPortal(e);return this._afterPortalAttached(),t}attachTemplatePortal(e){this._assertNotAttached();let t=this._portalOutlet.attachTemplatePortal(e);return this._afterPortalAttached(),t}attachDomPortal=e=>{this._assertNotAttached();let t=this._portalOutlet.attachDomPortal(e);return this._afterPortalAttached(),t};onAnimationEnd(e){e===re?this._completeExit():e===ie&&(clearTimeout(this._enterFallback),this._ngZone.run(()=>{this._onEnter.next(),this._onEnter.complete();}));}enter(){this._destroyed||(this._animationState="visible",this._changeDetectorRef.markForCheck(),this._changeDetectorRef.detectChanges(),this._screenReaderAnnounce(),this._animationsDisabled?Ut(()=>{this._ngZone.run(()=>queueMicrotask(()=>this.onAnimationEnd(ie)));},{injector:this._injector}):(clearTimeout(this._enterFallback),this._enterFallback=setTimeout(()=>{this._elementRef.nativeElement.classList.add("mat-snack-bar-fallback-visible"),this.onAnimationEnd(ie);},200)));}exit(){return this._destroyed?Hn(void 0):(this._ngZone.run(()=>{this._animationState="hidden",this._changeDetectorRef.markForCheck(),this._elementRef.nativeElement.setAttribute("mat-exit",""),clearTimeout(this._announceTimeoutId),this._animationsDisabled?Ut(()=>{this._ngZone.run(()=>queueMicrotask(()=>this.onAnimationEnd(re)));},{injector:this._injector}):(clearTimeout(this._exitFallback),this._exitFallback=setTimeout(()=>this.onAnimationEnd(re),200));}),this._onExit)}ngOnDestroy(){this._destroyed=true,this._clearFromModals(),this._completeExit();}_completeExit(){clearTimeout(this._exitFallback),queueMicrotask(()=>{this._onExit.next(),this._onExit.complete();});}_afterPortalAttached(){let e=this._elementRef.nativeElement,t=this.snackBarConfig.panelClass;t&&(Array.isArray(t)?t.forEach(o=>e.classList.add(o)):e.classList.add(t)),this._exposeToModals();let a=this._label.nativeElement,i="mdc-snackbar__label";a.classList.toggle(i,!a.querySelector(`.${i}`));}_exposeToModals(){let e=this._liveElementId,t=this._document.querySelectorAll('body > .cdk-overlay-container [aria-modal="true"]');for(let a=0;a<t.length;a++){let i=t[a],o=i.getAttribute("aria-owns");this._trackedModals.add(i),o?o.indexOf(e)===-1&&i.setAttribute("aria-owns",o+" "+e):i.setAttribute("aria-owns",e);}}_clearFromModals(){this._trackedModals.forEach(e=>{let t=e.getAttribute("aria-owns");if(t){let a=t.replace(this._liveElementId,"").trim();a.length>0?e.setAttribute("aria-owns",a):e.removeAttribute("aria-owns");}}),this._trackedModals.clear();}_assertNotAttached(){this._portalOutlet.hasAttached();}_screenReaderAnnounce(){this._announceTimeoutId||this._ngZone.runOutsideAngular(()=>{this._announceTimeoutId=setTimeout(()=>{if(this._destroyed)return;let e=this._elementRef.nativeElement,t=e.querySelector("[aria-hidden]"),a=e.querySelector("[aria-live]");if(t&&a){let i=null;this._platform.isBrowser&&document.activeElement instanceof HTMLElement&&t.contains(document.activeElement)&&(i=document.activeElement),t.removeAttribute("aria-hidden"),a.appendChild(t),i?.focus(),this._onAnnounce.next(),this._onAnnounce.complete();}},this._announceDelay);});}static \u0275fac=function(t){return new(t||r)};static \u0275cmp=ue({type:r,selectors:[["mat-snack-bar-container"]],viewQuery:function(t,a){if(t&1&&wi(Wi,7)(gt,7),t&2){let i;Ya(i=Ka())&&(a._portalOutlet=i.first),Ya(i=Ka())&&(a._label=i.first);}},hostAttrs:[1,"mdc-snackbar","mat-mdc-snack-bar-container"],hostVars:6,hostBindings:function(t,a){t&1&&qa("animationend",function(o){return a.onAnimationEnd(o.animationName)})("animationcancel",function(o){return a.onAnimationEnd(o.animationName)}),t&2&&$e("mat-snack-bar-container-enter",a._animationState==="visible")("mat-snack-bar-container-exit",a._animationState==="hidden")("mat-snack-bar-container-animations-enabled",!a._animationsDisabled);},features:[De],decls:6,vars:3,consts:[["label",""],[1,"mdc-snackbar__surface","mat-mdc-snackbar-surface"],[1,"mat-mdc-snack-bar-label"],["aria-hidden","true"],["cdkPortalOutlet",""]],template:function(t,a){t&1&&(Ae(0,"div",1)(1,"div",2,0)(3,"div",3),oo(4,yt,0,0,"ng-template",4),He(),Ky(5,"div"),He()()),t&2&&(wt$1(5),St$1("aria-live",a._live)("role",a._role)("id",a._liveElementId));},dependencies:[Wi],styles:[`@keyframes _mat-snack-bar-enter {
  from {
    transform: scale(0.8);
    opacity: 0;
  }
...
`],encapsulation:2,changeDetection:1})}return r})(),Ct=new y("mat-snack-bar-default-options",{providedIn:"root",factory:()=>new A}),It=(()=>{class r{_live=f($M);_injector=f(P);_breakpointObserver=f(Kf);_parentSnackBar=f(r,{optional:true,skipSelf:true});_defaultConfig=f(Ct);_animationsDisabled=Zt();_snackBarRefAtThisLevel=null;simpleSnackBarComponent=it;snackBarContainerComponent=St;handsetCssClass="mat-mdc-snack-bar-handset";get _openedSnackBarRef(){let e=this._parentSnackBar;return e?e._openedSnackBarRef:this._snackBarRefAtThisLevel}set _openedSnackBarRef(e){this._parentSnackBar?this._parentSnackBar._openedSnackBarRef=e:this._snackBarRefAtThisLevel=e;}openFromComponent(e,t){return this._attach(e,t)}openFromTemplate(e,t){return this._attach(e,t)}open(e,t="",a){let i=_(_({},this._defaultConfig),a);return i.data={message:e,action:t},i.announcementMessage===e&&(i.announcementMessage=void 0),this.openFromComponent(this.simpleSnackBarComponent,i)}dismiss(){this._openedSnackBarRef&&this._openedSnackBarRef.dismiss();}ngOnDestroy(){this._snackBarRefAtThisLevel&&this._snackBarRefAtThisLevel.dismiss();}_attachSnackBarContainer(e,t){let a=t&&t.viewContainerRef&&t.viewContainerRef.injector,i=P.create({parent:a||this._injector,providers:[{provide:A,useValue:t}]}),o=new bo(this.snackBarContainerComponent,t.viewContainerRef,i),s=e.attach(o);return s.instance.snackBarConfig=t,s.instance}_attach(e,t){let a=_(_(_({},new A),this._defaultConfig),t),i=this._createOverlay(a),o=this._attachSnackBarContainer(i,a),s=new E(o,i);if(e instanceof Ve){let l=new _r(e,null,{$implicit:a.data,snackBarRef:s});s.instance=o.attachTemplatePortal(l);}else {let l=this._createInjector(a,s),d=new bo(e,void 0,l),c=o.attachComponentPortal(d);s.instance=c.instance;}return this._breakpointObserver.observe(yG.HandsetPortrait).pipe(an(i.detachments())).subscribe(l=>{i.overlayElement.classList.toggle(this.handsetCssClass,l.matches);}),a.announcementMessage&&o._onAnnounce.subscribe(()=>{this._live.announce(a.announcementMessage,a.politeness);}),this._animateSnackBar(s,a),this._openedSnackBarRef=s,this._openedSnackBarRef}_animateSnackBar(e,t){e.afterDismissed().subscribe(()=>{this._openedSnackBarRef==e&&(this._openedSnackBarRef=null),t.announcementMessage&&this._live.clear();}),t.duration&&t.duration>0&&e.afterOpened().subscribe(()=>e._dismissAfter(t.duration)),this._openedSnackBarRef?(this._openedSnackBarRef.afterDismissed().subscribe(()=>{e.containerInstance.enter();}),this._openedSnackBarRef.dismiss()):e.containerInstance.enter();}_createOverlay(e){let t=new wr;t.direction=e.direction;let a=wo(this._injector),i=e.direction==="rtl",o=e.horizontalPosition==="left"||e.horizontalPosition==="start"&&!i||e.horizontalPosition==="end"&&i,s=!o&&e.horizontalPosition!=="center";return o?a.left("0"):s?a.right("0"):a.centerHorizontally(),e.verticalPosition==="top"?a.top("0"):a.bottom("0"),t.positionStrategy=a,t.disableAnimations=this._animationsDisabled,qi(this._injector,t)}_createInjector(e,t){let a=e&&e.viewContainerRef&&e.viewContainerRef.injector;return P.create({parent:a||this._injector,providers:[{provide:E,useValue:t},{provide:nt,useValue:e.data}]})}static \u0275fac=function(t){return new(t||r)};static \u0275prov=C({token:r,factory:r.\u0275fac})}return r})();var Qt=(()=>{class r{static \u0275fac=function(t){return new(t||r)};static \u0275mod=Q({type:r});static \u0275inj=q({providers:[It],imports:[Yi,Er,Lb,it,st$1]})}return r})();var rt=`[
  {
    "version": "v0.9",
    "createSurface": {
...
`;var j="updateComponents",oe="components",At="registerMockRules",wt="mockRulesConfig",Dt="rules",Tt="id",Mt="children",ot="mock_rules_container",F=class r{destroyRef=f(pe);chatState=f(s);catalogManagement=f(fe);startupConfigState=f(hc);_activeDraft=Y("");activeDraft=this._activeDraft.asReadonly();_draftInput=Y("");constructor(){let n=this.startupConfigState.selectedRendererId?iq(this.startupConfigState.selectedRendererId):Hn(null),e=iq(this.catalogManagement.activeCatalog),t=this.startupConfigState.sharedA2uiPayload?iq(this.startupConfigState.sharedA2uiPayload):Hn(null);gl(n,e).pipe(oq(this.destroyRef)).subscribe(()=>{let a=this.catalogManagement.activeCatalog(),i=a&&(a.catalogId||a.$id)||"",o=this._activeDraft(),s=this.getCatalogIdFromDraft(o);if(o===""||s!==i){let l=this.getInitialDraft(i);this._activeDraft.set(l),this._draftInput.set(l);}}),t.pipe(ce(a=>!!a),oq(this.destroyRef)).subscribe(a=>{this.updateDraft(a);}),iq(this._draftInput).pipe(Po(1),zn(300),Os(),oq(this.destroyRef)).subscribe(a=>{this.syncLayoutToHistory(a);});}updateDraft(n){this._activeDraft.set(n),this._draftInput.set(n);}hydrateActiveDraft(){return this._activeDraft()}commitLayoutFromLlm(n){this._activeDraft.set(n);}flushDraft(){let n=this.catalogManagement.activeCatalog(),e=n&&(n.catalogId||n.$id)||"";this._activeDraft.set(this.getInitialDraft(e));}getInitialDraft(n){let e=this.startupConfigState.sharedA2uiPayload();if(e)return e;let t=this.startupConfigState.activeRenderer();return t?.samplePayload?t.samplePayload:n==="https://a2ui.org/specification/v0_9/basic_catalog.json"?rt:n?l([{version:"v0.9",createSurface:{surfaceId:"sample-surface",catalogId:n,sendDataModel:true}}]):""}getCatalogIdFromDraft(n){let e=n.trim();if(!e)return null;try{let t=JSON.parse(e);if(Array.isArray(t))for(let a of t){let i=a;if(i?.createSurface?.catalogId)return i.createSurface.catalogId}else if(t&&typeof t=="object"){let a=t;if(a?.createSurface?.catalogId)return a.createSurface.catalogId}}catch{}return null}syncLayoutToHistory(n){let e=this.sanitizeLayout(n);if(!e)return;let t=this.chatState.chatHistory();if(t.length===0){this.chatState.setChatHistory([{role:"user",content:e}]);return}let a=t[t.length-1];if(a.role==="user"&&a.content.trim().startsWith("[")){let o=[...t];o[o.length-1]={role:"user",content:e},this.chatState.setChatHistory(o);}else this.chatState.updateChatHistory(o=>[...o,{role:"user",content:e}]);}sanitizeLayout(n){let e=n.trim();if(!e)return "";let t=a(e);if(t){let a=t.map(i=>i&&typeof i=="object"&&!Array.isArray(i)?this.sanitizeBlock(i):i).filter(i=>i!==null);return l(a)}return console.warn("[StateSync] Discarding malformed layout JSON during sanitization: not a valid JSON array"),""}sanitizeBlock(n){if(n[At]||n[wt])return null;if(n[j]&&typeof n[j]=="object"&&n[j]!==null){let e=n[j];if(Array.isArray(e[oe])){let t=e[oe].filter(a=>a!==null&&typeof a=="object"&&!Array.isArray(a)?a[Tt]!==ot:true);e[oe]=t.map(a=>a!==null&&typeof a=="object"&&!Array.isArray(a)?this.sanitizeComponentObject(a):a);}}return n}sanitizeComponentObject(n){let e={};for(let[t,a]of Object.entries(n))t===Dt||/^mock/i.test(t)||(t===Mt&&Array.isArray(a)?e[t]=a.filter(i=>i!==ot):a!==null&&typeof a=="object"&&!Array.isArray(a)?e[t]=this.sanitizeComponentObject(a):Array.isArray(a)?e[t]=a.map(i=>i!==null&&typeof i=="object"&&!Array.isArray(i)?this.sanitizeComponentObject(i):i):e[t]=a);return e}static \u0275fac=function(e){return new(e||r)};static \u0275prov=T({token:r,factory:r.\u0275fac,providedIn:"root"})};var st=/```(?:jsonl?|jsonlines|a2ui|html|xml)?\s*([\s\S]*?)\s*```/gi,ct=/<(thought|thinking|reasoning)>([\s\S]*?)(?:<\/\1>|$)/gi,lt=/\s*●●●\s*$/g;function dt(r){return r.length>0&&r.some(n=>{if(n&&typeof n=="object"&&!Array.isArray(n)){let e=Object.keys(n);return e.includes("version")||e.includes("createSurface")||e.includes("updateComponents")||e.includes("updateDataModel")||e.includes("deleteSurface")}return  false})}var U=class r{PULSE_INDICATOR="\u25CF\u25CF\u25CF";appendPulse(n){return `${n??""} ${this.PULSE_INDICATOR}`}stripPulse(n){return n?(lt.lastIndex=0,n.replace(lt,"").trim()):""}stripThinkingTags(n){return n?(ct.lastIndex=0,n.replace(ct,"").trim()):""}extractCodeFences(n){if(!n)return {extracted:"",hasFences:false};st.lastIndex=0;let e=Array.from(n.matchAll(st));return e.length>0?{extracted:e.map(t=>t[1].trim()).join(`
`),hasFences:true}:{extracted:n.trim(),hasFences:false}}cleanPayload(n){if(!n)return "";let e=this.stripPulse(n);if(e=this.stripThinkingTags(e),e=this.extractCodeFences(e).extracted,!e.startsWith("{")&&!e.startsWith("[")){let a$1=Array.from(e.matchAll(/[\{\[]/g));for(let i of a$1)if(i.index!==void 0&&i.index>=0){let o=e.substring(i.index).trim();if(o.startsWith("{")&&o.includes('"version"')||o.startsWith("[")&&/^\[\s*[\{\"]/.test(o)&&(o.includes('"version"')||o.includes('"createSurface"')||o.includes('"updateComponents"'))){e=o;break}let s=a(o);if(s!==null&&dt(s)){e=o;break}}}return e.trim()}isLayoutSnapshot(n){if(!n)return  false;let e=this.cleanPayload(n);if(e.startsWith('{"version"')||e.startsWith("{")&&e.includes('"version"')||e.startsWith("[")&&(e.includes('"version"')||e.includes('"createSurface"')||e.includes('"updateComponents"')))return  true;let t=a(e);return t!==null&&dt(t)}static \u0275fac=function(e){return new(e||r)};static \u0275prov=T({token:r,factory:r.\u0275fac,providedIn:"root"})};function mt(r){if(r==null||r.trim().length===0)return {blocks:[],wasHealed:false};let n=false,e=a(r);if(e)return {blocks:e,wasHealed:false};try{let i=JSON.parse(r);if(Array.isArray(i))return {blocks:i,wasHealed:n};if(i&&typeof i=="object")return {blocks:[i],wasHealed:n}}catch{}let t=r.split(`
`).map(i=>i.trim()).filter(i=>i.length>0),a$1=[];for(let i of t)if(!(i.startsWith("```")||!i.startsWith("{")&&!i.startsWith("[")))try{a$1.push(JSON.parse(i));}catch{n=true;let s=Rt(i);if(s!==null)a$1.push(s);else if(i.includes('"version"')||i.includes('"createSurface"'))throw new Error(`Syntax recovery failed for corrupted JSON Line:
"${i}"`)}if(a$1.length===0)throw new Error("No valid A2UI JSON layout command block could be parsed or recovered.");return {blocks:a$1,wasHealed:n}}function Rt(r){if(r==null||r.trim().length===0)return null;let n=r.trim();n=n.replace(/,\s*([\]}])/g,"$1");try{return JSON.parse(n)}catch{for(let t=1;t<=5;t++)try{return JSON.parse(n+"}".repeat(t))}catch{}for(let t=1;t<=3;t++)for(let a=1;a<=3;a++)try{return JSON.parse(n+"]".repeat(t)+"}".repeat(a))}catch{}}return null}function Et(r){if(!r||typeof r!="object")return  false;let n=r;if(!n.updateComponents||typeof n.updateComponents!="object")return  false;let e=n.updateComponents;return Array.isArray(e.components)}function ut(r,n){let e=false,t={};if(n)for(let i of Object.keys(n)){let o=i.toLowerCase().replace(/[^a-z]/g,"");t[o]=i;}let a={textbox:"textfield",textinput:"textfield",rowlayout:"row",columnlayout:"column",choice:"choicepicker",datepicker:"datetimeinput",datetimepicker:"datetimeinput"};for(let i of r){if(!Et(i))continue;let o=i.updateComponents,s=[];for(let l of o.components){if(!l||typeof l!="object"||Array.isArray(l)){s.push(l);continue}let d=l,c=d.component;if(d.name&&!d.component&&(e=true,c=d.name,d.component=c,delete d.name),typeof c!="string")throw new Error("Component declaration is missing component type name string.");let p=c;if(n&&!n[c]){let u=c.toLowerCase().replace(/[^a-z]/g,""),g=t[u];if(!g){let f=a[u];f&&(g=t[f]);}if(g&&n[g])e=true,p=g;else {let f=u?Object.keys(n).find(C=>C.toLowerCase().includes(u)||u.includes(C.toLowerCase())):void 0;if(f)e=true,p=f;else throw new Error(`Validation failure: Component type "${c}" is not registered in the active custom catalog.`)}}let h=Ot(d);h.component=p,s.push(h);}o.components=s;}return e}function se(r){if(r===null||typeof r!="object")return r;if(Array.isArray(r))return r.map(t=>se(t));let n=r,e={};for(let[t,a]of Object.entries(n))t==="__proto__"||t==="constructor"||t==="prototype"||(e[t]=se(a));return e}function Ot(r){return se(r)}var H=class r{catalogManagement=f(fe);systemPrompt=Ci(()=>{let n=this.catalogManagement.activeCatalog();return n?this.generateSystemPrompt(l(n)):`
