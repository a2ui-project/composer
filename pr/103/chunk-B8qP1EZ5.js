import {o as ot,I as It,z as zt$1,q as qt,V as Vt}from'./chunk-tt9-rcid.js';import {Q as Qe,W as Ww,g,a as gs,m as ms,b as W,J as Jd,h as hI,s as sr,N as Nt,C as Co,$ as $i,c as $h,_ as _w,O as Ou,L as Lh,F as FI,d as FD,P as Ph,e as Fh,j as ju,o as og,X as Xh,k as kw,f as LI,i as N,n as ns,y as yr,q as qn,l as XI,p as JI,r as gw,G as Gh,t as tw,u as nw,K,v as re,Y as Yn,w as ih,x as w,z as ee$1,A as Ym,B as L,D as fD,E as _u,H as mC,I as ku,M as zh,R as Pu,S as Wh}from'./main.js';import {M as Me,W as Wt,C as Ce,A as At,l as li,d as di,s as si,n as ne$1}from'./chunk-B2mPoEW-.js';import {j,P}from'./chunk-p280Icdm.js';import {c as co,Y as Yt$1,T as Td,D as Dd,G as Go,Q as Qd,Z as Zd,R,f as fc,_ as _n,K as Ko,a as Dt,S as Se,V as Vc,b as bn,q as qr,x as xe,d as To}from'./chunk-F8xFloh8.js';var $t=["*",[["mat-toolbar-row"]]],Qt=["*","mat-toolbar-row"],Zt=(()=>{class o{static \u0275fac=function(e){return new(e||o)};static \u0275dir=_u({type:o,selectors:[["mat-toolbar-row"]],hostAttrs:[1,"mat-toolbar-row"],exportAs:["matToolbarRow"]})}return o})(),zt=(()=>{class o{_elementRef=g(qn);_platform=g(R);_document=g(W);color;_toolbarRows;ngAfterViewInit(){this._platform.isBrowser&&(this._checkToolbarMixedModes(),this._toolbarRows.changes.subscribe(()=>this._checkToolbarMixedModes()));}_checkToolbarMixedModes(){this._toolbarRows.length;}static \u0275fac=function(e){return new(e||o)};static \u0275cmp=hI({type:o,selectors:[["mat-toolbar"]],contentQueries:function(e,i,n){if(e&1&&Gh(n,Zt,5),e&2){let s;tw(s=nw())&&(i._toolbarRows=s);}},hostAttrs:[1,"mat-toolbar"],hostVars:6,hostBindings:function(e,i){e&2&&(gw(i.color?"mat-"+i.color:""),Xh("mat-toolbar-multiple-rows",i._toolbarRows.length>0)("mat-toolbar-single-row",i._toolbarRows.length===0));},inputs:{color:"color"},exportAs:["matToolbar"],ngContentSelectors:Qt,decls:2,vars:0,template:function(e,i){e&1&&(XI($t),JI(0),JI(1,1));},styles:[`.mat-toolbar {
