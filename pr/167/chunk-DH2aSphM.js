import {f,a4 as ae,Y as Y_,S as So,j,aa as Uq,b9 as Ee,aJ as Al,V as L_,ah as ue,ba as Ho,ab as qn,ac as Ws,r as I,h as ho,bb as Fn,K as K_,bc as Xa,ak as Z,al as E,X as pe,bd as Xc,be as vA,bf as k,bg as sp,as as g,ao as Jt,bh as Eo,b6 as $e,aw as Er,bi as f3,bj as dn,bk as Cr,bl as Io,bm as Ji,bn as w,Q,t as K,bo as es,an as Dr,i as i_,u as st$1,A as Ai,b as fe,o as o_,c as Me,e as Yt,z as ze,g as wi,k as bt$1,l as Sf,q as Ci,bp as Do,ap as M$1,x as z$1,a6 as pc,y as te,R,ag as C,at as It$1,aS as $t,ax as Xi,ay as Ce,aB as ao,v as vv,D as Dt$1,d as ic,W as We,aC as xi,H as sc,N as ac,P as J$1,aY as AS,aP as RS,aZ as _m,a_ as Em}from'./main.js';import {o,p,l,b}from'./chunk-Blv2imfc.js';function ht(r,a){if(r&1){let e=AS();Me(0,"div",1)(1,"button",2),ic("click",function(){_m(e);let n=RS();return Em(n.action())}),Yt(2),ze()();}if(r&2){let e=RS();bt$1(2),Sf(" ",e.data.action," ");}}var ft=["label"];function gt(r,a){}var yt=Math.pow(2,31)-1,M=class{_overlayRef;instance;containerInstance;_afterDismissed=new C;_afterOpened=new C;_onAction=new C;_durationTimeoutId;_dismissedByAction=false;constructor(a,e){this._overlayRef=e,this.containerInstance=a,a._onExit.subscribe(()=>this._finishDismiss());}dismiss(){this._afterDismissed.closed||this.containerInstance.exit(),clearTimeout(this._durationTimeoutId);}dismissWithAction(){this._onAction.closed||(this._dismissedByAction=true,this._onAction.next(),this._onAction.complete(),this.dismiss()),clearTimeout(this._durationTimeoutId);}closeWithAction(){this.dismissWithAction();}_dismissAfter(a){this._durationTimeoutId=setTimeout(()=>this.dismiss(),Math.min(a,yt));}_open(){this._afterOpened.closed||(this._afterOpened.next(),this._afterOpened.complete());}_finishDismiss(){this._overlayRef.dispose(),this._onAction.closed||this._onAction.complete(),this._afterDismissed.next({dismissedByAction:this._dismissedByAction}),this._afterDismissed.complete(),this._dismissedByAction=false;}afterDismissed(){return this._afterDismissed}afterOpened(){return this.containerInstance._onEnter}onAction(){return this._onAction}},at=new g("MatSnackBarData"),A=class{politeness="polite";announcementMessage="";viewContainerRef;duration=0;panelClass;direction;data=null;horizontalPosition="center";verticalPosition="bottom"},vt=(()=>{class r{static \u0275fac=function(t){return new(t||r)};static \u0275dir=J$1({type:r,selectors:[["","matSnackBarLabel",""]],hostAttrs:[1,"mat-mdc-snack-bar-label","mdc-snackbar__label"]})}return r})(),bt=(()=>{class r{static \u0275fac=function(t){return new(t||r)};static \u0275dir=J$1({type:r,selectors:[["","matSnackBarActions",""]],hostAttrs:[1,"mat-mdc-snack-bar-actions","mdc-snackbar__actions"]})}return r})(),_t=(()=>{class r{static \u0275fac=function(t){return new(t||r)};static \u0275dir=J$1({type:r,selectors:[["","matSnackBarAction",""]],hostAttrs:[1,"mat-mdc-snack-bar-action","mdc-snackbar__action"]})}return r})(),it=(()=>{class r{snackBarRef=f(M);data=f(at);action(){this.snackBarRef.dismissWithAction();}get hasAction(){return !!this.data.action}static \u0275fac=function(t){return new(t||r)};static \u0275cmp=fe({type:r,selectors:[["simple-snack-bar"]],hostAttrs:[1,"mat-mdc-simple-snack-bar"],exportAs:["matSnackBar"],decls:3,vars:2,consts:[["matSnackBarLabel",""],["matSnackBarActions",""],["matButton","","matSnackBarAction","",3,"click"]],template:function(t,n){t&1&&(Me(0,"div",0),Yt(1),ze(),wi(2,ht,3,1,"div",1)),t&2&&(bt$1(),Sf(" ",n.data.message,`
`),bt$1(),Ci(n.hasAction?2:-1));},dependencies:[o_,vt,bt,_t],styles:[`.mat-mdc-simple-snack-bar {
  display: flex;
}
