import {f,n as ne$1,at as Cv,G as K$1,i as qa,Q,Y,bd as lh,t as st,be as CG,bf as yr,bg as rt,e as ue,bh as uh,b9 as Ee,x as io,A as Ae,y as Tt,H as He,a3 as gf,S as St,bi as hf,k as $e,v as vi,p as bi,j as wt,aU as y,B as ev,D as Ya,E as Ka,bj as db,bk as kb,bl as rW,K as Ky,ba as wi,U,bm as Ec,bn as Bi,J,b6 as R,bo as Ct,bp as Dc,d as O,q,ai as S,bq as W,aj as ce$1,ak as oe$1,br as vl,aS as P,a8 as tc,a_ as an,bs as In,av as Ut$1,bt as Se,bu as Xt$1,aV as Zt$1,bv as ur,bw as vo,bx as sn,ad as zn,by as gl,aB as ZI,as as JI,bz as nD,bA as V,bB as We,bC as Rb,bD as ih,bE as Ui,aC as Qp,aD as Jp}from'./main.js';import {h}from'./chunk-2EWHjJmM.js';var Ft=class n{trackingService=f(ne$1);a2uiComposerTrackEvent=Cv.required();a2uiComposerTrackParams=Cv();onClick(){let v=this.a2uiComposerTrackEvent(),t=this.a2uiComposerTrackParams();v&&typeof this.trackingService[v]=="function"&&this.trackingService[v](t);}static \u0275fac=function(t){return new(t||n)};static \u0275dir=K$1({type:n,selectors:[["","a2uiComposerTrackEvent",""]],hostBindings:function(t,e){t&1&&qa("click",function(){return e.onClick()});},inputs:{a2uiComposerTrackEvent:[1,"a2uiComposerTrackEvent"],a2uiComposerTrackParams:[1,"a2uiComposerTrackParams"]}})};var Ot=(()=>{class n{static \u0275fac=function(e){return new(e||n)};static \u0275mod=Q({type:n});static \u0275inj=Y({imports:[st]})}return n})();var Vt=["*"],Nt=`.mdc-list {
  margin: 0;
  padding: 8px 0;
