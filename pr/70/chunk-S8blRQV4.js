import {s as se$1,i as it,a as re,b as ae,k as kt,I as It,r as rn,o as on,c as at}from'./chunk-Bwu0f8QJ.js';import {V as uu,X as Xt,i as io,Z as On,$ as fu,a0 as du,C as Ci,h as au,a1 as lu,a2 as ks,a3 as Fs,E as Ed,y as yd,L as Lo,H as Hd,j as jd,A as At,T as Tn,x as xe$1,k as An,a4 as ni,q,r as ri,p as St,z as zo,v as wn,n as Hc,a5 as Un,a6 as Xe,a7 as hf,S as Se$1,s as si}from'./chunk-rE_E6kTi.js';import {C,a9 as jt,N as No,bi as se,p as pe$1,S as So,D as DD,H as HE,a as ai,t as tD,b as Mc,M as Mp,s as fI,c as Dp,am as Jv,B as By,I as Ip,u as pI,an as eE,k as kc,$ as $E,j as jl,y as x,h as MI,i as NI,F as Fp,a4 as WE,ap as Nc,aq as Sc,K as hF,f as cr,bj as cF,w as Ce$1,X,G as Le$1,J as fe$1,a1 as Xh,av as mF,r as lD,aX as bp,E as Ep,q as qI,v as Ap,l as xI,m as AI,x as xp,Z as zo$1,_ as pg,aZ as hg,Q as gg,ay as yF,aC as Yp,au as pm,a8 as RI,bk as io$1,T as TI,a2 as bI,U as Up,aJ as Du,n as Am,o as dp,a6 as cu,a7 as lu$1}from'./main.js';var De=["*"];var Fe=[[["","mat-card-avatar",""],["","matCardAvatar",""]],[["mat-card-title"],["mat-card-subtitle"],["","mat-card-title",""],["","mat-card-subtitle",""],["","matCardTitle",""],["","matCardSubtitle",""]],"*"],Re=["[mat-card-avatar], [matCardAvatar]",`mat-card-title, mat-card-subtitle,
      [mat-card-title], [mat-card-subtitle],
      [matCardTitle], [matCardSubtitle]`,"*"],Te=new x("MAT_CARD_CONFIG"),le=(()=>{class i{appearance;constructor(){let t=C(Te,{optional:true});this.appearance=t?.appearance||"raised";}static \u0275fac=function(e){return new(e||i)};static \u0275cmp=HE({type:i,selectors:[["mat-card"]],hostAttrs:[1,"mat-mdc-card","mdc-card"],hostVars:8,hostBindings:function(e,n){e&2&&Fp("mat-mdc-card-outlined",n.appearance==="outlined")("mdc-card--outlined",n.appearance==="outlined")("mat-mdc-card-filled",n.appearance==="filled")("mdc-card--filled",n.appearance==="filled");},inputs:{appearance:"appearance"},exportAs:["matCard"],ngContentSelectors:De,decls:1,vars:0,template:function(e,n){e&1&&(MI(),NI(0));},styles:[`.mat-mdc-card {
  display: flex;
...
`],encapsulation:2})}return i})();var Ie=(()=>{class i{static \u0275fac=function(e){return new(e||i)};static \u0275mod=$E({type:i});static \u0275inj=jl({providers:[at,{provide:Ne,useValue:{separatorKeyCodes:[13]}}],imports:[si,Se$1]})}return i})();var je=["*"],Se=(()=>{class i{labelPosition="after";static \u0275fac=function(e){return new(e||i)};static \u0275cmp=HE({type:i,selectors:[["div","mat-internal-form-field",""]],hostAttrs:[1,"mdc-form-field","mat-internal-form-field"],hostVars:2,hostBindings:function(e,n){e&2&&Fp("mdc-form-field--align-end",n.labelPosition==="before");},inputs:{labelPosition:"labelPosition"},ngContentSelectors:je,decls:1,vars:0,template:function(e,n){e&1&&(MI(),NI(0));},styles:[`.mat-internal-form-field {
...
`],encapsulation:2})}return i})(),Me=(()=>{class i{static \u0275fac=function(e){return new(e||i)};static \u0275mod=$E({type:i});static \u0275inj=jl({imports:[ht,Se$1]})}return i})();function ut(i,c){let t=hf(c);t!==void 0&&i.assign(t);}function li(i,c){i&1&&(ai(0,"div",4)(1,"mat-icon",22),tD(2,"lock"),Mc(),ai(3,"span"),tD(4,"Active URL configuration is locked by enterprise policy (allowOverrides: false)."),Mc()());}function mi(i,c){i&1&&(ai(0,"mat-error"),tD(1,"Renderer URL is required."),Mc());}function hi(i,c){i&1&&(ai(0,"mat-error"),tD(1,"Must be a valid HTTP or HTTPS URL."),Mc());}function pi(i,c){i&1&&(ai(0,"mat-hint",27),tD(1,"Gemini Assistant feature will be disabled without a valid API key."),Mc());}function ui(i,c){i&1&&(ai(0,"mat-error"),tD(1,"API key cannot be empty whitespace."),Mc());}function gi(i,c){if(i&1){let t=TI();ai(0,"div",3)(1,"h3"),tD(2,"Gemini API Provisioning"),Mc(),ai(3,"p",8),tD(4," Your personal Gemini API key is encrypted and stored locally in your browser's secure database using the "),ai(5,"a",23),tD(6,"Web Crypto API"),Mc(),tD(7,". Neither Google nor anyone else has access to this key. "),Mc(),ai(8,"mat-form-field",5)(9,"mat-label"),tD(10,"Gemini API Key"),Mc(),Dp(11,"input",24),Jv(),ai(12,"button",25),Mp("click",function(){cu(t);let n=bI();return lu$1(n.hideApiKey.set(!n.hideApiKey()))}),ai(13,"mat-icon",26),tD(14),Mc()(),fI(15,pi,2,0,"mat-hint",27),fI(16,ui,2,0,"mat-error"),Mc()();}if(i&2){let t=bI();By(11),Ip("type",t.hideApiKey()?"password":"text"),eE(),By(),Ep("aria-label",t.hideApiKey()?"Show API key":"Hide API key"),By(2),Up(t.hideApiKey()?"visibility":"visibility_off"),By(),pI(t.settingsForm.controls.apiKey.value?-1:15),By(),pI(t.settingsForm.controls.apiKey.hasError("pattern")?16:-1);}}function fi(i,c){i&1&&(ai(0,"div",9)(1,"mat-icon",22),tD(2,"lock"),Mc(),ai(3,"span"),tD(4,"Authentication mode overrides are locked by enterprise policy."),Mc()());}function vi(i,c){if(i&1&&(ai(0,"code",20),tD(1),Mc()),i&2){let t=bI();By(),kc("[Catalog Error] ",t.catalogErrorMessage());}}function _i(i,c){i&1&&(ai(0,"code",21),tD(1,"[System] Catalog handshake completed successfully. Active catalog ready."),Mc());}function bi(i,c){i&1&&(ai(0,"code"),tD(1,"[System] Catalog handshake in progress. Indexing metadata..."),Mc());}function yi(i,c){i&1&&(ai(0,"code"),tD(1,"[System] Bridge connected. Initializing catalog handshake..."),Mc());}function wi(i,c){i&1&&(ai(0,"code"),tD(1,"[System] Bridge disconnected. Waiting for iframe handshake initialization..."),Mc());}var Ee=class i{fb=C(uu);startupResolution=C(jt);document=C(No);platformLocation=C(se);hostCommunication=C(Xt);catalogManagement=C(io);configProvider=C(pe$1);isLocked=So(false);isThirdParty=So(false);hideApiKey=So(true);forceThirdPartyAuth=So(false);bridgeConnected=DD(()=>this.hostCommunication.latestEnvelope()!==null);catalogStatus=DD(()=>this.catalogManagement.catalogError()?"Error":this.catalogManagement.isHandshakeInProgress()?"Indexing":this.catalogManagement.activeCatalog()?"Connected":"Disconnected");catalogErrorMessage=DD(()=>this.catalogManagement.catalogError());settingsForm=this.fb.group({rendererUrl:["",[On.required,On.pattern(/^https?:\/\/.+/i)]],apiKey:[""]});ngOnInit(){let c=this.startupResolution.isContextLocked();this.isLocked.set(c);let t=this.startupResolution.isThirdPartyEnvironment();this.isThirdParty.set(t),this.forceThirdPartyAuth.set(this.configProvider.authType()==="3p");let e=this.configProvider.rendererUrl(),n=this.configProvider.geminiApiKey();if(this.settingsForm.patchValue({rendererUrl:e,apiKey:n}),c&&this.settingsForm.controls.rendererUrl.disable(),t){let s=this.settingsForm.controls.apiKey;s.setValidators([On.pattern(/\S/)]),s.updateValueAndValidity();}}async saveSettings(){if(this.settingsForm.invalid){this.settingsForm.markAllAsTouched();return}let c=this.settingsForm.getRawValue();this.isThirdParty()?(this.isLocked()||this.configProvider.setRendererUrl(c.rendererUrl.trim()),await this.configProvider.setGeminiApiKey(c.apiKey.trim())):(await this.configProvider.purgeGeminiApiKey(),this.isLocked()||this.configProvider.setRendererUrl(c.rendererUrl.trim())),this.reloadWindow();}reloadWindow(){if(this.document.defaultView?.location){let c=this.platformLocation.getBaseHrefFromDOM()||"/";ut(this.document.defaultView.location,c);}}toggleForceThirdPartyAuth(){if(this.isLocked())return;let c=!this.forceThirdPartyAuth();this.forceThirdPartyAuth.set(c),this.configProvider.setForcedAuthMode(c?"3p":"1p"),this.reloadWindow();}static \u0275fac=function(t){return new(t||i)};static \u0275cmp=HE({type:i,selectors:[["a2ui-composer-settings"]],decls:52,vars:13,consts:[[1,"settings-container"],[1,"settings-card"],[3,"ngSubmit","formGroup"],[1,"form-section"],[1,"locked-notice"],["appearance","outline",1,"full-width"],["matInput","","formControlName","rendererUrl","placeholder","http://localhost:3000"],[1,"form-section","developer-auth-section"],[1,"description"],[1,"locked-notice","auth-locked-notice"],[1,"toggle-container",2,"margin-top","12px"],[3,"change","checked","disabled"],["align","end"],["mat-flat-button","","color","primary",3,"click"],[1,"status-card"],[1,"status-badges"],[1,"status-badge","bridge-badge",3,"color"],[1,"status-badge","catalog-badge",3,"color"],[1,"overlay-logs"],[1,"logs-console"],[1,"error-log",2,"color","#f44336","font-weight","bold"],[1,"success-log",2,"color","#4caf50"],["color","warn","aria-hidden","true"],["href","https://developer.mozilla.org/en-US/docs/Web/API/Web_Crypto_API","target","_blank","rel","noopener noreferrer"],["matInput","","formControlName","apiKey","placeholder","Enter your Gemini API key",3,"type"],["mat-icon-button","","matSuffix","","type","button",1,"api-key-toggle-btn",3,"click"],["aria-hidden","true"],[1,"warning-hint"]],template:function(t,e){t&1&&(ai(0,"div",0)(1,"mat-card",1)(2,"mat-card-header")(3,"mat-card-title"),tD(4,"A2UI Composer Settings"),Mc()(),ai(5,"mat-card-content")(6,"form",2),Mp("ngSubmit",function(){return e.saveSettings()}),ai(7,"div",3)(8,"h3"),tD(9,"Renderer Application URL"),Mc(),fI(10,li,5,0,"div",4),ai(11,"mat-form-field",5)(12,"mat-label"),tD(13,"Target Renderer URL"),Mc(),Dp(14,"input",6),Jv(),fI(15,mi,2,0,"mat-error"),fI(16,hi,2,0,"mat-error"),Mc()(),fI(17,gi,17,5,"div",3),ai(18,"div",7)(19,"h3"),tD(20,"Developer Authentication Overrides"),Mc(),ai(21,"p",8),tD(22," Simulate external 3P context to verify Gemini API key provisioning workflows. "),Mc(),fI(23,fi,5,0,"div",9),ai(24,"div",10)(25,"mat-slide-toggle",11),Mp("change",function(){return e.toggleForceThirdPartyAuth()}),tD(26," Force External Third-Party Authentication Mode "),Mc()()()()(),ai(27,"mat-card-actions",12)(28,"button",13),Mp("click",function(){return e.saveSettings()}),tD(29,"Save Settings"),Mc()()(),ai(30,"mat-card",14)(31,"mat-card-header")(32,"mat-card-title"),tD(33,"Connection Status & Diagnostics"),Mc(),ai(34,"mat-card-subtitle"),tD(35,"Real-time monitoring bridge"),Mc()(),ai(36,"mat-card-content")(37,"div",15)(38,"mat-chip-set")(39,"mat-chip",16),tD(40),Mc(),ai(41,"mat-chip",17),tD(42),Mc()()(),ai(43,"div",18)(44,"h4"),tD(45,"Overlay Logs Preview"),Mc(),ai(46,"div",19),fI(47,vi,2,1,"code",20)(48,_i,2,0,"code",21)(49,bi,2,0,"code")(50,yi,2,0,"code")(51,wi,2,0,"code"),Mc()()()()()),t&2&&(By(6),Ip("formGroup",e.settingsForm),By(4),pI(e.isLocked()?10:-1),By(4),eE(),By(),pI(e.settingsForm.controls.rendererUrl.hasError("required")?15:-1),By(),pI(e.settingsForm.controls.rendererUrl.hasError("pattern")?16:-1),By(),pI(e.isThirdParty()?17:-1),By(6),pI(e.isLocked()?23:-1),By(2),Ip("checked",e.forceThirdPartyAuth())("disabled",e.isLocked()),By(14),Ip("color",e.bridgeConnected()?"primary":"accent"),By(),kc("Bridge: ",e.bridgeConnected()?"Connected":"Disconnected"),By(),Ip("color",e.catalogStatus()==="Connected"?"primary":e.catalogStatus()==="Indexing"?"accent":e.catalogStatus()==="Error"?"warn":void 0),By(),kc("Catalog Handshake: ",e.catalogStatus()),By(5),pI(e.catalogErrorMessage()?47:e.catalogStatus()==="Connected"?48:e.catalogStatus()==="Indexing"?49:e.bridgeConnected()?50:51));},dependencies:[fu,du,Ci,au,lu,ks,Fs,se$1,it,re,ae,kt,It,rn,on,Ed,yd,Lo,Hd,jd,fe,le,ue,he,ge,pe,me,Ie,mt,ke,Me,ht],styles:[`.settings-container[_ngcontent-%COMP%]{padding:24px;max-width:600px;margin:0 auto}.form-section[_ngcontent-%COMP%]{margin-top:16px}.form-section[_ngcontent-%COMP%]   h3[_ngcontent-%COMP%]{margin-bottom:8px}.form-section[_ngcontent-%COMP%]   .description[_ngcontent-%COMP%]{margin-bottom:12px;font-size:13px;color:#555}.full-width[_ngcontent-%COMP%]{width:100%}.locked-notice[_ngcontent-%COMP%]{display:flex;align-items:center;gap:8px;padding:10px 14px;background-color:var(--mat-sys-error-container);color:var(--mat-sys-on-error-container);border-radius:6px;margin-bottom:16px;font-size:13px;font-weight:500}.status-card[_ngcontent-%COMP%]{margin-top:24px}.status-badges[_ngcontent-%COMP%]{margin-top:12px;margin-bottom:16px}.overlay-logs[_ngcontent-%COMP%]   h4[_ngcontent-%COMP%]{margin-bottom:8px;font-size:14px}.overlay-logs[_ngcontent-%COMP%]   .logs-console[_ngcontent-%COMP%]{background-color:#1e1e1e;color:#0f0;padding:12px;border-radius:6px;font-family:monospace;font-size:12px;line-height:1.5}  body .mat-mdc-slide-toggle .mat-internal-form-field,   body .mat-mdc-slide-toggle .mdc-form-field{display:inline-flex!important;align-items:center!important;gap:16px!important}  body .mat-mdc-slide-toggle label,   body .mat-mdc-slide-toggle .mdc-label{padding-left:16px!important;white-space:normal!important;line-height:1.4!important;color:var(--mat-sys-on-surface)!important}.warning-hint[_ngcontent-%COMP%]{color:var(--mat-sys-error);display:block;margin-top:4px}
