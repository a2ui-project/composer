import {g,s as Yg,u as en,M as M1,X as Xd,h as hI,$ as $i$1,V as Vh,R as Ru,T as Tw,b as Wh,w as lg,O as Oh,F as FI,n as ng,c as mD,B as Bh,d as cg,x as ug,y as LI,z as Xh,C as nw,D as O1,E as RC,m as ms,G as Gw,H as G,I as j,P as Pn$1,J as T$1,Q as Le,S as ee,U as gg,_ as zm,a0 as se$1,a1 as jt,a2 as _E,a3 as ME,a4 as qw,a5 as Wm,a6 as Ou,a7 as ku,r as rs,v as vr$1,a8 as tp,l as Tu,a9 as Ah,aa as Ow,ab as Qn,ac as Uc,ad as A1,K as KI,ae as kh,j as jh,af as Qh,k as ew,t as tw,Y as Yh,ag as $n,Z as Zn,ah as gC,ai as X,aj as H,ak as xi$2,al as We,am as ey,an as Um,ao as R1,ap as VI,aq as Lh,ar as HI,i as hw,as as tg,at as sh,W,au as bn,f as XI,av as mg,aw as Ft,ax as e,N,ay as re,az as Vm,aA as Ve,aB as AC,aC as zd,aD as Gd,aE as $h,o as rw,q as qI,A as Ad,aF as YI,p as Rd,aG as Jm,aH as ED,aI as Hh,aJ as Pu,aK as Fu,aL as kw,aM as ar$1,aN as zh,aO as II,aP as jI,aQ as $s,aR as ty,aS as nd,aT as A,aU as dr$1,aV as Lw,aW as Bw,L as Lu,aX as BI,aY as Hw,aZ as Nw}from'./main.js';import {n as no$1,A as Ae,F as Fe,B,Y as Ye,u as ue,J as Jt,a as ae,_ as _e,s as st,q as q$1,b as J$1,V,R as Rt,G as G$1}from'./chunk-pUWA7L17.js';import {i as it$1,J,I as Ii,v as vi$1,k as ki$1,F as Fi$1,S as Si$1,b as bi$1,T as Ti$1,x as xi$1,M as Mi$1,E as Ei$1,O as Oi$1}from'./chunk-CaC-uDpV.js';import {H as H$1,K as Ke,X as Xe}from'./chunk-CTBoV_hS.js';import {s as se,i as it$2,r as rn$1,o as on$1,V as Ve$1}from'./chunk-DLTUilmr.js';import {X as Xt,W as Wi$1,T,H as Hd,j as jd,E as Ed,L as Lo$1,i as io$1,y as yd,m as mu,C as Ci$1,a as au,N as Ns,D as Du,q,r as ri$1,x as xe,O,A as An,s as so,b as Hc,c as sc,d as jr,e as St,f as At,g as Wr,Q as Qt,h as Do$1,k as al,z as zo$1,l as Co$1,S as Se,w as wn,n as wo$1,o as oo$1,p as bn$1}from'./chunk-DqDCSoHK.js';var Mn=`
...
`.trim()+`
`;function nt(a){let i=a.trim();if(i.startsWith("[")&&i.endsWith("]"))try{let e=JSON.parse(i);if(Array.isArray(e))return e}catch{}return null}var on="updateComponents",kn="components",Ci="registerMockRules",wi="mockRulesConfig",Mi="rules",ki="id",Di="children",Oa="mock_rules_container",at=class a{destroyRef=g(Le);chatState=g(J);_activeDraft=en(Mn);activeDraft=this._activeDraft.asReadonly();_draftInput=en("");constructor(){Du(this._draftInput).pipe(Jm(1),zm(300),Wm(),Wi$1(this.destroyRef)).subscribe(i=>{this.syncLayoutToHistory(i);});}updateDraft(i){this._activeDraft.set(i),this._draftInput.set(i);}hydrateActiveDraft(){return this._activeDraft()}commitLayoutFromLlm(i){this._activeDraft.set(i);}flushDraft(){this._activeDraft.set(Mn);}syncLayoutToHistory(i){let e=this.sanitizeLayout(i),t=this.chatState.chatHistory();if(t.length===0){this.chatState.setChatHistory([{role:"user",content:e}]);return}let n=t[t.length-1];if(n.role==="user"&&n.content.trim().startsWith('{"version"')){let l=[...t];l[l.length-1]={role:"user",content:e},this.chatState.setChatHistory(l);}else this.chatState.updateChatHistory(l=>[...l,{role:"user",content:e}]);}sanitizeLayout(i){let e=i.trim();if(!e)return "";let t=nt(e);if(t)return t.map(s=>s&&typeof s=="object"&&!Array.isArray(s)?this.sanitizeBlock(s):s).filter(Boolean).map(s=>JSON.stringify(s)).join(`
`)+`
`;let n=e.split(`
...
`+$;}this.chatState.updateChatHistory(ee=>{let $=[...ee],Ae=$.length-1,_e=j({role:"error",content:z},u?{isRetryable:true,originalPrompt:e}:{});return Ae>=0&&$[Ae].role==="model"?($[Ae]=_e,$):($.push(_e),$)});}systemPrompt=Gw(()=>{let i=this.catalogManagement.activeCatalog();return i?this.generateSystemPrompt(JSON.stringify(i,null,2)):`You are an AI assistant designed to help model mock screens inside A2UI Composer shell.
...
`],encapsulation:2,changeDetection:1})}return a})(),zn=class{index;tab};function Bn(a){let i=a+"";return /^\d+$/.test(i)?a+"ms":i}var bi=(()=>{class a{static \u0275fac=function(t){return new(t||a)};static \u0275mod=rs({type:a});static \u0275inj=vr$1({imports:[Se]})}return a})();var Or=new T$1("MAT_BADGE_CONFIG"),fi="mat-badge-content",Ir=(()=>{class a{static \u0275fac=function(t){return new(t||a)};static \u0275cmp=hI({type:a,selectors:[["ng-component"]],decls:0,vars:0,template:function(t,n){},styles:[`.mat-badge {
  position: relative;
}
.mat-badge.mat-badge {
  overflow: visible;
