...
`],encapsulation:2,changeDetection:1})}return a})(),zn=class{index;tab};function Bn(a){let i=a+"";return /^\d+$/.test(i)?a+"ms":i}var bi=(()=>{class a{static \u0275fac=function(t){return new(t||a)};static \u0275mod=rs({type:a});static \u0275inj=vr$1({imports:[Se]})}return a})();var Or=new T("MAT_BADGE_CONFIG"),fi="mat-badge-content",Ir=(()=>{class a{static \u0275fac=function(t){return new(t||a)};static \u0275cmp=hI({type:a,selectors:[["ng-component"]],decls:0,vars:0,template:function(t,n){},styles:[`.mat-badge {
  position: relative;
}
.mat-badge.mat-badge {
  overflow: visible;
