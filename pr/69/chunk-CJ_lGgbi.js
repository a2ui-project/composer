import {n as no,A as Ae}from'./chunk-DzfL7Fp8.js';import {G as Gw,g,a as gs,m as ms,W,X as Xd,h as hI,e as er,P as Pn,q as qI,$ as $i,b as Wh,T as Tw,R as Ru,V as Vh,c as mD,B as Bh,L as Lu,j as jh,d as cg,N,r as rs,v as vr,Z as Zn,K as KI,f as XI,i as hw,n as ng,Y as Yh,k as ew,t as tw,l as Tu,A as Ad,o as rw,p as Rd}from'./main.js';import {M as Me,W as Wt,C as Ce,A as At,l as li,d as di,s as si}from'./chunk-D3m7Y-Pr.js';import'./chunk-C32_wuxB.js';import {i as io,Y as Yt,E as Ed,y as yd,L as Lo,H as Hd,j as jd,R,S as Se}from'./chunk-C2zAZLQ8.js';var dt=["*",[["mat-toolbar-row"]]],pt=["*","mat-toolbar-row"],ft=(()=>{class e{static \u0275fac=function(t){return new(t||e)};static \u0275dir=Tu({type:e,selectors:[["mat-toolbar-row"]],hostAttrs:[1,"mat-toolbar-row"],exportAs:["matToolbarRow"]})}return e})(),st=(()=>{class e{_elementRef=g(Zn);_platform=g(R);_document=g(W);color;_toolbarRows;ngAfterViewInit(){this._platform.isBrowser&&(this._checkToolbarMixedModes(),this._toolbarRows.changes.subscribe(()=>this._checkToolbarMixedModes()));}_checkToolbarMixedModes(){this._toolbarRows.length;}static \u0275fac=function(t){return new(t||e)};static \u0275cmp=hI({type:e,selectors:[["mat-toolbar"]],contentQueries:function(t,i,c){if(t&1&&Yh(c,ft,5),t&2){let d;ew(d=tw())&&(i._toolbarRows=d);}},hostAttrs:[1,"mat-toolbar"],hostVars:6,hostBindings:function(t,i){t&2&&(hw(i.color?"mat-"+i.color:""),ng("mat-toolbar-multiple-rows",i._toolbarRows.length>0)("mat-toolbar-single-row",i._toolbarRows.length===0));},inputs:{color:"color"},exportAs:["matToolbar"],ngContentSelectors:pt,decls:2,vars:0,template:function(t,i){t&1&&(KI(dt),XI(0),XI(1,1));},styles:[`.mat-toolbar {
