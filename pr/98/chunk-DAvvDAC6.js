import {o as ot,I as It,z as zt$1,q as qt,V as Vt}from'./chunk-C4uAr4PO.js';import {Q as Qe,z as zw,g,h as hs,a as gs,W,X as Xd,p as pI,s as sr,N as Nt,C as Co,$ as $i,U as Uh,T as Tw,R as Ru,F as Fh,P as PI,b as PD,k as kh,c as Ph,L as Lu,r as rg,K as Kh,O as Ow,d as FI,e as N,n as ns,y as yr,q as qn,f as KI,i as XI,j as hw,l as zh,m as ew,t as tw,o as K,u as re,Y as Yn,v as oh,w,x as ee$1,Z as Zm,A as L,B as dD,D as Tu,E as hC,G as Ou,H as $h,I as ku,J as Gh}from'./main.js';import {M as Me,W as Wt,C as Ce,A as At,l as li,d as di,s as si,n as ne$1}from'./chunk-CldzkgWH.js';import {j,P}from'./chunk-BasFn_3C.js';import {l as lo,Y as Yt$1,D as Dd,S as Sd,H as Ho,Z as Zd,a as Yd,R,m as mc,_ as _n,$ as $o,b as Dt,x as xe,V as Vc,c as bn,K as Kr,d as Se,e as Do}from'./chunk-Zu2jJUaN.js';var $t=["*",[["mat-toolbar-row"]]],Qt=["*","mat-toolbar-row"],Zt=(()=>{class o{static \u0275fac=function(e){return new(e||o)};static \u0275dir=Tu({type:o,selectors:[["mat-toolbar-row"]],hostAttrs:[1,"mat-toolbar-row"],exportAs:["matToolbarRow"]})}return o})(),zt=(()=>{class o{_elementRef=g(qn);_platform=g(R);_document=g(W);color;_toolbarRows;ngAfterViewInit(){this._platform.isBrowser&&(this._checkToolbarMixedModes(),this._toolbarRows.changes.subscribe(()=>this._checkToolbarMixedModes()));}_checkToolbarMixedModes(){this._toolbarRows.length;}static \u0275fac=function(e){return new(e||o)};static \u0275cmp=pI({type:o,selectors:[["mat-toolbar"]],contentQueries:function(e,i,n){if(e&1&&zh(n,Zt,5),e&2){let s;ew(s=tw())&&(i._toolbarRows=s);}},hostAttrs:[1,"mat-toolbar"],hostVars:6,hostBindings:function(e,i){e&2&&(hw(i.color?"mat-"+i.color:""),Kh("mat-toolbar-multiple-rows",i._toolbarRows.length>0)("mat-toolbar-single-row",i._toolbarRows.length===0));},inputs:{color:"color"},exportAs:["matToolbar"],ngContentSelectors:Qt,decls:2,vars:0,template:function(e,i){e&1&&(KI($t),XI(0),XI(1,1));},styles:[`.mat-toolbar {
