import {o as ot,I as It,z as zt$1,q as qt$1,V as Vt}from'./chunk-ybe9L7-i.js';import {z as zw,g,h as hs,a as gs,W,X as Xd,p as pI,e as er,j as jn,b as WI,$ as $i,U as Uh,T as Tw,R as Ru,F as Fh,P as PD,c as Ph,L as Lu,k as kh,r as rg,N,n as ns,m as mr,q as qn,K as KI,d as XI,f as hw,i as Kh,l as zh,o as ew,t as tw,s as K,u as re,Y as Yn,v as oh,w,x as ee$1,Z as Zm,y as L,A as dD,B as Tu,C as hC,O as Ou,D as $h,E as ku,G as Gh,H as xd,I as rw,J as Rd}from'./main.js';import {M as Me,W as Wt$1,C as Ce,A as At,l as li,d as di,s as si}from'./chunk-Iw909hWz.js';import {j,P}from'./chunk-D7qjIohy.js';import {l as lo,Y as Yt$1,D as Dd,S as Sd,H as Ho,Z as Zd,a as Yd,R,m as mc,_ as _n,$ as $o,b as Dt,x as xe,V as Vc,c as bn,K as Kr,d as Se,e as Do}from'./chunk-BJQ8bCHB.js';var Gt=["*",[["mat-toolbar-row"]]],Ut=["*","mat-toolbar-row"],$t=(()=>{class o{static \u0275fac=function(e){return new(e||o)};static \u0275dir=Tu({type:o,selectors:[["mat-toolbar-row"]],hostAttrs:[1,"mat-toolbar-row"],exportAs:["matToolbarRow"]})}return o})(),jt=(()=>{class o{_elementRef=g(qn);_platform=g(R);_document=g(W);color;_toolbarRows;ngAfterViewInit(){this._platform.isBrowser&&(this._checkToolbarMixedModes(),this._toolbarRows.changes.subscribe(()=>this._checkToolbarMixedModes()));}_checkToolbarMixedModes(){this._toolbarRows.length;}static \u0275fac=function(e){return new(e||o)};static \u0275cmp=pI({type:o,selectors:[["mat-toolbar"]],contentQueries:function(e,i,n){if(e&1&&zh(n,$t,5),e&2){let s;ew(s=tw())&&(i._toolbarRows=s);}},hostAttrs:[1,"mat-toolbar"],hostVars:6,hostBindings:function(e,i){e&2&&(hw(i.color?"mat-"+i.color:""),Kh("mat-toolbar-multiple-rows",i._toolbarRows.length>0)("mat-toolbar-single-row",i._toolbarRows.length===0));},inputs:{color:"color"},exportAs:["matToolbar"],ngContentSelectors:Ut,decls:2,vars:0,template:function(e,i){e&1&&(KI(Gt),XI(0),XI(1,1));},styles:[`.mat-toolbar {
