...
`],encapsulation:2})}return n})(),dt=(()=>{class n{static \u0275fac=function(t){return new(t||n)};static \u0275dir=J({type:n,selectors:[["mat-select-trigger"]],features:[Nf([{provide:ji,useExisting:n}])]})}return n})(),mt=(()=>{class n{static \u0275fac=function(t){return new(t||n)};static \u0275mod=Q({type:n});static \u0275inj=K({imports:[rs,Dt,lt$1,Sh,me,Dt]})}return n})();function Pn(n,a){if(n&1&&(Re(0,"div",5),Zt(1),We()),n&2){let e=jS();wt(),dc(e.errorMessage());}}function Fn(n){let a=n.value;if(!a)return null;try{let e=new URL(a.trim());return ["http:","https:"].includes(e.protocol)&&e.host?null:{invalidUrl:!0}}catch{return {invalidUrl:true}}}var Oe=class n{fb=f(Oi$1);settingsService=f(F);dialogRef=f(is);data=f(Hh,{optional:true});errorMessage=B(null);form=this.fb.group({name:[this.data?.renderer?.name??"",[we.required,we.pattern(/\S/)]],rendererUrl:[this.data?.renderer?.rendererUrl??"",[we.required,Fn]]});onConfirm(){if(this.form.invalid){this.form.markAllAsTouched();return}this.errorMessage.set(null);let a=this.form.controls.name.value.trim(),e=this.form.controls.rendererUrl.value.trim(),t=this.data?.renderer?.id||`custom-${Date.now()}`;try{this.settingsService.saveCustomRenderer({id:t,name:a,rendererUrl:e}),this.dialogRef.close(t);}catch(i){this.errorMessage.set(i instanceof Error?i.message:"Failed to save custom renderer.");}}static \u0275fac=function(e){return new(e||n)};static \u0275cmp=he({type:n,selectors:[["a2ui-composer-add-renderer-dialog"]],decls:18,vars:5,consts:[["mat-dialog-title",""],[3,"ngSubmit","formGroup"],["appearance","outline",1,"full-width"],["matInput","","id","renderer-name-input","formControlName","name","placeholder","My Renderer"],["matInput","","id","renderer-url-input","formControlName","rendererUrl","placeholder","http://localhost:3000"],["role","alert",1,"error-message"],["align","end"],["mat-button","","type","button","mat-dialog-close",""],["mat-button","","type","submit","color","primary",3,"click","disabled"]],template:function(e,t){e&1&&(Re(0,"h2",0),Zt(1),We(),Re(2,"mat-dialog-content")(3,"form",1),cc("ngSubmit",function(o){return o.preventDefault(),t.onConfirm()}),Re(4,"mat-form-field",2)(5,"mat-label"),Zt(6,"Name"),We(),Dv(7,"input",3),yI(),We(),Re(8,"mat-form-field",2)(9,"mat-label"),Zt(10,"Renderer URL"),We(),Dv(11,"input",4),yI(),We(),Si(12,Pn,2,1,"div",5),We()(),Re(13,"mat-dialog-actions",6)(14,"button",7),Zt(15,"Cancel"),We(),Re(16,"button",8),cc("click",function(){return t.onConfirm()}),Zt(17),We()()),e&2&&(wt(),dc(t.data?.renderer?"Edit Custom Renderer":"Add Custom Renderer"),wt(2),xi("formGroup",t.form),wt(4),bI(),wt(4),bI(),wt(),Ti$1(t.errorMessage()?12:-1),wt(4),xi("disabled",t.form.invalid),wt(),Rf(" ",t.data?.renderer?"Save":"Add"," "));},dependencies:[Ri$1,Ni$2,Et$1,Fi$1,Ii,Un$1,kn$1,U_,k_,L_,j_,F_,me,tt,de,Dn$1,Rn$1,u_,l_],styles:["mat-dialog-content[_ngcontent-%COMP%]{padding-top:12px}.full-width[_ngcontent-%COMP%]{width:100%;margin-bottom:12px;margin-top:4px}.error-message[_ngcontent-%COMP%]{color:var(--mat-sys-error, #b3261e);font-size:.875rem;margin-top:8px}"]})};var Ie=class n{disabled=Xv(false);dialog=f(ss);destroyRef=f(ce);items=B([]);selectedItem=Ni$1(()=>{let a=this.getSelectedId();if(a)return this.items().find(e=>e.id===a)});onSelectionChange(a){a!=null&&this.emitSelection(a);}async handleAdd(a,e){e?.preventDefault(),e?.stopPropagation(),this.dialog.open(a,{width:"450px"}).afterClosed().pipe(H_(this.destroyRef)).subscribe(async i=>{i&&(await this.refreshItems(),this.emitSelection(i));});}async handleEdit(a,e,t,i){if(e.stopPropagation(),e.preventDefault(),t.readOnly)return;this.dialog.open(a,{width:"450px",data:{[i]:t}}).afterClosed().pipe(H_(this.destroyRef)).subscribe(async s=>{s&&(await this.refreshItems(),this.getSelectedId()===s&&this.emitSelection(s));});}async handleDelete(a,e,t=null){a.stopPropagation(),a.preventDefault(),!this.items().find(o=>o.id===e)?.readOnly&&(await this.deleteItem(e),await this.refreshItems(),this.getSelectedId()===e&&this.emitSelection(t));}static \u0275fac=function(e){return new(e||n)};static \u0275dir=J({type:n,inputs:{disabled:[1,"disabled"]}})};var Ln=(n,a)=>a.id;function Nn(n,a){if(n&1&&(Re(0,"span",5),Zt(1),We()),n&2){let e=jS();wt(),dc(e.selectedItem()?.rendererUrl);}}function Bn(n,a){n&1&&(Re(0,"mat-option",6),Zt(1,"No items available \u2014 click + to add"),We()),n&2&&xi("disabled",true);}function zn(n,a){if(n&1){let e=PS();Re(0,"mat-option",8)(1,"div",9)(2,"div",10),Zt(3),We(),Re(4,"div",5),Zt(5),We()(),Re(6,"button",11),cc("click",function(i){let o=Im(e).$implicit,s=jS(2);return Sm(s.onEditRenderer(i,o))})("keydown",function(i){return i.stopPropagation()}),Re(7,"mat-icon",12),Zt(8,"edit"),We()(),Re(9,"button",13),cc("click",function(i){let o=Im(e).$implicit,s=jS(2);return Sm(s.onDeleteRenderer(i,o.id))})("keydown",function(i){return i.stopPropagation()}),Re(10,"mat-icon",12),Zt(11,"delete"),We()()();}if(n&2){let e=a.$implicit;xi("value",e.id),wt(3),dc(e.name),wt(2),dc(e.rendererUrl),wt(),xi("disabled",e.readOnly)("matTooltip",e.readOnly?"Static configuration items cannot be edited":"Edit renderer"),St$1("aria-label","Edit "+e.name),wt(3),xi("disabled",e.readOnly)("matTooltip",e.readOnly?"Static configuration items cannot be deleted":"Delete renderer"),St$1("aria-label","Delete "+e.name);}}function Vn(n,a){if(n&1&&xS(0,zn,12,9,"mat-option",8,Ln),n&2){let e=jS();AS(e.items());}}var ht=class n extends Ie{selectedRendererId=Xv("default");rendererSelected=e$();settingsService=f(F);constructor(){super(),this.refreshItems();}getSelectedId(){return this.selectedRendererId()}refreshItems(){let a=this.settingsService.getRenderers();this.items.set(a);}emitSelection(a){a&&this.rendererSelected.emit(a);}deleteItem(a){this.settingsService.deleteCustomRenderer(a);}onAddRenderer(a){this.handleAdd(Oe,a);}onEditRenderer(a,e){this.handleEdit(Oe,a,e,"renderer");}onDeleteRenderer(a,e){this.handleDelete(a,e,"default");}static \u0275fac=function(e){return new(e||n)};static \u0275cmp=he({type:n,selectors:[["a2ui-composer-renderer-selector"]],inputs:{selectedRendererId:[1,"selectedRendererId"]},outputs:{rendererSelected:"rendererSelected"},features:[Ce],decls:15,vars:6,consts:[[1,"renderer-selector-container"],["appearance","outline",1,"renderer-selector-form-field"],["id","renderer-select",3,"selectionChange","value","disabled"],[1,"renderer-trigger-content"],[1,"renderer-name"],[1,"renderer-url-subtext"],[1,"empty-state-option",3,"disabled"],["mat-icon-button","","type","button","aria-label","Add custom renderer",1,"add-renderer-button",3,"click","disabled"],[1,"renderer-option",3,"value"],[1,"renderer-option-content"],[1,"renderer-option-label"],["mat-icon-button","","type","button",1,"edit-renderer-button",3,"click","keydown","disabled","matTooltip"],["aria-hidden","true"],["mat-icon-button","","type","button",1,"delete-renderer-button",3,"click","keydown","disabled","matTooltip"]],template:function(e,t){e&1&&(Re(0,"div",0)(1,"mat-form-field",1)(2,"mat-label"),Zt(3,"Renderer"),We(),Re(4,"mat-select",2),cc("selectionChange",function(o){return t.onSelectionChange(o.value)}),Re(5,"mat-select-trigger")(6,"div",3)(7,"span",4),Zt(8),We(),Si(9,Nn,2,1,"span",5),We()(),Si(10,Bn,2,1,"mat-option",6)(11,Vn,2,0),We()(),Re(12,"button",7),cc("click",function(o){return t.onAddRenderer(o)}),Re(13,"mat-icon"),Zt(14,"add_circle"),We()()()),e&2&&(wt(4),xi("value",t.selectedRendererId())("disabled",t.disabled()),wt(4),dc(t.selectedItem()?.name),wt(),Ti$1(t.selectedItem()?.rendererUrl?9:-1),wt(),Ti$1(t.items().length===0?10:11),wt(2),xi("disabled",t.disabled()));},dependencies:[me,tt,de,mt,lt,dt,ae,u_,VA,li,ai,Yt$1,mt$1,U_],styles:[".renderer-selector-container[_ngcontent-%COMP%]{display:flex;width:100%}.renderer-selector-form-field[_ngcontent-%COMP%]{flex:1}.renderer-trigger-content[_ngcontent-%COMP%]{display:flex;flex-direction:column;overflow:hidden;line-height:normal}.renderer-trigger-content[_ngcontent-%COMP%]   .renderer-name[_ngcontent-%COMP%]{font-weight:500;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.renderer-option[_ngcontent-%COMP%]{height:auto!important;line-height:normal!important;padding-top:8px!important;padding-bottom:8px!important}.renderer-option[_ngcontent-%COMP%]     .mdc-list-item__primary-text, .renderer-option[_ngcontent-%COMP%]     .mat-mdc-option-text{display:flex;align-items:center;width:100%;overflow:hidden}.renderer-option-content[_ngcontent-%COMP%]{display:flex;flex-direction:column;flex:1;min-width:0;overflow:hidden}.renderer-option-label[_ngcontent-%COMP%]{font-weight:500;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.renderer-url-subtext[_ngcontent-%COMP%]{font-size:12px;color:var(--mat-option-supporting-text-color, #666);overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.edit-renderer-button[_ngcontent-%COMP%]{margin-left:auto;flex-shrink:0;opacity:0;transition:opacity .15s ease-in-out}.renderer-option[_ngcontent-%COMP%]:hover   .edit-renderer-button[_ngcontent-%COMP%], .renderer-option[_ngcontent-%COMP%]:focus-within   .edit-renderer-button[_ngcontent-%COMP%]{opacity:1}.edit-renderer-button[disabled][_ngcontent-%COMP%]{pointer-events:auto}.delete-renderer-button[_ngcontent-%COMP%]{flex-shrink:0;opacity:0;transition:opacity .15s ease-in-out}.renderer-option[_ngcontent-%COMP%]:hover   .delete-renderer-button[_ngcontent-%COMP%], .renderer-option[_ngcontent-%COMP%]:focus-within   .delete-renderer-button[_ngcontent-%COMP%]{opacity:1}.delete-renderer-button[disabled][_ngcontent-%COMP%]{pointer-events:auto}.empty-state-option[_ngcontent-%COMP%]{font-style:italic}"]})};function Hn(n,a){if(n&1&&(Re(0,"div",7),Zt(1),We()),n&2){let e=jS();wt(),dc(e.errorMessage());}}var Te=class n{fb=f(Oi$1);settingsService=f(F);dialogRef=f(is);data=f(Hh,{optional:true});errorMessage=B(null);hideApiKey=B(true);form=this.fb.group({name:[this.data?.apiKey?.name??"",[we.required,we.pattern(/\S/)]],apiKey:[this.data?.apiKey?.key??"",[we.required,we.pattern(/\S/)]]});toggleHideApiKey(){this.hideApiKey.update(a=>!a);}async onConfirm(){if(this.form.invalid){this.form.markAllAsTouched();return}this.errorMessage.set(null);let a=this.form.controls.name.value.trim(),e=this.form.controls.apiKey.value.trim(),t=this.data?.apiKey?.id||`custom-${Date.now()}`;try{await this.settingsService.saveCustomApiKey(t,a,e),this.dialogRef.close(t);}catch(i){this.errorMessage.set(i instanceof Error?i.message:"Failed to save custom API key.");}}static \u0275fac=function(e){return new(e||n)};static \u0275cmp=he({type:n,selectors:[["a2ui-composer-add-api-key-dialog"]],decls:21,vars:8,consts:[["mat-dialog-title",""],[3,"ngSubmit","formGroup"],["appearance","outline",1,"full-width"],["matInput","","id","api-key-name-input","formControlName","name","placeholder","My Gemini Key"],["matInput","","id","api-key-value-input","formControlName","apiKey","placeholder","Paste your API key here",3,"type"],["mat-icon-button","","matSuffix","","type","button",1,"api-key-toggle-btn",3,"click"],["aria-hidden","true"],["role","alert",1,"error-message"],["align","end"],["mat-button","","type","button","mat-dialog-close",""],["mat-button","","type","submit","color","primary",3,"click","disabled"]],template:function(e,t){e&1&&(Re(0,"h2",0),Zt(1),We(),Re(2,"mat-dialog-content")(3,"form",1),cc("ngSubmit",function(o){return o.preventDefault(),t.onConfirm()}),Re(4,"mat-form-field",2)(5,"mat-label"),Zt(6,"Name"),We(),Dv(7,"input",3),yI(),We(),Re(8,"mat-form-field",2)(9,"mat-label"),Zt(10,"API Key"),We(),Dv(11,"input",4),yI(),Re(12,"button",5),cc("click",function(){return t.toggleHideApiKey()}),Re(13,"mat-icon",6),Zt(14),We()()(),Si(15,Hn,2,1,"div",7),We()(),Re(16,"mat-dialog-actions",8)(17,"button",9),Zt(18,"Cancel"),We(),Re(19,"button",10),cc("click",function(){return t.onConfirm()}),Zt(20),We()()),e&2&&(wt(),dc(t.data?.apiKey?"Edit Gemini API Key":"Add Gemini API Key"),wt(2),xi("formGroup",t.form),wt(4),bI(),wt(4),xi("type",t.hideApiKey()?"password":"text"),bI(),wt(),St$1("aria-label",t.hideApiKey()?"Show API key":"Hide API key"),wt(2),dc(t.hideApiKey()?"visibility":"visibility_off"),wt(),Ti$1(t.errorMessage()?15:-1),wt(4),xi("disabled",t.form.invalid),wt(),Rf(" ",t.data?.apiKey?"Save":"Add"," "));},dependencies:[Ri$1,Ni$2,Et$1,Fi$1,Ii,Un$1,kn$1,U_,k_,L_,j_,F_,me,tt,de,Ot,Dn$1,Rn$1,u_,l_,VA,li,ai],styles:["mat-dialog-content[_ngcontent-%COMP%]{padding-top:12px}.full-width[_ngcontent-%COMP%]{width:100%;margin-bottom:12px;margin-top:4px}.error-message[_ngcontent-%COMP%]{color:var(--mat-sys-error, #b3261e);font-size:.875rem;margin-top:8px}"]})};var Gn=(n,a)=>a.id;function jn(n,a){n&1&&(Re(0,"mat-option",3),Zt(1,"No items available \u2014 click + to add"),We()),n&2&&xi("disabled",true);}function qn(n,a){if(n&1){let e=PS();Re(0,"mat-option",5)(1,"span",6),Zt(2),We(),Re(3,"button",7),cc("keydown",function(i){return i.stopPropagation()})("click",function(i){let o=Im(e).$implicit,s=jS(2);return Sm(s.onEditApiKey(i,o))}),Re(4,"mat-icon",8),Zt(5,"edit"),We()(),Re(6,"button",9),cc("keydown",function(i){return i.stopPropagation()})("click",function(i){let o=Im(e).$implicit,s=jS(2);return Sm(s.onDeleteApiKey(i,o.id))}),Re(7,"mat-icon",8),Zt(8,"delete"),We()()();}if(n&2){let e=a.$implicit;xi("value",e.id),wt(2),dc(e.name),wt(),xi("disabled",e.readOnly)("matTooltip",e.readOnly?"Static configuration items cannot be edited":"Edit API key"),St$1("aria-label","Edit "+e.name),wt(3),xi("disabled",e.readOnly)("matTooltip",e.readOnly?"Static configuration items cannot be deleted":"Delete API key"),St$1("aria-label","Delete "+e.name);}}function Un(n,a){if(n&1&&xS(0,qn,9,8,"mat-option",5,Gn),n&2){let e=jS();AS(e.items());}}var ut=class n extends Ie{selectedApiKeyId=Xv(null);apiKeySelected=e$();settingsService=f(F);constructor(){super(),this.refreshItems();}getSelectedId(){return this.selectedApiKeyId()}async refreshItems(){let a=await this.settingsService.getAvailableApiKeys();this.items.set(a);}emitSelection(a){this.apiKeySelected.emit(a);}async deleteItem(a){await this.settingsService.deleteCustomApiKey(a);}onAddApiKey(a){this.handleAdd(Te,a);}onEditApiKey(a,e){this.handleEdit(Te,a,e,"apiKey");}onDeleteApiKey(a,e){this.handleDelete(a,e,null);}static \u0275fac=function(e){return new(e||n)};static \u0275cmp=he({type:n,selectors:[["a2ui-composer-api-key-selector"]],inputs:{selectedApiKeyId:[1,"selectedApiKeyId"]},outputs:{apiKeySelected:"apiKeySelected"},features:[Ce],decls:12,vars:5,consts:[[1,"api-key-selector-container"],["appearance","outline",1,"api-key-selector-form-field"],["id","api-key-select",3,"selectionChange","value","disabled"],[1,"empty-state-option",3,"disabled"],["mat-icon-button","","type","button","aria-label","Add Gemini API key",1,"add-api-key-button",3,"click","disabled"],[1,"api-key-option",3,"value"],[1,"api-key-option-label"],["mat-icon-button","","type","button",1,"edit-api-key-button",3,"keydown","click","disabled","matTooltip"],["aria-hidden","true"],["mat-icon-button","","type","button",1,"delete-api-key-button",3,"keydown","click","disabled","matTooltip"]],template:function(e,t){e&1&&(Re(0,"div",0)(1,"mat-form-field",1)(2,"mat-label"),Zt(3,"API Key"),We(),Re(4,"mat-select",2),cc("selectionChange",function(o){return t.onSelectionChange(o.value)}),Re(5,"mat-select-trigger"),Zt(6),We(),Si(7,jn,2,1,"mat-option",3)(8,Un,2,0),We()(),Re(9,"button",4),cc("click",function(o){return t.onAddApiKey(o)}),Re(10,"mat-icon"),Zt(11,"add_circle"),We()()()),e&2&&(wt(4),xi("value",t.selectedApiKeyId())("disabled",t.disabled()),wt(2),Rf(" ",t.selectedItem()?.name," "),wt(),Ti$1(t.items().length===0?7:8),wt(2),xi("disabled",t.disabled()));},dependencies:[me,tt,de,mt,lt,dt,ae,u_,VA,li,ai,Yt$1,mt$1,U_],styles:[".api-key-selector-container[_ngcontent-%COMP%]{display:flex;width:100%}.api-key-selector-form-field[_ngcontent-%COMP%]{flex:1}.api-key-option[_ngcontent-%COMP%]     .mdc-list-item__primary-text, .api-key-option[_ngcontent-%COMP%]     .mat-mdc-option-text{display:flex;align-items:center;width:100%;overflow:hidden}.api-key-option-label[_ngcontent-%COMP%]{flex:1;min-width:0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.edit-api-key-button[_ngcontent-%COMP%]{margin-left:auto;flex-shrink:0;opacity:0;transition:opacity .15s ease-in-out}.api-key-option[_ngcontent-%COMP%]:hover   .edit-api-key-button[_ngcontent-%COMP%], .api-key-option[_ngcontent-%COMP%]:focus-within   .edit-api-key-button[_ngcontent-%COMP%]{opacity:1}.edit-api-key-button[disabled][_ngcontent-%COMP%]{pointer-events:auto}.delete-api-key-button[_ngcontent-%COMP%]{flex-shrink:0;opacity:0;transition:opacity .15s ease-in-out}.api-key-option[_ngcontent-%COMP%]:hover   .delete-api-key-button[_ngcontent-%COMP%], .api-key-option[_ngcontent-%COMP%]:focus-within   .delete-api-key-button[_ngcontent-%COMP%]{opacity:1}.delete-api-key-button[disabled][_ngcontent-%COMP%]{pointer-events:auto}.empty-state-option[_ngcontent-%COMP%]{font-style:italic}"]})};function Qn(n,a){if(n&1){let e=PS();Re(0,"div",3)(1,"h3"),Zt(2,"Gemini API Provisioning"),We(),Re(3,"a2ui-composer-api-key-selector",18),cc("apiKeySelected",function(i){Im(e);let o=jS();return Sm(o.onApiKeySelected(i))}),We()();}if(n&2){let e=jS();wt(3),xi("selectedApiKeyId",e.selectedApiKeyId());}}function Wn(n,a){n&1&&(Re(0,"mat-card-footer",9),Zt(1," To obtain an API key: "),Re(2,"ol")(3,"li"),Zt(4," Go to "),Re(5,"a",19),Zt(6," Google AI Studio"),We(),Zt(7," and sign in with your Google account. "),We(),Re(8,"li"),Zt(9,"Click Create API key."),We(),Re(10,"li"),Zt(11,"Select or create a Google Cloud project when prompted, then click Create key."),We(),Re(12,"li"),Zt(13,"Save your key in a secure location!"),We()(),Zt(14," A2UI Composer encrypts your key and stores it locally in your browser's secure database using the "),Re(15,"a",20),Zt(16,"Web Crypto API"),We(),Zt(17,". Neither Google nor anyone else has access to this key. "),We());}function Yn(n,a){if(n&1&&(Re(0,"code"),Zt(1),We()),n&2){let e=jS();wt(),Rf("[System] Active renderer updated to ",e.activeRendererUrl());}}function Xn(n,a){if(n&1&&(Re(0,"code",16),Zt(1),We()),n&2){let e=jS();wt(),Rf("[Catalog Error] ",e.catalogErrorMessage());}}function $n(n,a){n&1&&(Re(0,"code",17),Zt(1,"[System] Catalog handshake completed successfully. Active catalog ready."),We());}function Zn(n,a){n&1&&(Re(0,"code"),Zt(1,"[System] Catalog handshake in progress. Indexing metadata..."),We());}function Jn(n,a){n&1&&(Re(0,"code"),Zt(1,"[System] Bridge connected. Initializing catalog handshake..."),We());}function ea(n,a){n&1&&(Re(0,"code"),Zt(1,"[System] Bridge disconnected. Waiting for iframe handshake initialization..."),We());}var Wi=class n{fb=f(Oi$1);startupResolution=f(Ao);startupConfigState=f(xc);hostCommunication=f(rl);catalogManagement=f(eE);configProvider=f(go);settingsService=f(F);is1PAuthEnabled=f(Tc);selectedRendererId=B(null);selectedApiKeyId=Ni$1(()=>this.settingsService.selectedApiKeyId());selectedRendererOption=Ni$1(()=>{let a=this.selectedRendererId();if(!(!a||a==="Custom"))return this.settingsService.getRenderers().find(e=>e.id===a)});isThirdParty=B(false);isApiKeyProvidedByConfig=Ni$1(()=>this.configProvider.isApiKeyProvidedByConfig());isApiKeyUnmaskDisabled=Ni$1(()=>this.isApiKeyProvidedByConfig());hideApiKey=B(true);forceThirdPartyAuth=B(false);bridgeConnected=Ni$1(()=>this.hostCommunication.latestEnvelope()!==null);catalogStatus=Ni$1(()=>this.catalogManagement.catalogError()?"Error":this.catalogManagement.isHandshakeInProgress()?"Indexing":this.catalogManagement.activeCatalog()?"Connected":"Disconnected");catalogErrorMessage=Ni$1(()=>this.catalogManagement.catalogError());activeRendererUrl=Ni$1(()=>this.startupConfigState.resolvedUrl());settingsForm=this.fb.group({});constructor(){Ut(()=>{let a=this.settingsService.selectedRendererId()||"default";Xt(()=>{this.selectedRendererId.set(a);});});}ngOnInit(){let a=this.settingsService.selectedRendererId()||"default";this.selectedRendererId.set(a),this.settingsService.getEffectiveApiKey();let e=this.startupResolution.isThirdPartyEnvironment();this.isThirdParty.set(e),this.forceThirdPartyAuth.set(this.configProvider.authType()==="3p");}async onRendererSelected(a){let e=this.selectedRendererId();this.selectedRendererId.set(a),await this.settingsService.selectRenderer(a)||this.selectedRendererId.set(e);}async onApiKeySelected(a){await this.settingsService.selectApiKey(a);}toggleHideApiKey(){this.isApiKeyUnmaskDisabled()||this.hideApiKey.set(!this.hideApiKey());}toggleForceThirdPartyAuth(){let a=!this.forceThirdPartyAuth();this.forceThirdPartyAuth.set(a),this.configProvider.setForcedAuthMode(a?"3p":"1p"),this.isThirdParty.set(this.startupResolution.isThirdPartyEnvironment());}static \u0275fac=function(e){return new(e||n)};static \u0275cmp=he({type:n,selectors:[["a2ui-composer-settings"]],decls:44,vars:12,consts:[[1,"settings-container"],[1,"settings-card"],[3,"formGroup"],[1,"form-section"],[3,"rendererSelected","selectedRendererId"],[1,"form-section","first-party-auth-section",3,"hidden"],[1,"description"],[1,"toggle-container",2,"margin-top","12px"],[3,"change","checked"],[1,"get-api-key"],[1,"status-card"],[1,"status-badges"],[1,"status-badge","bridge-badge",3,"color"],[1,"status-badge","catalog-badge",3,"color"],[1,"overlay-logs"],[1,"logs-console"],[1,"error-log",2,"color","#f44336","font-weight","bold"],[1,"success-log",2,"color","#4caf50"],[3,"apiKeySelected","selectedApiKeyId"],["href","https://aistudio.google.com/api-keys","target","_blank","rel","noopener noreferrer"],["href","https://developer.mozilla.org/en-US/docs/Web/API/Web_Crypto_API","target","_blank","rel","noopener noreferrer"]],template:function(e,t){e&1&&(Re(0,"div",0)(1,"mat-card",1)(2,"mat-card-header")(3,"mat-card-title"),Zt(4,"A2UI Composer Settings"),We()(),Re(5,"mat-card-content")(6,"form",2)(7,"div",3)(8,"h3"),Zt(9,"Renderer"),We(),Re(10,"a2ui-composer-renderer-selector",4),cc("rendererSelected",function(o){return t.onRendererSelected(o)}),We()(),Si(11,Qn,4,1,"div",3),Re(12,"div",5)(13,"h3"),Zt(14,"Developer Authentication Overrides"),We(),Re(15,"p",6),Zt(16," Simulate external 3P context to verify Gemini API key provisioning workflows. "),We(),Re(17,"div",7)(18,"mat-slide-toggle",8),cc("change",function(){return t.toggleForceThirdPartyAuth()}),Zt(19," Force External Third-Party Authentication Mode "),We()()()()(),Si(20,Wn,18,0,"mat-card-footer",9),We(),Re(21,"mat-card",10)(22,"mat-card-header")(23,"mat-card-title"),Zt(24,"Connection Status & Diagnostics"),We(),Re(25,"mat-card-subtitle"),Zt(26,"Real-time monitoring bridge"),We()(),Re(27,"mat-card-content")(28,"div",11)(29,"mat-chip-set")(30,"mat-chip",12),Zt(31),We(),Re(32,"mat-chip",13),Zt(33),We()()(),Re(34,"div",14)(35,"h4"),Zt(36,"Overlay Logs Preview"),We(),Re(37,"div",15),Si(38,Yn,2,1,"code"),Si(39,Xn,2,1,"code",16)(40,$n,2,0,"code",17)(41,Zn,2,0,"code")(42,Jn,2,0,"code")(43,ea,2,0,"code"),We()()()()()),e&2&&(wt(6),xi("formGroup",t.settingsForm),wt(4),xi("selectedRendererId",t.selectedRendererId()),wt(),Ti$1(t.isThirdParty()?11:-1),wt(),xi("hidden",!t.is1PAuthEnabled),wt(6),xi("checked",t.forceThirdPartyAuth()),wt(2),Ti$1(t.isThirdParty()?20:-1),wt(10),xi("color",t.bridgeConnected()?"primary":"accent"),wt(),Rf("Bridge: ",t.bridgeConnected()?"Connected":"Disconnected"),wt(),xi("color",t.catalogStatus()==="Connected"?"primary":t.catalogStatus()==="Indexing"?"accent":t.catalogStatus()==="Error"?"warn":void 0),wt(),Rf("Catalog Handshake: ",t.catalogStatus()),wt(5),Ti$1(t.activeRendererUrl()?38:-1),wt(),Ti$1(t.catalogErrorMessage()?39:t.catalogStatus()==="Connected"?40:t.catalogStatus()==="Indexing"?41:t.bridgeConnected()?42:43));},dependencies:[Ri$1,Ni$2,Ii,Un$1,me,Dn$1,u_,li,E,F$1,k,z,T,S,j,Li,St,Ki,Bi,It,ht,ut],styles:[`[_nghost-%COMP%]{display:block;height:100%;overflow-y:auto}.settings-container[_ngcontent-%COMP%]{padding:24px;max-width:600px;margin:0 auto}.form-section[_ngcontent-%COMP%]{margin-top:16px}.form-section[_ngcontent-%COMP%]   h3[_ngcontent-%COMP%]{margin-bottom:8px}.full-width[_ngcontent-%COMP%], a2ui-composer-renderer-selector[_ngcontent-%COMP%], a2ui-composer-api-key-selector[_ngcontent-%COMP%], mat-form-field[_ngcontent-%COMP%]{width:100%;box-sizing:border-box}.locked-notice[_ngcontent-%COMP%]{display:flex;align-items:center;gap:8px;padding:10px 14px;background-color:var(--mat-sys-error-container);color:var(--mat-sys-on-error-container);border-radius:6px;margin-bottom:16px;font-size:13px;font-weight:500}.save-error-banner[_ngcontent-%COMP%]{display:flex;align-items:center;gap:8px;padding:12px 16px;background-color:var(--mat-sys-error-container);color:var(--mat-sys-on-error-container);border-radius:6px;margin:16px 24px 0;font-size:13px;font-weight:500}.status-card[_ngcontent-%COMP%]{margin-top:24px}.status-badges[_ngcontent-%COMP%]{margin-top:12px;margin-bottom:16px}.overlay-logs[_ngcontent-%COMP%]   h4[_ngcontent-%COMP%]{margin-bottom:8px;font-size:14px}.overlay-logs[_ngcontent-%COMP%]   .logs-console[_ngcontent-%COMP%]{background-color:var(--mat-sys-surface-container-lowest);color:var(--mat-sys-primary);padding:12px;border-radius:6px;font-family:monospace;font-size:12px;line-height:1.5}  body .mat-mdc-slide-toggle .mat-internal-form-field,   body .mat-mdc-slide-toggle .mdc-form-field{display:inline-flex!important;align-items:center!important;gap:16px!important}  body .mat-mdc-slide-toggle label,   body .mat-mdc-slide-toggle .mdc-label{padding-left:16px!important;white-space:normal!important;line-height:1.4!important;color:var(--mat-sys-on-surface)!important}.warning-hint[_ngcontent-%COMP%]{color:var(--mat-sys-on-surface-variant);display:block;margin-top:4px}.get-api-key[_ngcontent-%COMP%]{font-size:var(--mat-sys-body-small-size, 12px);padding-left:24px;padding-bottom:12px}
