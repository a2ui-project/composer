import {f,a6 as pe,a as fe,h as hc,q,ad as lq,aN as Po,N as cq,ak as ce$1,aO as Hn,ae as zn,af as Os,p as S,b as fo,aP as Fn,n as ne,aQ as Xa,an as Z,ao as _,R as me,aR as zc,aS as qM,aT as P,aU as Xf,aV as y$1,aW as Zt$1,aX as bo,aY as Ve,aZ as _r,a_ as EG,a$ as an,b0 as wr,b1 as wo,b2 as qi,b3 as C,t as Q,Y,b4 as Yi,b5 as Er,U as Ub,x as st$1,C as Ci,e as ue,V as Vb,A as Ae,W as Wt,H as He,v as vi,k as wt$1,y as yf,o as bi,b6 as _o,b7 as R,z as U$1,a8 as tc,J,d as O,aj as I,b8 as Mt$1,aw as Ut,b9 as Wi,ba as De,ar as oo,Q as Qy,S as St$1,j as qa,l as $e,bb as wi,F as Ya,K as Ka,G as K,aC as eS,at as rS,aD as tm,aE as nm}from'./main.js';import {e}from'./chunk-CLNpRTgV.js';import {m,d,y}from'./chunk-2nTkU-o5.js';function ht(r,n){if(r&1){let e=eS();Ae(0,"div",1)(1,"button",2),qa("click",function(){tm(e);let a=rS();return nm(a.action())}),Wt(2),He()();}if(r&2){let e=rS();wt$1(2),yf(" ",e.data.action," ");}}var ft=["label"];function gt(r,n){}var yt=Math.pow(2,31)-1,E=class{_overlayRef;instance;containerInstance;_afterDismissed=new I;_afterOpened=new I;_onAction=new I;_durationTimeoutId;_dismissedByAction=false;constructor(n,e){this._overlayRef=e,this.containerInstance=n,n._onExit.subscribe(()=>this._finishDismiss());}dismiss(){this._afterDismissed.closed||this.containerInstance.exit(),clearTimeout(this._durationTimeoutId);}dismissWithAction(){this._onAction.closed||(this._dismissedByAction=true,this._onAction.next(),this._onAction.complete(),this.dismiss()),clearTimeout(this._durationTimeoutId);}closeWithAction(){this.dismissWithAction();}_dismissAfter(n){this._durationTimeoutId=setTimeout(()=>this.dismiss(),Math.min(n,yt));}_open(){this._afterOpened.closed||(this._afterOpened.next(),this._afterOpened.complete());}_finishDismiss(){this._overlayRef.dispose(),this._onAction.closed||this._onAction.complete(),this._afterDismissed.next({dismissedByAction:this._dismissedByAction}),this._afterDismissed.complete(),this._dismissedByAction=false;}afterDismissed(){return this._afterDismissed}afterOpened(){return this.containerInstance._onEnter}onAction(){return this._onAction}},nt=new y$1("MatSnackBarData"),A=class{politeness="polite";announcementMessage="";viewContainerRef;duration=0;panelClass;direction;data=null;horizontalPosition="center";verticalPosition="bottom"},vt=(()=>{class r{static \u0275fac=function(t){return new(t||r)};static \u0275dir=K({type:r,selectors:[["","matSnackBarLabel",""]],hostAttrs:[1,"mat-mdc-snack-bar-label","mdc-snackbar__label"]})}return r})(),bt=(()=>{class r{static \u0275fac=function(t){return new(t||r)};static \u0275dir=K({type:r,selectors:[["","matSnackBarActions",""]],hostAttrs:[1,"mat-mdc-snack-bar-actions","mdc-snackbar__actions"]})}return r})(),_t=(()=>{class r{static \u0275fac=function(t){return new(t||r)};static \u0275dir=K({type:r,selectors:[["","matSnackBarAction",""]],hostAttrs:[1,"mat-mdc-snack-bar-action","mdc-snackbar__action"]})}return r})(),at=(()=>{class r{snackBarRef=f(E);data=f(nt);action(){this.snackBarRef.dismissWithAction();}get hasAction(){return !!this.data.action}static \u0275fac=function(t){return new(t||r)};static \u0275cmp=ue({type:r,selectors:[["simple-snack-bar"]],hostAttrs:[1,"mat-mdc-simple-snack-bar"],exportAs:["matSnackBar"],decls:3,vars:2,consts:[["matSnackBarLabel",""],["matSnackBarActions",""],["matButton","","matSnackBarAction","",3,"click"]],template:function(t,a){t&1&&(Ae(0,"div",0),Wt(1),He(),vi(2,ht,3,1,"div",1)),t&2&&(wt$1(),yf(" ",a.data.message,`
`),wt$1(),bi(a.hasAction?2:-1));},dependencies:[Vb,vt,bt,_t],styles:[`.mat-mdc-simple-snack-bar {
  display: flex;
}
