import {f,a6 as me,i as ie$1,v as vc,Y,ad as Fq,aO as Lo,L as Pq,ak as te,aP as Hn,ae as zn,af as Ls,m as T,p as po,aQ as Fn,ab as Kc,e,aR as Xa,an as W,ao as v,S as fe$1,aS as es,I as Ii}from'./main.js';import {e as e$1}from'./chunk-CLNpRTgV.js';import {d,f as f$1,c}from'./chunk-DLqZzcsn.js';import {s}from'./chunk-D2d45eFV.js';var ae=`[
  {
    "version": "v0.9",
    "createSurface": {
...
`;var w="updateComponents",j="components",he="registerMockRules",fe="mockRulesConfig",ge="rules",ye="id",ve="children",ne="mock_rules_container",_=class i{destroyRef=f(me);chatState=f(s);catalogManagement=f(ie$1);startupConfigState=f(vc);previousCatalogId=null;isDraftModified=false;_activeDraft=Y("");activeDraft=this._activeDraft.asReadonly();_draftInput=Y("");constructor(){Fq(this.startupConfigState.selectedRendererId).pipe(Lo(1),Pq(this.destroyRef)).subscribe(()=>{this.flushDraft();}),Fq(this.catalogManagement.activeCatalog).pipe(te(t=>!!t),Pq(this.destroyRef)).subscribe(t=>{let n=t.catalogId||t.$id||"",a=this.previousCatalogId===null,r=this.previousCatalogId!==null&&this.previousCatalogId!==n;if((a||r)&&!this.isDraftModified){let s=this.getInitialDraft(n);this._activeDraft.set(s),this._draftInput.set(s);}this.previousCatalogId=n;}),(this.startupConfigState.sharedA2uiPayload?Fq(this.startupConfigState.sharedA2uiPayload):Hn(null)).pipe(te(t=>!!t),Pq(this.destroyRef)).subscribe(t=>{this.injectExternalDraft(t);}),Fq(this._draftInput).pipe(Lo(1),zn(300),Ls(),Pq(this.destroyRef)).subscribe(t=>{this.syncLayoutToHistory(t);});}updateDraft(e){this.isDraftModified=true,this._activeDraft.set(e),this._draftInput.set(e);}injectExternalDraft(e){this.isDraftModified=true,this._activeDraft.set(e),this._draftInput.set(e);}hydrateActiveDraft(){return this._activeDraft()}commitLayoutFromLlm(e){this.isDraftModified=true,this._activeDraft.set(e);}flushDraft(){this.isDraftModified=false,this.previousCatalogId=null;let e=this.catalogManagement.activeCatalog(),t=e&&(e.catalogId||e.$id)||"";!this.startupConfigState.activeRenderer()?.samplePayload&&!t&&(t="https://a2ui.org/specification/v0_9/basic_catalog.json");let a=this.getInitialDraft(t);this._activeDraft.set(a),this._draftInput.set(a);}getInitialDraft(e){let t=this.startupConfigState.activeRenderer();return t?.samplePayload?t.samplePayload:e==="https://a2ui.org/specification/v0_9/basic_catalog.json"?ae:e?d([{version:"v0.9",createSurface:{surfaceId:"sample-surface",catalogId:e,sendDataModel:true}}]):""}syncLayoutToHistory(e){let t=this.sanitizeLayout(e);if(!t)return;let n=this.chatState.chatHistory();if(n.length===0){this.chatState.setChatHistory([{role:"user",content:t}]);return}let a=n[n.length-1];if(a.role==="user"&&a.content.trim().startsWith("[")){let s=[...n];s[s.length-1]={role:"user",content:t},this.chatState.setChatHistory(s);}else this.chatState.updateChatHistory(s=>[...s,{role:"user",content:t}]);}sanitizeLayout(e){let t=e.trim();if(!t)return "";let n=f$1(t);if(n.success){let a=n.data.map(r=>r&&typeof r=="object"&&!Array.isArray(r)?this.sanitizeBlock(r):r).filter(r=>r!==null);return d(a)}return console.warn("[StateSync] Discarding malformed layout JSON during sanitization: not a valid JSON array"),""}sanitizeBlock(e){if(e[he]||e[fe])return null;if(e[w]&&typeof e[w]=="object"&&e[w]!==null){let t=e[w];if(Array.isArray(t[j])){let n=t[j].filter(a=>a!==null&&typeof a=="object"&&!Array.isArray(a)?a[ye]!==ne:true);t[j]=n.map(a=>a!==null&&typeof a=="object"&&!Array.isArray(a)?this.sanitizeComponentObject(a):a);}}return e}sanitizeComponentObject(e){let t={};for(let[n,a]of Object.entries(e))n===ge||/^mock/i.test(n)||(n===ve&&Array.isArray(a)?t[n]=a.filter(r=>r!==ne):a!==null&&typeof a=="object"&&!Array.isArray(a)?t[n]=this.sanitizeComponentObject(a):Array.isArray(a)?t[n]=a.map(r=>r!==null&&typeof r=="object"&&!Array.isArray(r)?this.sanitizeComponentObject(r):r):t[n]=a);return t}static \u0275fac=function(t){return new(t||i)};static \u0275prov=T({token:i,factory:i.\u0275fac,providedIn:"root"})};var re=/```(?:jsonl?|jsonlines|a2ui|html|xml)?\s*([\s\S]*?)\s*```/gi,oe=/<(thought|thinking|reasoning)>([\s\S]*?)(?:<\/\1>|$)/gi,ie=/\s*●●●\s*$/g;function se(i){return i.length>0&&i.some(e=>{if(e&&typeof e=="object"&&!Array.isArray(e)){let t=Object.keys(e);return t.includes("version")||t.includes("createSurface")||t.includes("updateComponents")||t.includes("updateDataModel")||t.includes("deleteSurface")}return  false})}var P=class i{PULSE_INDICATOR="\u25CF\u25CF\u25CF";appendPulse(e){return `${e??""} ${this.PULSE_INDICATOR}`}stripPulse(e){return e?(ie.lastIndex=0,e.replace(ie,"").trim()):""}stripThinkingTags(e){return e?(oe.lastIndex=0,e.replace(oe,"").trim()):""}extractCodeFences(e){if(!e)return {extracted:"",hasFences:false};re.lastIndex=0;let t=Array.from(e.matchAll(re));return t.length>0?{extracted:t.map(n=>n[1].trim()).join(`
`),hasFences:true}:{extracted:e.trim(),hasFences:false}}cleanPayload(e){if(!e)return "";let t=this.stripPulse(e);if(t=this.stripThinkingTags(t),t=this.extractCodeFences(t).extracted,!t.startsWith("{")&&!t.startsWith("[")){let a=Array.from(t.matchAll(/[\{\[]/g));for(let r of a)if(r.index!==void 0&&r.index>=0){let s=t.substring(r.index).trim();if(s.startsWith("{")&&s.includes('"version"')||s.startsWith("[")&&/^\[\s*[\{\"]/.test(s)&&(s.includes('"version"')||s.includes('"createSurface"')||s.includes('"updateComponents"'))){t=s;break}let o=f$1(s);if(o.success&&se(o.data)){t=s;break}}}return t.trim()}isLayoutSnapshot(e){if(!e)return  false;let t=this.cleanPayload(e);if(t.startsWith('{"version"')||t.startsWith("{")&&t.includes('"version"')||t.startsWith("[")&&(t.includes('"version"')||t.includes('"createSurface"')||t.includes('"updateComponents"')))return  true;let n=f$1(t);return n.success&&se(n.data)}static \u0275fac=function(t){return new(t||i)};static \u0275prov=T({token:i,factory:i.\u0275fac,providedIn:"root"})};function le(i){if(i==null||i.trim().length===0)return {success:false,error:"No valid A2UI JSON layout command block could be parsed or recovered."};let e=f$1(i);if(e.success)return {success:true,isConversational:false,blocks:e.data,count:F(e.data)};let t=i.trim();if(t.startsWith("{")||t.startsWith("[")){let o=ce(i);if(o!==null&&typeof o=="object"){let c=Array.isArray(o)?o:[o];return {success:true,isConversational:false,blocks:c,count:F(c)}}}let a=i.split(`
`).map((o,c)=>({text:(o||"").trim(),originalIndex:c})).filter(o=>o.text.length>0),r=[],s=false;for(let o of a)if(!(o.text.startsWith("```")||!o.text.startsWith("{")&&!o.text.startsWith("["))){s=true;try{r.push(JSON.parse(o.text));}catch(c$1){let u=ce(o.text);if(u!==null)r.push(u);else {let l=c(c$1,o.text);return {success:false,error:c$1?.message??"Syntax recovery failed",line:o.originalIndex+1,column:l.column,snippet:o.text}}}}if(r.length===0){if(s){let o=e.error;return {success:false,error:o?.message??"Syntax recovery failed",line:o?.line,column:o?.column,snippet:o?.snippet}}return {success:true,isConversational:true,blocks:[],count:0}}return {success:true,isConversational:false,blocks:r,count:F(r)}}function ce(i){if(i==null||i.trim().length===0)return null;let e=i.trim();e=e.replace(/,\s*([\]}])/g,"$1");try{return JSON.parse(e)}catch{for(let n=1;n<=5;n++)try{return JSON.parse(e+"}".repeat(n))}catch{}for(let n=1;n<=3;n++)for(let a=1;a<=3;a++)try{return JSON.parse(e+"}".repeat(n)+"]".repeat(a))}catch{}for(let n=1;n<=3;n++)for(let a=1;a<=3;a++)try{return JSON.parse(e+"]".repeat(n)+"}".repeat(a))}catch{}}return null}function Se(i){if(!i||typeof i!="object")return  false;let e=i;if(!e.updateComponents||typeof e.updateComponents!="object")return  false;let t=e.updateComponents;return Array.isArray(t.components)}function ue(i,e){let t=false,n={};if(e)for(let r of Object.keys(e)){let s=r.toLowerCase().replace(/[^a-z]/g,"");n[s]=r;}let a={textbox:"textfield",textinput:"textfield",rowlayout:"row",columnlayout:"column",choice:"choicepicker",datepicker:"datetimeinput",datetimepicker:"datetimeinput"};for(let r of i){if(!Se(r))continue;let s=r.updateComponents,o=[];for(let c of s.components){if(!c||typeof c!="object"||Array.isArray(c)){o.push(c);continue}let u=c,l=u.component;if(u.name&&!u.component&&(t=true,l=u.name,u.component=l,delete u.name),typeof l!="string")throw new Error("Component declaration is missing component type name string.");let d=l;if(e&&!e[l]){let p=l.toLowerCase().replace(/[^a-z]/g,""),g=n[p];if(!g){let f=a[p];f&&(g=n[f]);}if(g&&e[g])t=true,d=g;else {let f=p?Object.keys(e).find(C=>C.toLowerCase().includes(p)||p.includes(C.toLowerCase())):void 0;if(f)t=true,d=f;else throw new Error(`Validation failure: Component type "${l}" is not registered in the active custom catalog.`)}}let h=be(u);h.component=d,o.push(h);}s.components=o;}return t}function H(i){if(i===null||typeof i!="object")return i;if(Array.isArray(i))return i.map(n=>H(n));let e=i,t={};for(let[n,a]of Object.entries(e))n==="__proto__"||n==="constructor"||n==="prototype"||(t[n]=H(a));return t}function be(i){return H(i)}function F(i){return i.reduce((e,t)=>!t||typeof t!="object"?e:t.updateComponents&&Array.isArray(t.updateComponents.components)?e+t.updateComponents.components.length:t.createSurface?e+1:e,0)}var E=class i{catalogManagement=f(ie$1);systemPrompt=Ii(()=>{let e=this.catalogManagement.activeCatalog();return e?this.generateSystemPrompt(d(e)):`
