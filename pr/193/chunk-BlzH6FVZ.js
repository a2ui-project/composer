import {f,a6 as pe,h as he,p as pc,q,ac as cq,aM as Po,P as aq,aj as te,aN as Hn,ad as zn,ae as ks,T,a as fo,aO as Fn,e,aP as Xa,am as Z,an as _,R as me,aQ as Qi,aR as WM,aS as P,aT as Zf,aU as y,aV as Zt$1,aW as bo,aX as Ve,aY as _r,aZ as _G,a_ as an,a$ as wr,b0 as wo,b1 as qi,b2 as C,Q,r as Y,b3 as Yi,b4 as Er,B as Bb,t as st$1,C as Ci,d as de,j as jb,A as Ae,W as Wt,H as He,v as vi,k as wt$1,l as gf,n as bi,b5 as _o,b6 as R,U as U$1,a8 as nc,J,b as O,ai as S,b7 as Mt$1,av as Ut,b8 as Wi,b9 as De,aq as oo,Z as Zy,S as St$1,Y as Ya,$ as $e,ba as wi,K as Ka,F as Za,G as K,aB as QI,as as tS,aC as Jp,aD as em}from'./main.js';import {e as e$1}from'./chunk-CLNpRTgV.js';import {u,a}from'./chunk-CfU6lDs_.js';import {s}from'./chunk-C-XUddUq.js';function ht(r,n){if(r&1){let e=QI();Ae(0,"div",1)(1,"button",2),Ya("click",function(){Jp(e);let a=tS();return em(a.action())}),Wt(2),He()();}if(r&2){let e=tS();wt$1(2),gf(" ",e.data.action," ");}}var ft=["label"];function gt(r,n){}var yt=Math.pow(2,31)-1,E=class{_overlayRef;instance;containerInstance;_afterDismissed=new S;_afterOpened=new S;_onAction=new S;_durationTimeoutId;_dismissedByAction=false;constructor(n,e){this._overlayRef=e,this.containerInstance=n,n._onExit.subscribe(()=>this._finishDismiss());}dismiss(){this._afterDismissed.closed||this.containerInstance.exit(),clearTimeout(this._durationTimeoutId);}dismissWithAction(){this._onAction.closed||(this._dismissedByAction=true,this._onAction.next(),this._onAction.complete(),this.dismiss()),clearTimeout(this._durationTimeoutId);}closeWithAction(){this.dismissWithAction();}_dismissAfter(n){this._durationTimeoutId=setTimeout(()=>this.dismiss(),Math.min(n,yt));}_open(){this._afterOpened.closed||(this._afterOpened.next(),this._afterOpened.complete());}_finishDismiss(){this._overlayRef.dispose(),this._onAction.closed||this._onAction.complete(),this._afterDismissed.next({dismissedByAction:this._dismissedByAction}),this._afterDismissed.complete(),this._dismissedByAction=false;}afterDismissed(){return this._afterDismissed}afterOpened(){return this.containerInstance._onEnter}onAction(){return this._onAction}},nt=new y("MatSnackBarData"),A=class{politeness="polite";announcementMessage="";viewContainerRef;duration=0;panelClass;direction;data=null;horizontalPosition="center";verticalPosition="bottom"},vt=(()=>{class r{static \u0275fac=function(t){return new(t||r)};static \u0275dir=K({type:r,selectors:[["","matSnackBarLabel",""]],hostAttrs:[1,"mat-mdc-snack-bar-label","mdc-snackbar__label"]})}return r})(),bt=(()=>{class r{static \u0275fac=function(t){return new(t||r)};static \u0275dir=K({type:r,selectors:[["","matSnackBarActions",""]],hostAttrs:[1,"mat-mdc-snack-bar-actions","mdc-snackbar__actions"]})}return r})(),_t=(()=>{class r{static \u0275fac=function(t){return new(t||r)};static \u0275dir=K({type:r,selectors:[["","matSnackBarAction",""]],hostAttrs:[1,"mat-mdc-snack-bar-action","mdc-snackbar__action"]})}return r})(),at=(()=>{class r{snackBarRef=f(E);data=f(nt);action(){this.snackBarRef.dismissWithAction();}get hasAction(){return !!this.data.action}static \u0275fac=function(t){return new(t||r)};static \u0275cmp=de({type:r,selectors:[["simple-snack-bar"]],hostAttrs:[1,"mat-mdc-simple-snack-bar"],exportAs:["matSnackBar"],decls:3,vars:2,consts:[["matSnackBarLabel",""],["matSnackBarActions",""],["matButton","","matSnackBarAction","",3,"click"]],template:function(t,a){t&1&&(Ae(0,"div",0),Wt(1),He(),vi(2,ht,3,1,"div",1)),t&2&&(wt$1(),gf(" ",a.data.message,`
`),wt$1(),bi(a.hasAction?2:-1));},dependencies:[jb,vt,bt,_t],styles:[`.mat-mdc-simple-snack-bar {
  display: flex;
}
