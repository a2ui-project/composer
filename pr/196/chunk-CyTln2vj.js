import {a as f,a6 as he$1,o as oe$1,g as gc,q,ad as Nq,aO as Lo,R as Rq,ak as ce$1,aP as Hn,ae as zn,af as Fs,T,h as ho,aQ as Hn$1,ab as Kc,J,aR as Xa,an as Z,ao as _$1,M as ge$1,aS as Yc,S as Si}from'./main.js';import {e}from'./chunk-CLNpRTgV.js';import {y,p,g,d}from'./chunk-DsKPoGH1.js';var ae=`[
  {
    "version": "v0.9",
    "createSurface": {
...
`;var w="updateComponents",j="components",he="registerMockRules",fe="mockRulesConfig",ge="rules",ye="id",ve="children",ne="mock_rules_container",_=class o{destroyRef=f(he$1);chatState=f(y);catalogManagement=f(oe$1);startupConfigState=f(gc);previousCatalogId=null;isDraftModified=false;_activeDraft=q("");activeDraft=this._activeDraft.asReadonly();_draftInput=q("");constructor(){Nq(this.startupConfigState.selectedRendererId).pipe(Lo(1),Rq(this.destroyRef)).subscribe(()=>{this.flushDraft();}),Nq(this.catalogManagement.activeCatalog).pipe(ce$1(t=>!!t),Rq(this.destroyRef)).subscribe(t=>{let n=t.catalogId||t.$id||"",a=this.previousCatalogId===null,r=this.previousCatalogId!==null&&this.previousCatalogId!==n;if((a||r)&&!this.isDraftModified){let i=this.getInitialDraft(n);this._activeDraft.set(i),this._draftInput.set(i);}this.previousCatalogId=n;}),(this.startupConfigState.sharedA2uiPayload?Nq(this.startupConfigState.sharedA2uiPayload):Hn(null)).pipe(ce$1(t=>!!t),Rq(this.destroyRef)).subscribe(t=>{this.injectExternalDraft(t);}),Nq(this._draftInput).pipe(Lo(1),zn(300),Fs(),Rq(this.destroyRef)).subscribe(t=>{this.syncLayoutToHistory(t);});}updateDraft(e){this.isDraftModified=true,this._activeDraft.set(e),this._draftInput.set(e);}injectExternalDraft(e){this.isDraftModified=true,this._activeDraft.set(e),this._draftInput.set(e);}hydrateActiveDraft(){return this._activeDraft()}commitLayoutFromLlm(e){this.isDraftModified=true,this._activeDraft.set(e);}flushDraft(){this.isDraftModified=false,this.previousCatalogId=null;let e=this.catalogManagement.activeCatalog(),t=e&&(e.catalogId||e.$id)||"";!this.startupConfigState.activeRenderer()?.samplePayload&&!t&&(t="https://a2ui.org/specification/v0_9/basic_catalog.json");let a=this.getInitialDraft(t);this._activeDraft.set(a),this._draftInput.set(a);}getInitialDraft(e){let t=this.startupConfigState.activeRenderer();return t?.samplePayload?t.samplePayload:e==="https://a2ui.org/specification/v0_9/basic_catalog.json"?ae:e?p([{version:"v0.9",createSurface:{surfaceId:"sample-surface",catalogId:e,sendDataModel:true}}]):""}syncLayoutToHistory(e){let t=this.sanitizeLayout(e);if(!t)return;let n=this.chatState.chatHistory();if(n.length===0){this.chatState.setChatHistory([{role:"user",content:t}]);return}let a=n[n.length-1];if(a.role==="user"&&a.content.trim().startsWith("[")){let i=[...n];i[i.length-1]={role:"user",content:t},this.chatState.setChatHistory(i);}else this.chatState.updateChatHistory(i=>[...i,{role:"user",content:t}]);}sanitizeLayout(e){let t=e.trim();if(!t)return "";let n=g(t);if(n.success){let a=n.data.map(r=>r&&typeof r=="object"&&!Array.isArray(r)?this.sanitizeBlock(r):r).filter(r=>r!==null);return p(a)}return console.warn("[StateSync] Discarding malformed layout JSON during sanitization: not a valid JSON array"),""}sanitizeBlock(e){if(e[he]||e[fe])return null;if(e[w]&&typeof e[w]=="object"&&e[w]!==null){let t=e[w];if(Array.isArray(t[j])){let n=t[j].filter(a=>a!==null&&typeof a=="object"&&!Array.isArray(a)?a[ye]!==ne:true);t[j]=n.map(a=>a!==null&&typeof a=="object"&&!Array.isArray(a)?this.sanitizeComponentObject(a):a);}}return e}sanitizeComponentObject(e){let t={};for(let[n,a]of Object.entries(e))n===ge||/^mock/i.test(n)||(n===ve&&Array.isArray(a)?t[n]=a.filter(r=>r!==ne):a!==null&&typeof a=="object"&&!Array.isArray(a)?t[n]=this.sanitizeComponentObject(a):Array.isArray(a)?t[n]=a.map(r=>r!==null&&typeof r=="object"&&!Array.isArray(r)?this.sanitizeComponentObject(r):r):t[n]=a);return t}static \u0275fac=function(t){return new(t||o)};static \u0275prov=T({token:o,factory:o.\u0275fac,providedIn:"root"})};var re=/```(?:jsonl?|jsonlines|a2ui|html|xml)?\s*([\s\S]*?)\s*```/gi,oe=/<(thought|thinking|reasoning)>([\s\S]*?)(?:<\/\1>|$)/gi,ie=/\s*●●●\s*$/g;function se(o){return o.length>0&&o.some(e=>{if(e&&typeof e=="object"&&!Array.isArray(e)){let t=Object.keys(e);return t.includes("version")||t.includes("createSurface")||t.includes("updateComponents")||t.includes("updateDataModel")||t.includes("deleteSurface")}return  false})}var E=class o{PULSE_INDICATOR="\u25CF\u25CF\u25CF";appendPulse(e){return `${e??""} ${this.PULSE_INDICATOR}`}stripPulse(e){return e?(ie.lastIndex=0,e.replace(ie,"").trim()):""}stripThinkingTags(e){return e?(oe.lastIndex=0,e.replace(oe,"").trim()):""}extractCodeFences(e){if(!e)return {extracted:"",hasFences:false};re.lastIndex=0;let t=Array.from(e.matchAll(re));return t.length>0?{extracted:t.map(n=>n[1].trim()).join(`
`),hasFences:true}:{extracted:e.trim(),hasFences:false}}cleanPayload(e){if(!e)return "";let t=this.stripPulse(e);if(t=this.stripThinkingTags(t),t=this.extractCodeFences(t).extracted,!t.startsWith("{")&&!t.startsWith("[")){let a=Array.from(t.matchAll(/[\{\[]/g));for(let r of a)if(r.index!==void 0&&r.index>=0){let i=t.substring(r.index).trim();if(i.startsWith("{")&&i.includes('"version"')||i.startsWith("[")&&/^\[\s*[\{\"]/.test(i)&&(i.includes('"version"')||i.includes('"createSurface"')||i.includes('"updateComponents"'))){t=i;break}let u=g(i);if(u.success&&se(u.data)){t=i;break}}}return t.trim()}isLayoutSnapshot(e){if(!e)return  false;let t=this.cleanPayload(e);if(t.startsWith('{"version"')||t.startsWith("{")&&t.includes('"version"')||t.startsWith("[")&&(t.includes('"version"')||t.includes('"createSurface"')||t.includes('"updateComponents"')))return  true;let n=g(t);return n.success&&se(n.data)}static \u0275fac=function(t){return new(t||o)};static \u0275prov=T({token:o,factory:o.\u0275fac,providedIn:"root"})};function le(o){if(o==null||o.trim().length===0)return {success:true,isConversational:true,blocks:[],count:0};let e=g(o);if(e.success)return {success:true,isConversational:false,blocks:e.data,count:F(e.data)};let t=o.trim();if(t.startsWith("{")||t.startsWith("[")){let s=ce(o);if(s!==null&&typeof s=="object"){let c=Array.isArray(s)?s:[s];return {success:true,isConversational:false,blocks:c,count:F(c)}}}let a=o.split(`
`).map((s,c)=>({text:(s||"").trim(),originalIndex:c})).filter(s=>s.text.length>0),r=[],i=false,u=null;for(let s of a)if(!(s.text.startsWith("```")||!s.text.startsWith("{")&&!s.text.startsWith("["))){i=true;try{r.push(JSON.parse(s.text));}catch(c){let l=ce(s.text);if(l!==null)r.push(l);else if(!u){let d$1=d(c,s.text);u={success:false,error:c?.message??"Syntax recovery failed",line:s.originalIndex+1,column:d$1.column,snippet:s.text};}}}if(r.length===0){if(u)return u;if(i){let s=e.error;return {success:false,error:s?.message??"Syntax recovery failed",line:s?.line,column:s?.column,snippet:s?.snippet}}return {success:true,isConversational:true,blocks:[],count:0}}return {success:true,isConversational:false,blocks:r,count:F(r)}}function ce(o){if(o==null||o.trim().length===0)return null;let e=o.trim();if(e.length>256*1024)return null;e=e.replace(/,\s*([\]}])/g,"$1");try{return JSON.parse(e)}catch{for(let n=1;n<=5;n++)try{return JSON.parse(e+"}".repeat(n))}catch{}for(let n=1;n<=3;n++)for(let a=1;a<=3;a++)try{return JSON.parse(e+"}".repeat(n)+"]".repeat(a))}catch{}for(let n=1;n<=3;n++)for(let a=1;a<=3;a++)try{return JSON.parse(e+"]".repeat(n)+"}".repeat(a))}catch{}}return null}function Se(o){if(!o||typeof o!="object")return  false;let e=o;if(!e.updateComponents||typeof e.updateComponents!="object")return  false;let t=e.updateComponents;return Array.isArray(t.components)}function ue(o,e){let t=false,n={};if(e)for(let r of Object.keys(e)){let i=r.toLowerCase().replace(/[^a-z]/g,"");n[i]=r;}let a={textbox:"textfield",textinput:"textfield",rowlayout:"row",columnlayout:"column",choice:"choicepicker",datepicker:"datetimeinput",datetimepicker:"datetimeinput"};for(let r of o){if(!Se(r))continue;let i=r.updateComponents,u=[];for(let s of i.components){if(!s||typeof s!="object"||Array.isArray(s)){u.push(s);continue}let c=s,l=c.component;if(c.name&&!c.component&&(t=true,l=c.name,c.component=l,delete c.name),typeof l!="string")throw new Error("Component declaration is missing component type name string.");let d=l;if(e&&!e[l]){let p=l.toLowerCase().replace(/[^a-z]/g,""),g=n[p];if(!g){let f=a[p];f&&(g=n[f]);}if(g&&e[g])t=true,d=g;else {let f=p?Object.keys(e).find(C=>C.toLowerCase().includes(p)||p.includes(C.toLowerCase())):void 0;if(f)t=true,d=f;else throw new Error(`Validation failure: Component type "${l}" is not registered in the active custom catalog.`)}}let h=be(c);h.component=d,u.push(h);}i.components=u;}return t}function z(o){if(o===null||typeof o!="object")return o;if(Array.isArray(o))return o.map(n=>z(n));let e=o,t={};for(let[n,a]of Object.entries(e))n==="__proto__"||n==="constructor"||n==="prototype"||(t[n]=z(a));return t}function be(o){return z(o)}function F(o){return o.reduce((e,t)=>!t||typeof t!="object"?e:t.updateComponents&&Array.isArray(t.updateComponents.components)?e+t.updateComponents.components.length:t.createSurface?e+1:e,0)}var P=class o{catalogManagement=f(oe$1);systemPrompt=Si(()=>{let e=this.catalogManagement.activeCatalog();return e?this.generateSystemPrompt(p(e)):`
  ...
  **IMPORTANT**: The component names used in the examples below (Column, Text,
  ...
  \`\`\`
  `}static \u0275fac=function(t){return new(t||o)};static \u0275prov=T({token:o,factory:o.\u0275fac,providedIn:"root"})};var O=class o{isConnectivityError(e){return e?e.includes("failed to fetch")||e.includes("fetch")||e.includes("timeout")||e.includes("504")||e.includes("proxy")||e.includes("networkerror")||e.includes("connection")||e.includes("401")||e.includes("403")||e.includes("credential")||e.includes("quota")||e.includes("blocked")||e.includes("503")||e.includes("unavailable")||e.includes("api key")||e.includes("apikey"):false}parseError(e,t,n=false){let a=e??"",r=t??"",i="Connectivity Failure",u=r.trim().startsWith("{"),s=u?"A connectivity error occurred.":r,c=u?"Details: "+r:void 0,l="Tip: Please check your network proxy configurations or verify your settings to restore connections.",d=n,h=true,p=this.isConnectivityError(a);return a.includes("validation")||a.includes("syntax recovery")||a.includes("validation failure")?{errorTitle:"Validation Failure",errorMessage:"The generated layout contains invalid components or structure.",errorTip:"Tip: Try rephrasing your prompt to guide the model to generate valid components.",isRetryable:n,showDetails:true,errorDetails:"Details: "+r,isConnectivityFailure:p}:a.includes("503")||a.includes("unavailable")?{errorTitle:"Service Unavailable",errorMessage:"The generative service is temporarily unavailable. Please try again later.",errorTip:"",isRetryable:true,showDetails:false,isConnectivityFailure:p}:a.includes("high demand")?{errorTitle:"Model High Demand",errorMessage:"This model is currently experiencing high demand. Spikes in demand are usually temporary. Please try again later.",errorTip:"",isRetryable:true,showDetails:false,isConnectivityFailure:p}:a.includes("timeout")||a.includes("504")?{errorTitle:"REST Gateway Timeout",errorMessage:"Remote generation service did not respond.",errorDetails:"Details: "+r,errorTip:l,isRetryable:d,showDetails:true,isConnectivityFailure:p}:a.includes("api key")||a.includes("apikey")?{errorTitle:"Invalid API Key",errorMessage:"The provided Gemini API key is invalid or missing.",errorDetails:"Details: "+r,errorTip:"Tip: Please update your third-party Gemini developer API key on the settings page to restore connections.",isRetryable:d,showDetails:true,isConnectivityFailure:p}:a.includes("auth")||a.includes("401")||a.includes("403")||a.includes("credential")?{errorTitle:"Authentication Refused",errorMessage:"Authentication failed. Please verify your credentials in Settings.",errorDetails:"Details: "+r,errorTip:l,isRetryable:d,showDetails:true,isConnectivityFailure:p}:a.includes("quota")||a.includes("blocked")||a.includes("429")?{errorTitle:"GenAI Service Blocked",errorMessage:"Resource quota depleted or content safety limits triggered.",errorDetails:"Details: "+r,errorTip:l,isRetryable:d,showDetails:true,isConnectivityFailure:p}:{errorTitle:i,errorMessage:s,errorTip:l,isRetryable:d,showDetails:h,errorDetails:c,isConnectivityFailure:p}}static \u0275fac=function(t){return new(t||o)};static \u0275prov=T({token:o,factory:o.\u0275fac,providedIn:"root"})};function de(o){let e=/^([a-zA-Z0-9_]*Error|[a-zA-Z0-9_]*Exception|API_KEY_INVALID)\s*(\[[^\]]+\])?:\s*/i,t=o.replace(e,"");if(t.startsWith("{"))try{let n=JSON.parse(t);if(n.error&&n.error.message)return n.error.message}catch{}return t}function L(o){if(!o)return o;let e=o.replace(/AIzaSy[A-Za-z0-9_-]+/g,"redacted for your protection");return e=e.replace(/(Invalid API key:\s*)(redacted for your protection|[A-Za-z0-9_-]+)/gi,(t,n,a)=>a.toLowerCase()==="redacted for your protection"?t:n+"redacted for your protection"),e=e.replace(/(API key:\s*)(redacted for your protection|[A-Za-z0-9_-]+)/gi,(t,n,a)=>a.toLowerCase()==="redacted for your protection"?t:n+"redacted for your protection"),e}var pe=class o{catalogManagement=f(oe$1);configProvider=f(ho);stateSync=f(_);chatState=f(y);llmClient=f(Hn$1);errorLogger=f(Kc);chatCleaner=f(E);usageTrackingService=f(J);promptFactory=f(P);errorPresenter=f(O);pipelineStatus=this.chatState.pipelineStatus;isProgrammaticStreamActive=this.chatState.isProgrammaticStreamActive;currentTurnIndex=q(0);activePromptId=null;constructor(){Nq(this.configProvider.rendererUrl).pipe(Lo(1),Rq()).subscribe(()=>{queueMicrotask(()=>this.wipeEnvironmentCache());});}wipeEnvironmentCache(){this.currentTurnIndex.set(0),this.activePromptId=null,this.chatState.setChatHistory([]),this.finalizeStream("idle"),this.chatState.clearRawLlmHistory(),this.stateSync.flushDraft();}finalizeStream(e="idle"){this.chatState.setPipelineStatus(e),this.chatState.setProgrammaticStreamActive(false);}getFullMessageContext(){return [{role:"system",content:this.promptFactory.systemPrompt()},...this.chatState.chatHistory().filter(e=>e.role!=="error")]}activeStreamResponse;isCancelRequested=false;cancelActiveStream(){this.isCancelRequested=true,this.activePromptId&&this.usageTrackingService.trackChatCancel({promptId:this.activePromptId,turnIndex:this.currentTurnIndex(),pipelineStatus:this.pipelineStatus()}),this.activeStreamResponse&&this.activeStreamResponse.cancel&&this.activeStreamResponse.cancel();}emitPromptTracking(e,t,n){let a=!!n?.retryOfPromptId,r=n?.promptTurnIndex??this.currentTurnIndex()+1;this.currentTurnIndex.set(r);let i=this.catalogManagement.activeCatalog(),u=i&&(i.catalogId||i.$id)||"",s=t.some(l=>l.name==="screenshot.png"||l.mimeType?.startsWith("image/")),c=t.filter(l=>l.name!=="screenshot.png"&&!l.mimeType?.startsWith("image/"));return a?this.usageTrackingService.trackChatRetry({promptId:n?.promptId,catalogId:u,turnIndex:r,attemptNumber:2,retryOfPromptId:n?.retryOfPromptId}):this.usageTrackingService.trackChatPrompt({promptId:n?.promptId,catalogId:u,turnType:r===1?"initial":"followup",turnIndex:r,attemptNumber:1,hasScreenshot:s,attachmentCount:c.length})}async submitPrompt(e,t=[],n){if(this.chatState.isProgrammaticStreamActive()){console.warn("[ChatCoordinator] Blocked submitPrompt: programmatic stream is active.");return}let a=e.trim();if(!a&&t.length===0)return;let r=this.emitPromptTracking(a,t,n);this.activePromptId=r,this.chatState.setProgrammaticStreamActive(true),this.chatState.setPipelineStatus("receiving_stream"),this.chatState.updateChatHistory(u=>[...u,{role:"user",content:a,attachments:t.length>0?t:void 0,promptId:r}]);let i=this.getFullMessageContext();this.chatState.addRawLlmLog("LLM_REQUEST",i),this.chatState.updateChatHistory(u=>[...u,{role:"model",content:this.chatCleaner.appendPulse("")}]);try{this.isCancelRequested=!1;let u=await this.llmClient.chatStream(i);if(this.isCancelRequested){u.cancel&&u.cancel();let d=new Error("Cancelled");throw d.name=Xa,d}this.activeStreamResponse=u;let s="",c="";for await(let d of u.contentStream)s+=d.content,d.thinking&&(c+=d.thinking),this.chatState.updateChatHistory(h=>{let p=[...h],g=p.length-1;return p[g]?.role==="model"&&(p[g]={role:"model",content:this.chatCleaner.appendPulse(s),thinking:c}),p});let l=await u.complete;this.chatState.addRawLlmLog("LLM_RESPONSE",l),this.chatState.updateChatHistory(d=>{let h=[...d],p=h.length-1;return h[p]?.role==="model"&&(h[p]={role:"model",content:l,thinking:c}),h}),this.chatState.setPipelineStatus("received_raw"),await this.processRawLlmPayload(l,r);}catch(u){u&&typeof u=="object"&&"name"in u&&u.name===Xa?(this.finalizeStream("idle"),this.chatState.updateChatHistory(s=>{let c=[...s],l=c.length-1;return c[l]?.role==="model"&&(c[l]=Z(_$1({},c[l]),{content:"*You stopped this response.*"})),c})):this.handleConnectivityError(u,a,t,r);}finally{this.activeStreamResponse=void 0;}}async processRawLlmPayload(e,t){let n=[],a=0;try{this.chatCleaner.extractCodeFences(e).hasFences&&this.chatState.setPipelineStatus("healing");let r=this.chatCleaner.cleanPayload(e),i=le(r);if(i.success&&i.isConversational){this.finalizeStream("idle");return}if(!i.success){let u=t?`[prompt:${t}] `:"";this.errorLogger.error({sourceTag:"[ChatParser]",message:`${u}${i.error}`,line:i.line,column:i.column,snippet:i.snippet}),this.chatState.updateChatHistory(s=>{let c=[...s],l=c.length-1;return c[l]?.role==="model"&&(c[l]=Z(_$1({},c[l]),{parseError:i})),c}),this.finalizeStream("idle");return}n=i.blocks,a=i.count;}catch(r){throw this.finalizeStream("failed"),r}this.chatState.setPipelineStatus("validating");try{let r={type:ge$1.RENDER_A2UI,payload:n},i=[];if(!Yc.validateOutgoingMessage(r,i))throw new Error(`Outgoing message envelope validation failed:
${i.join(`
`)}`);ue(n,this.catalogManagement.activeCatalog()?.components)&&this.chatState.setPipelineStatus("healing"),this.chatState.setPipelineStatus("ready");let c=p(n);this.chatState.updateChatHistory(l=>{let d=[...l],h=d.length-1;return d[h]?.role==="model"&&(d[h]=Z(_$1({},d[h]),{content:c,isSnapshot:!0,componentCount:a})),d}),this.stateSync.commitLayoutFromLlm(c),this.chatState.setProgrammaticStreamActive(!1);}catch(r){throw this.finalizeStream("failed"),r}}handleConnectivityError(e,t,n=[],a){let r=e instanceof Error?e.message:String(e),i=r.toLowerCase(),u=de(r);this.errorPresenter.isConnectivityError(i)?this.finalizeStream("idle"):this.finalizeStream("failed");let s=this.errorPresenter.parseError(i,u,!!t),c="";e instanceof Error?c="Exception: "+e.message+`
Stack: `+(e.stack||"None"):c="Unknown Exception: "+JSON.stringify(e);let l="";s.errorDetails&&(l+=s.errorDetails+`

`),l+=c;let d=L(s.errorMessage),h=s.showDetails?L(l):void 0,p=s.showDetails?L(s.errorTip):void 0;console.error("Gemini chat execution failed:",e),this.chatState.updateChatHistory(g=>{let f=[...g],C=f.length-1,H=_$1({role:"error",content:d,errorTitle:s.errorTitle,errorMessage:d,errorDetails:h,errorTip:p,promptId:a},s.isRetryable?{isRetryable:true,originalPrompt:t,attachments:n}:{});return C>=0&&f[C].role==="model"?(f[C]=H,f):(f.push(H),f)});}systemPrompt=this.promptFactory.systemPrompt;static \u0275fac=function(t){return new(t||o)};static \u0275prov=T({token:o,factory:o.\u0275fac,providedIn:"root"})};export{E,_,le as l,pe as p};