import {l as le,s as sf,a as sc,f,i as ic,c as cc,A,q as qo,u as ue,S as Sb,I as Ib,$ as $x,b as sr,N as Nt,C as Co,d as Se,V as Va,e as Vt,j as je,g as jy,h as di,m as mt$1,v as vt$1,k as hi,n as nf,o as $a,p as Ve,r as bS,t as fi,P,Z,w as q,x as tt,y as $,J,Q as Qr,z as bt,B as tf,D as zy,H as Ha,U as Ua,K}from'./main.js';import {M as Me,W as Wt,C as Ce,A as At,c as ci,s as si,r as ri,n as ne}from'./chunk-BVpKT0-K.js';import {Y as Yt,m as mt}from'./chunk-BUEHKukr.js';import'./chunk-B5yzO1yg.js';import {G as Gn,W as We,D as Di,I as Ii}from'./chunk-Y95vNb4E.js';var ut=["*",[["mat-toolbar-row"]]],ft=["*","mat-toolbar-row"],ht=(()=>{class e{static \u0275fac=function(t){return new(t||e)};static \u0275dir=K({type:e,selectors:[["mat-toolbar-row"]],hostAttrs:[1,"mat-toolbar-row"],exportAs:["matToolbarRow"]})}return e})(),ct=(()=>{class e{_elementRef=f($);_platform=f(J);_document=f(A);color;_toolbarRows;ngAfterViewInit(){this._platform.isBrowser&&(this._checkToolbarMixedModes(),this._toolbarRows.changes.subscribe(()=>this._checkToolbarMixedModes()));}_checkToolbarMixedModes(){this._toolbarRows.length;}static \u0275fac=function(t){return new(t||e)};static \u0275cmp=ue({type:e,selectors:[["mat-toolbar"]],contentQueries:function(t,r,gt){if(t&1&&zy(gt,ht,5),t&2){let _;Ha(_=Ua())&&(r._toolbarRows=_);}},hostAttrs:[1,"mat-toolbar"],hostVars:6,hostBindings:function(t,r){t&2&&(tf(r.color?"mat-"+r.color:""),Ve("mat-toolbar-multiple-rows",r._toolbarRows.length>0)("mat-toolbar-single-row",r._toolbarRows.length===0));},inputs:{color:"color"},exportAs:["matToolbar"],ngContentSelectors:ft,decls:2,vars:0,template:function(t,r){t&1&&(Qr(ut),bt(0),bt(1,1));},styles:[`.mat-toolbar {
