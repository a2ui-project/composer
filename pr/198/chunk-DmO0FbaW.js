import {f,n as ne$1,at as Iv,I as K$1,k as qa,Q,Y,bd as lh,x as st,be as IG,bf as yr,bg as rt,e as de,bh as dh,b9 as De,y as io,A as Ae,z as Tt,H as He,a3 as gf,S as St,bi as hf,p as $e,v as vi,r as bi,l as wt,aU as y,E as ev,F as Ya,G as Ka,bj as hb,bk as Fb,bl as oW,K as Ky,ba as wi,U,bm as Dc,bn as Bi,J,b6 as R,bo as Ct,bp as Ec,d as O,q,ai as S,bq as W,aj as ce$1,ak as oe$1,br as vl,aS as P,a8 as tc,a_ as an,bs as In,av as Ut$1,bt as Se,bu as Xt$1,aV as Zt$1,bv as dr,bw as vo,bx as sn,ad as zn,by as gl,aB as QI,as as tS,bz as oE,bA as V,bB as We,bC as Ob,bD as ih,bE as Ui,aC as Qp,aD as Jp}from'./main.js';import {h}from'./chunk-CBx-bLSP.js';var Ft=class n{trackingService=f(ne$1);a2uiComposerTrackEvent=Iv.required();a2uiComposerTrackParams=Iv();onClick(){let v=this.a2uiComposerTrackEvent(),t=this.a2uiComposerTrackParams();v&&typeof this.trackingService[v]=="function"&&this.trackingService[v](t);}static \u0275fac=function(t){return new(t||n)};static \u0275dir=K$1({type:n,selectors:[["","a2uiComposerTrackEvent",""]],hostBindings:function(t,e){t&1&&qa("click",function(){return e.onClick()});},inputs:{a2uiComposerTrackEvent:[1,"a2uiComposerTrackEvent"],a2uiComposerTrackParams:[1,"a2uiComposerTrackParams"]}})};var Ot=(()=>{class n{static \u0275fac=function(e){return new(e||n)};static \u0275mod=Q({type:n});static \u0275inj=Y({imports:[st]})}return n})();var Vt=["*"],Nt=`.mdc-list {
  margin: 0;
  padding: 8px 0;
