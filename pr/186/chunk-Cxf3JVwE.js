import {f,n as ne$1,at as Cv,G as K$1,q as qa,Q,r as q,be as lh,t as st,bf as CG,bg as yr,bh as rt,e as ue,bi as uh,ba as De,x as io,A as Ae,y as Tt,H as He,a3 as gf,S as St,bj as hf,j as $e,v as vi,l as bi,i as wt,aV as y,B as ev,D as Ya,E as Ka,bk as db,bl as kb,bm as rW,K as Ky,bb as wi,U,bn as Dc,bo as Bi,J,b7 as R,bp as Ct,bq as Ec,d as O,Y,ai as S,br as W,aj as ce$1,ak as oe$1,bs as vl,aT as P,a8 as tc,a$ as an,bt as In,av as Ut$1,bu as Se,bv as Xt$1,aW as Zt$1,bw as ur,bx as vo,by as sn,ad as zn,aN as gl,aB as ZI,as as JI,bz as nE,bA as V,bB as We,bC as Rb,bD as ih,bE as Ui,aC as Qp,aD as Jp}from'./main.js';import {h}from'./chunk-PUhXsPQx.js';var Ft=class n{trackingService=f(ne$1);a2uiComposerTrackEvent=Cv.required();a2uiComposerTrackParams=Cv();onClick(){let v=this.a2uiComposerTrackEvent(),t=this.a2uiComposerTrackParams();v&&typeof this.trackingService[v]=="function"&&this.trackingService[v](t);}static \u0275fac=function(t){return new(t||n)};static \u0275dir=K$1({type:n,selectors:[["","a2uiComposerTrackEvent",""]],hostBindings:function(t,e){t&1&&qa("click",function(){return e.onClick()});},inputs:{a2uiComposerTrackEvent:[1,"a2uiComposerTrackEvent"],a2uiComposerTrackParams:[1,"a2uiComposerTrackParams"]}})};var Ot=(()=>{class n{static \u0275fac=function(e){return new(e||n)};static \u0275mod=Q({type:n});static \u0275inj=q({imports:[st]})}return n})();var Vt=["*"],Nt=`.mdc-list {
  margin: 0;
  padding: 8px 0;
