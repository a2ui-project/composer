import {g,s as Yg,u as en,M as M1,X as Xd,h as hI,z as zi$1,V as Vh,R as Ru,T as Tw,a as Wh,w as lg,O as Oh,F as FI,n as ng,b as mD,B as Bh,c as cg,y as ug,A as LI,C as Xh,D as nw,E as O1,H as RC,G as Gw,I as G,J as j,_ as _E,Q as ME,S as T$1,U as Le,$ as ee,a0 as gg,a1 as zm,a2 as se$1,a3 as jt,a4 as qw,a5 as Wm,a6 as Ou,a7 as ku,d as os,v as vr$1,a8 as tp,l as Tu,a9 as xh,aa as Ow,ab as Qn,ac as Uc,ad as x1,K as KI,ae as kh,j as jh,af as Qh,k as ew,t as tw,Y as Yh,ag as $n,Z as Zn,ah as gC,ai as X,aj as H,ak as xi$2,al as We,am as ey,an as Um,ao as R1,ap as VI,aq as Lh,ar as HI,i as hw,as as tg,at as sh,W,au as bn,f as XI,av as mg,aw as Ft,o as oo$1,ax as e,N,ay as re,az as Vm,aA as Ve,aB as xC,aC as zd,aD as Gd,aE as $h,r as rw,aF as YI,aG as Jm,aH as ED,aI as Hh,aJ as Pu,aK as Fu,aL as kw,q as qI,x as xd,p as Rd,aM as ar$1,aN as zh,aO as II,aP as $s,aQ as ty,aR as nd,aS as x,aT as dr$1,aU as Lw,aV as Bw,L as Lu,aW as jI,aX as BI,aY as Hw,aZ as Nw}from'./main.js';import {n as no$1,A as Ae,F as Fe,B,Y as Ye,u as ue$1,J as Jt,a as ae,_ as _e,s as st,q as q$1,b as J$1,V,R as Rt,G as G$1}from'./chunk-fWVHBTXD.js';import {i as it$1,J,I as Ii$1,v as vi$1,k as ki$1,F as Fi$1,S as Si$1,b as bi$1,T as Ti$1,x as xi$1,M as Mi$1,E as Ei$1,O as Oi}from'./chunk-CUnUlU80.js';import {H as H$1,K as Ke,X as Xe}from'./chunk-C50OotQc.js';import {s as se,i as it$2,r as rn$1,o as on$1,V as Ve$1}from'./chunk-C5zC_3Oi.js';import {X as Xt,W as Wi,T,H as Hd,j as jd,E as Ed,L as Lo$1,i as io,y as yd,m as mu,C as Ci$1,a as au,N as Ns,D as Du,q,r as ri$1,x as xe,O,A as An$1,s as so$1,b as Hc,c as sc,d as jr,e as St,f as At,g as Wr,Q as Qt,h as Do$1,k as al,z as zo$1,l as Co$1,S as Se,w as wn$1,n as wo$1,o as oo$2,p as bn$1}from'./chunk-2xQGtTXa.js';var Sa=`
...
`.trim()+`
`;function nt(a){let i=a.trim();if(i.startsWith("[")&&i.endsWith("]"))try{let e=JSON.parse(i);if(Array.isArray(e))return e}catch{}return null}var nn="updateComponents",Cn="components",xi="registerMockRules",Ci="mockRulesConfig",wi="rules",Mi="id",ki="children",Ea="mock_rules_container",at=class a{destroyRef=g(Le);chatState=g(J);catalogManagement=g(io);_activeDraft=en("");activeDraft=this._activeDraft.asReadonly();_draftInput=en("");constructor(){Xd(()=>{let i=this.catalogManagement.activeCatalog();if(i){let e=i.catalogId||"";gg(()=>{let t=this._activeDraft(),n=this.getCatalogIdFromDraft(t);(t===""||n!==e)&&this._activeDraft.set(this.getInitialDraft(e));});}}),Du(this._draftInput).pipe(Jm(1),zm(300),Wm(),Wi(this.destroyRef)).subscribe(i=>{this.syncLayoutToHistory(i);});}updateDraft(i){this._activeDraft.set(i),this._draftInput.set(i);}hydrateActiveDraft(){return this._activeDraft()}commitLayoutFromLlm(i){this._activeDraft.set(i);}flushDraft(){let e=this.catalogManagement.activeCatalog()?.catalogId||"";this._activeDraft.set(this.getInitialDraft(e));}getInitialDraft(i){return i==="https://a2ui.org/specification/v0_9/basic_catalog.json"?Sa:i?JSON.stringify({version:"v0.9",createSurface:{surfaceId:"sample-surface",catalogId:i,sendDataModel:true}})+`
...
`+$;}this.chatState.updateChatHistory(ee=>{let $=[...ee],Re=$.length-1,fe=j({role:"error",content:z},u?{isRetryable:true,originalPrompt:e}:{});return Re>=0&&$[Re].role==="model"?($[Re]=fe,$):($.push(fe),$)});}systemPrompt=Gw(()=>{let i=this.catalogManagement.activeCatalog();return i?this.generateSystemPrompt(JSON.stringify(i,null,2)):`You are an AI assistant designed to help model mock screens inside A2UI Composer shell.
