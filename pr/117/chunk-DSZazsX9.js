import {o as ot,I as It,z as zt,q as qt,V as Vt}from'./chunk-DoD2Si0d.js';import {Q as Qe,e as eC,E as Es,g,D as Ds,w as ws,W,a as af,b as wI,s as sr,N as Nt,C as Co,q as qi,c as Qh,k as kw,B as Bu,G as Gh,d as GI,f as GD,U as Uh,$ as $h,h as Gu,i as dg,j as ig,l as Uw,z as zI,m as N,n as ss,o as Dr,Z as Zn,p as sw,r as aw,t as Cw,X as Xh,u as uw,v as lw,K,x as re$1,y as Qn,A as fh,F as w,H as ee$1,I as ry,L,J as ED,R as Ru,M as bC,V as Vu,O as Kh,P as Hu,S as Jh}from'./main.js';import {M as Me,W as Wt$1,C as Ce,A as At,l as li,d as di,s as si,n as ne$1}from'./chunk-Dr4p7gKS.js';import {j,P}from'./chunk-CQTQYz39.js';import {i as io,G as Gt$1,g as gd,h as hd,L as Lo,a as Ld,V as Vd,R,e as ec,f as fn,B as Bo,A as At$1,I as Ie,b as Ic,m as mn,H as Hi,x as xe,C as Co$1}from'./chunk-R-IIeLxd.js';var Qt=["*",[["mat-toolbar-row"]]],Zt=["*","mat-toolbar-row"],Wt=(()=>{class o{static \u0275fac=function(e){return new(e||o)};static \u0275dir=Ru({type:o,selectors:[["mat-toolbar-row"]],hostAttrs:[1,"mat-toolbar-row"],exportAs:["matToolbarRow"]})}return o})(),Gt=(()=>{class o{_elementRef=g(Zn);_platform=g(R);_document=g(W);color;_toolbarRows;ngAfterViewInit(){this._platform.isBrowser&&(this._checkToolbarMixedModes(),this._toolbarRows.changes.subscribe(()=>this._checkToolbarMixedModes()));}_checkToolbarMixedModes(){this._toolbarRows.length;}static \u0275fac=function(e){return new(e||o)};static \u0275cmp=wI({type:o,selectors:[["mat-toolbar"]],contentQueries:function(e,i,n){if(e&1&&Xh(n,Wt,5),e&2){let s;uw(s=lw())&&(i._toolbarRows=s);}},hostAttrs:[1,"mat-toolbar"],hostVars:6,hostBindings:function(e,i){e&2&&(Cw(i.color?"mat-"+i.color:""),ig("mat-toolbar-multiple-rows",i._toolbarRows.length>0)("mat-toolbar-single-row",i._toolbarRows.length===0));},inputs:{color:"color"},exportAs:["matToolbar"],ngContentSelectors:Zt,decls:2,vars:0,template:function(e,i){e&1&&(sw(Qt),aw(0),aw(1,1));},styles:[`.mat-toolbar {
