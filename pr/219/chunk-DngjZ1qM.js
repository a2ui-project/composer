import {b,a6 as Bn,o as oe$1,r as rg,y as yt,ad as Eze,aQ as Vl,Y as bze,ak as cn,aR as va,ae as _a,af as bh,p as pe$1,H as Hu,aS as Fn,ab as fv,J as J$1,aT as Xa,ao as y$1,ap as f,Z as jt,aU as dv,an as lv,O as Od}from'./main.js';import {e}from'./chunk-CLNpRTgV.js';import {y,p,g,d}from'./chunk-o02BdfRM.js';var ne=`[
  {
    "version": "v0.9",
    "createSurface": {
...
`;var R="updateComponents",U="components",ge="registerMockRules",ye="mockRulesConfig",ve="rules",Se="id",be="children",re="mock_rules_container",w=class o{destroyRef=b(Bn);chatState=b(y);catalogManagement=b(oe$1);startupConfigState=b(rg);previousCatalogId=null;isDraftModified=false;_activeDraft=yt("");activeDraft=this._activeDraft.asReadonly();_draftInput=yt("");constructor(){Eze(this.startupConfigState.selectedRendererId).pipe(Vl(1),bze(this.destroyRef)).subscribe(()=>{this.flushDraft();}),Eze(this.catalogManagement.activeCatalog).pipe(cn(t=>!!t),bze(this.destroyRef)).subscribe(t=>{let n=t.catalogId||t.$id||"",a=this.previousCatalogId===null,r=this.previousCatalogId!==null&&this.previousCatalogId!==n;if((a||r)&&!this.isDraftModified){let s=this.getInitialDraft(n);this._activeDraft.set(s),this._draftInput.set(s);}this.previousCatalogId=n;}),(this.startupConfigState.sharedA2uiPayload?Eze(this.startupConfigState.sharedA2uiPayload):va(null)).pipe(cn(t=>!!t),bze(this.destroyRef)).subscribe(t=>{this.injectExternalDraft(t);}),Eze(this._draftInput).pipe(Vl(1),_a(300),bh(),bze(this.destroyRef)).subscribe(t=>{this.syncLayoutToHistory(t);});}updateDraft(e){this.isDraftModified=true,this._activeDraft.set(e),this._draftInput.set(e);}injectExternalDraft(e){this.isDraftModified=true,this._activeDraft.set(e),this._draftInput.set(e);}hydrateActiveDraft(){return this._activeDraft()}commitLayoutFromLlm(e){this.isDraftModified=true,this._activeDraft.set(e);}flushDraft(){this.isDraftModified=false,this.previousCatalogId=null;let e=this.catalogManagement.activeCatalog(),t=e&&(e.catalogId||e.$id)||"";!this.startupConfigState.activeRenderer()?.samplePayload&&!t&&(t="https://a2ui.org/specification/v0_9/basic_catalog.json");let a=this.getInitialDraft(t);this._activeDraft.set(a),this._draftInput.set(a);}getInitialDraft(e){let t=this.startupConfigState.activeRenderer();return t?.samplePayload?t.samplePayload:e==="https://a2ui.org/specification/v0_9/basic_catalog.json"?ne:e?p([{version:"v0.9",createSurface:{surfaceId:"sample-surface",catalogId:e,sendDataModel:true}}]):""}syncLayoutToHistory(e){let t=this.sanitizeLayout(e);if(!t)return;let n=this.chatState.chatHistory();if(n.length===0){this.chatState.setChatHistory([{role:"user",content:t}]);return}let a=n[n.length-1];if(a.role==="user"&&a.content.trim().startsWith("[")){let s=[...n];s[s.length-1]={role:"user",content:t},this.chatState.setChatHistory(s);}else this.chatState.updateChatHistory(s=>[...s,{role:"user",content:t}]);}sanitizeLayout(e){let t=e.trim();if(!t)return "";let n=g(t);if(n.success){let a=n.data.map(r=>r&&typeof r=="object"&&!Array.isArray(r)?this.sanitizeBlock(r):r).filter(r=>r!==null);return p(a)}return console.warn("[StateSync] Discarding malformed layout JSON during sanitization: not a valid JSON array"),""}sanitizeBlock(e){if(e[ge]||e[ye])return null;if(e[R]&&typeof e[R]=="object"&&e[R]!==null){let t=e[R];if(Array.isArray(t[U])){let n=t[U].filter(a=>a!==null&&typeof a=="object"&&!Array.isArray(a)?a[Se]!==re:true);t[U]=n.map(a=>a!==null&&typeof a=="object"&&!Array.isArray(a)?this.sanitizeComponentObject(a):a);}}return e}sanitizeComponentObject(e){let t={};for(let[n,a]of Object.entries(e))n===ve||/^mock/i.test(n)||(n===be&&Array.isArray(a)?t[n]=a.filter(r=>r!==re):a!==null&&typeof a=="object"&&!Array.isArray(a)?t[n]=this.sanitizeComponentObject(a):Array.isArray(a)?t[n]=a.map(r=>r!==null&&typeof r=="object"&&!Array.isArray(r)?this.sanitizeComponentObject(r):r):t[n]=a);return t}static \u0275fac=function(t){return new(t||o)};static \u0275prov=pe$1({token:o,factory:o.\u0275fac,providedIn:"root"})};var oe=/```(?:jsonl?|jsonlines|a2ui|html|xml)?\s*([\s\S]*?)\s*```/gi,ie=/<(thought|thinking|reasoning)>([\s\S]*?)(?:<\/\1>|$)/gi,se=/\s*●●●\s*$/g;function ce(o){return o.length>0&&o.some(e=>{if(e&&typeof e=="object"&&!Array.isArray(e)){let t=Object.keys(e);return t.includes("version")||t.includes("createSurface")||t.includes("updateComponents")||t.includes("updateDataModel")||t.includes("deleteSurface")}return  false})}var P=class o{PULSE_INDICATOR="\u25CF\u25CF\u25CF";appendPulse(e){return `${e??""} ${this.PULSE_INDICATOR}`}stripPulse(e){return e?(se.lastIndex=0,e.replace(se,"").trim()):""}stripThinkingTags(e){return e?(ie.lastIndex=0,e.replace(ie,"").trim()):""}extractCodeFences(e){if(!e)return {extracted:"",hasFences:false};oe.lastIndex=0;let t=Array.from(e.matchAll(oe));return t.length>0?{extracted:t.map(n=>n[1].trim()).join(`
`),hasFences:true}:{extracted:e.trim(),hasFences:false}}cleanPayload(e){if(!e)return "";let t=this.stripPulse(e);if(t=this.stripThinkingTags(t),t=this.extractCodeFences(t).extracted,!t.startsWith("{")&&!t.startsWith("[")){let a=Array.from(t.matchAll(/[\{\[]/g));for(let r of a)if(r.index!==void 0&&r.index>=0){let s=t.substring(r.index).trim();if(s.startsWith("{")&&s.includes('"version"')||s.startsWith("[")&&/^\[\s*[\{\"]/.test(s)&&(s.includes('"version"')||s.includes('"createSurface"')||s.includes('"updateComponents"'))){t=s;break}let i=g(s);if(i.success&&ce(i.data)){t=s;break}}}return t.trim()}isLayoutSnapshot(e){if(!e)return  false;let t=this.cleanPayload(e);if(t.startsWith('{"version"')||t.startsWith("{")&&t.includes('"version"')||t.startsWith("[")&&(t.includes('"version"')||t.includes('"createSurface"')||t.includes('"updateComponents"')))return  true;let n=g(t);return n.success&&ce(n.data)}static \u0275fac=function(t){return new(t||o)};static \u0275prov=pe$1({token:o,factory:o.\u0275fac,providedIn:"root"})};function ue(o){if(o==null||o.trim().length===0)return {success:false,error:"No valid A2UI JSON layout command block could be parsed or recovered."};let e=g(o);if(e.success)return {success:true,isConversational:false,blocks:e.data,count:F(e.data)};let t=o.trim();if(t.startsWith("{")||t.startsWith("[")){let i=le(o);if(i!==null&&typeof i=="object"){let c=Array.isArray(i)?i:[i];return {success:true,isConversational:false,blocks:c,count:F(c)}}}let a=o.split(`
`).map((i,c)=>({text:(i||"").trim(),originalIndex:c})).filter(i=>i.text.length>0),r=[],s=false;for(let i of a)if(!(i.text.startsWith("```")||!i.text.startsWith("{")&&!i.text.startsWith("["))){s=true;try{r.push(JSON.parse(i.text));}catch(c){let u=le(i.text);if(u!==null)r.push(u);else {let l=d(c,i.text);return {success:false,error:c?.message??"Syntax recovery failed",line:i.originalIndex+1,column:l.column,snippet:i.text}}}}if(r.length===0){if(s){let i=e.error;return {success:false,error:i?.message??"Syntax recovery failed",line:i?.line,column:i?.column,snippet:i?.snippet}}return {success:true,isConversational:true,blocks:[],count:0}}return {success:true,isConversational:false,blocks:r,count:F(r)}}function le(o){if(o==null||o.trim().length===0)return null;let e=o.trim();e=e.replace(/,\s*([\]}])/g,"$1");try{return JSON.parse(e)}catch{for(let n=1;n<=5;n++)try{return JSON.parse(e+"}".repeat(n))}catch{}for(let n=1;n<=3;n++)for(let a=1;a<=3;a++)try{return JSON.parse(e+"}".repeat(n)+"]".repeat(a))}catch{}for(let n=1;n<=3;n++)for(let a=1;a<=3;a++)try{return JSON.parse(e+"]".repeat(n)+"}".repeat(a))}catch{}}return null}function Ce(o){if(!o||typeof o!="object")return  false;let e=o;if(!e.updateComponents||typeof e.updateComponents!="object")return  false;let t=e.updateComponents;return Array.isArray(t.components)}function pe(o,e){let t=false,n={};if(e)for(let r of Object.keys(e)){let s=r.toLowerCase().replace(/[^a-z]/g,"");n[s]=r;}let a={textbox:"textfield",textinput:"textfield",rowlayout:"row",columnlayout:"column",choice:"choicepicker",datepicker:"datetimeinput",datetimepicker:"datetimeinput"};for(let r of o){if(!Ce(r))continue;let s=r.updateComponents,i=[];for(let c of s.components){if(!c||typeof c!="object"||Array.isArray(c)){i.push(c);continue}let u=c,l=u.component;if(u.name&&!u.component&&(t=true,l=u.name,u.component=l,delete u.name),typeof l!="string")throw new Error("Component declaration is missing component type name string.");let p=l;if(e&&!e[l]){let d=l.toLowerCase().replace(/[^a-z]/g,""),g=n[d];if(!g){let f=a[d];f&&(g=n[f]);}if(g&&e[g])t=true,p=g;else {let f=d?Object.keys(e).find(I=>I.toLowerCase().includes(d)||d.includes(I.toLowerCase())):void 0;if(f)t=true,p=f;else throw new Error(`Validation failure: Component type "${l}" is not registered in the active custom catalog.`)}}let h=Ie(u);h.component=p,i.push(h);}s.components=i;}return t}function J(o){if(o===null||typeof o!="object")return o;if(Array.isArray(o))return o.map(n=>J(n));let e=o,t={};for(let[n,a]of Object.entries(e))n==="__proto__"||n==="constructor"||n==="prototype"||(t[n]=J(a));return t}function Ie(o){return J(o)}function F(o){return o.reduce((e,t)=>!t||typeof t!="object"?e:t.updateComponents&&Array.isArray(t.updateComponents.components)?e+t.updateComponents.components.length:t.createSurface?e+1:e,0)}function de(o){return o?!!(o.functions&&"callMcpTool"in o.functions||o.$defs&&("callMcpTool"in o.$defs||"catalog_callMcpTool"in o.$defs)):false}var E=class o{catalogManagement=b(oe$1);mcpManager=b(lv);systemPrompt=Od(()=>{let e=this.catalogManagement.activeCatalog(),n=de(e)?this.mcpManager.getActiveServersWithTools():[],a=this.buildMcpInstructions(n);return e?this.generateSystemPrompt(p(e))+a:`
  ...
  ${a}
      `});buildMcpInstructions(e){let t=new Map;for(let r of e)for(let s of r.tools||[])t.has(s.name)||t.set(s.name,s);if(t.size===0)return "";let n={type:"object",properties:{content:{type:"array",items:{type:"object",properties:{type:{type:"string"},text:{type:"string"}}}}}};return `
  ...
  ### Available MCP Tools
  ${Array.from(t.values()).map(r=>{let s=r.description?` - ${r.description}`:"",i=JSON.stringify(r.inputSchema||{type:"object",properties:{}}),c=JSON.stringify(r.outputSchema||n);return `- **\`${r.name}\`**${s}
  - **Input Schema**: \`${i}\`
  - **Output Schema**: \`${c}\``}).join(`
`)}
`}generateSystemPrompt(e$1){return `
  ...
  **IMPORTANT**: The component names used in the examples below (Column, Text,
  ...
  \`\`\`
  `}static \u0275fac=function(t){return new(t||o)};static \u0275prov=pe$1({token:o,factory:o.\u0275fac,providedIn:"root"})};var O=class o{isConnectivityError(e){return e?e.includes("failed to fetch")||e.includes("fetch")||e.includes("timeout")||e.includes("504")||e.includes("proxy")||e.includes("networkerror")||e.includes("connection")||e.includes("401")||e.includes("403")||e.includes("credential")||e.includes("quota")||e.includes("blocked")||e.includes("503")||e.includes("unavailable")||e.includes("api key")||e.includes("apikey"):false}parseError(e,t,n=false){let a=e??"",r=t??"",s="Connectivity Failure",i=r.trim().startsWith("{"),c=i?"A connectivity error occurred.":r,u=i?"Details: "+r:void 0,l="Tip: Please check your network proxy configurations or verify your settings to restore connections.",p=n,h=true,d=this.isConnectivityError(a);return a.includes("validation")||a.includes("syntax recovery")||a.includes("validation failure")?{errorTitle:"Validation Failure",errorMessage:"The generated layout contains invalid components or structure.",errorTip:"Tip: Try rephrasing your prompt to guide the model to generate valid components.",isRetryable:n,showDetails:true,errorDetails:"Details: "+r,isConnectivityFailure:d}:a.includes("503")||a.includes("unavailable")?{errorTitle:"Service Unavailable",errorMessage:"The generative service is temporarily unavailable. Please try again later.",errorTip:"",isRetryable:true,showDetails:false,isConnectivityFailure:d}:a.includes("high demand")?{errorTitle:"Model High Demand",errorMessage:"This model is currently experiencing high demand. Spikes in demand are usually temporary. Please try again later.",errorTip:"",isRetryable:true,showDetails:false,isConnectivityFailure:d}:a.includes("timeout")||a.includes("504")?{errorTitle:"REST Gateway Timeout",errorMessage:"Remote generation service did not respond.",errorDetails:"Details: "+r,errorTip:l,isRetryable:p,showDetails:true,isConnectivityFailure:d}:a.includes("api key")||a.includes("apikey")?{errorTitle:"Invalid API Key",errorMessage:"The provided Gemini API key is invalid or missing.",errorDetails:"Details: "+r,errorTip:"Tip: Please update your third-party Gemini developer API key on the settings page to restore connections.",isRetryable:p,showDetails:true,isConnectivityFailure:d}:a.includes("auth")||a.includes("401")||a.includes("403")||a.includes("credential")?{errorTitle:"Authentication Refused",errorMessage:"Authentication failed. Please verify your credentials in Settings.",errorDetails:"Details: "+r,errorTip:l,isRetryable:p,showDetails:true,isConnectivityFailure:d}:a.includes("quota")||a.includes("blocked")||a.includes("429")?{errorTitle:"GenAI Service Blocked",errorMessage:"Resource quota depleted or content safety limits triggered.",errorDetails:"Details: "+r,errorTip:l,isRetryable:p,showDetails:true,isConnectivityFailure:d}:{errorTitle:s,errorMessage:c,errorTip:l,isRetryable:p,showDetails:h,errorDetails:u,isConnectivityFailure:d}}static \u0275fac=function(t){return new(t||o)};static \u0275prov=pe$1({token:o,factory:o.\u0275fac,providedIn:"root"})};function me(o){let e=/^([a-zA-Z0-9_]*Error|[a-zA-Z0-9_]*Exception|API_KEY_INVALID)\s*(\[[^\]]+\])?:\s*/i,t=o.replace(e,"");if(t.startsWith("{"))try{let n=JSON.parse(t);if(n.error&&n.error.message)return n.error.message}catch{}return t}function L(o){if(!o)return o;let e=o.replace(/AIzaSy[A-Za-z0-9_-]+/g,"redacted for your protection");return e=e.replace(/(Invalid API key:\s*)(redacted for your protection|[A-Za-z0-9_-]+)/gi,(t,n,a)=>a.toLowerCase()==="redacted for your protection"?t:n+"redacted for your protection"),e=e.replace(/(API key:\s*)(redacted for your protection|[A-Za-z0-9_-]+)/gi,(t,n,a)=>a.toLowerCase()==="redacted for your protection"?t:n+"redacted for your protection"),e}var he=class o{catalogManagement=b(oe$1);configProvider=b(Hu);stateSync=b(w);chatState=b(y);llmClient=b(Fn);errorLogger=b(fv);chatCleaner=b(P);usageTrackingService=b(J$1);promptFactory=b(E);errorPresenter=b(O);pipelineStatus=this.chatState.pipelineStatus;isProgrammaticStreamActive=this.chatState.isProgrammaticStreamActive;currentTurnIndex=yt(0);activePromptId=null;constructor(){Eze(this.configProvider.rendererUrl).pipe(Vl(1),bze()).subscribe(()=>{queueMicrotask(()=>this.wipeEnvironmentCache());});}wipeEnvironmentCache(){this.currentTurnIndex.set(0),this.activePromptId=null,this.chatState.setChatHistory([]),this.chatState.setPipelineStatus("idle"),this.chatState.setProgrammaticStreamActive(false),this.chatState.clearRawLlmHistory(),this.stateSync.flushDraft();}getFullMessageContext(){return [{role:"system",content:this.promptFactory.systemPrompt()},...this.chatState.chatHistory().filter(e=>e.role!=="error")]}activeStreamResponse;isCancelRequested=false;cancelActiveStream(){this.isCancelRequested=true,this.activePromptId&&this.usageTrackingService.trackChatCancel({promptId:this.activePromptId,turnIndex:this.currentTurnIndex(),pipelineStatus:this.pipelineStatus()}),this.activeStreamResponse&&this.activeStreamResponse.cancel&&this.activeStreamResponse.cancel();}emitPromptTracking(e,t,n){let a=!!n?.retryOfPromptId,r=n?.promptTurnIndex??this.currentTurnIndex()+1;this.currentTurnIndex.set(r);let s=this.catalogManagement.activeCatalog(),i=s&&(s.catalogId||s.$id)||"",c=t.some(l=>l.name==="screenshot.png"||l.mimeType?.startsWith("image/")),u=t.filter(l=>l.name!=="screenshot.png"&&!l.mimeType?.startsWith("image/"));return a?this.usageTrackingService.trackChatRetry({promptId:n?.promptId,catalogId:i,turnIndex:r,attemptNumber:2,retryOfPromptId:n?.retryOfPromptId}):this.usageTrackingService.trackChatPrompt({promptId:n?.promptId,catalogId:i,turnType:r===1?"initial":"followup",turnIndex:r,attemptNumber:1,hasScreenshot:c,attachmentCount:u.length})}async submitPrompt(e,t=[],n){if(this.chatState.isProgrammaticStreamActive()){console.warn("[ChatCoordinator] Blocked submitPrompt: programmatic stream is active.");return}let a=e.trim();if(!a&&t.length===0)return;let r=this.emitPromptTracking(a,t,n);this.activePromptId=r,this.chatState.setProgrammaticStreamActive(true),this.chatState.setPipelineStatus("receiving_stream"),this.chatState.updateChatHistory(i=>[...i,{role:"user",content:a,attachments:t.length>0?t:void 0,promptId:r}]);let s=this.getFullMessageContext();this.chatState.addRawLlmLog("LLM_REQUEST",s),this.chatState.updateChatHistory(i=>[...i,{role:"model",content:this.chatCleaner.appendPulse("")}]);try{this.isCancelRequested=!1;let i=await this.llmClient.chatStream(s);if(this.isCancelRequested){i.cancel&&i.cancel();let p=new Error("Cancelled");throw p.name=Xa,p}this.activeStreamResponse=i;let c="",u="";for await(let p of i.contentStream)c+=p.content,p.thinking&&(u+=p.thinking),this.chatState.updateChatHistory(h=>{let d=[...h],g=d.length-1;return d[g]?.role==="model"&&(d[g]={role:"model",content:this.chatCleaner.appendPulse(c),thinking:u}),d});let l=await i.complete;this.chatState.addRawLlmLog("LLM_RESPONSE",l),this.chatState.updateChatHistory(p=>{let h=[...p],d=h.length-1;return h[d]?.role==="model"&&(h[d]={role:"model",content:l,thinking:u}),h}),this.chatState.setPipelineStatus("received_raw"),await this.processRawLlmPayload(l,r);}catch(i){i&&typeof i=="object"&&"name"in i&&i.name===Xa?(this.chatState.setPipelineStatus("idle"),this.chatState.setProgrammaticStreamActive(false),this.chatState.updateChatHistory(c=>{let u=[...c],l=u.length-1;return u[l]?.role==="model"&&(u[l]=y$1(f({},u[l]),{content:"*You stopped this response.*"})),u})):this.handleConnectivityError(i,a,t,r);}finally{this.activeStreamResponse=void 0;}}async processRawLlmPayload(e,t){let n=[];try{this.chatCleaner.extractCodeFences(e).hasFences&&this.chatState.setPipelineStatus("healing");let a=this.chatCleaner.cleanPayload(e),r=ue(a);if(r.success&&r.isConversational){this.chatState.setPipelineStatus("idle"),this.chatState.setProgrammaticStreamActive(!1);return}if(!r.success){this.errorLogger.error({sourceTag:"[ChatParser]",message:r.error,line:r.line,column:r.column,snippet:r.snippet}),this.chatState.updateChatHistory(s=>{let i=[...s],c=i.length-1;return i[c]?.role==="model"&&(i[c]=y$1(f({},i[c]),{parseError:r})),i}),this.chatState.setPipelineStatus("idle"),this.chatState.setProgrammaticStreamActive(!1);return}n=r.blocks;}catch(a){throw this.chatState.setPipelineStatus("failed"),this.chatState.setProgrammaticStreamActive(false),a}this.chatState.setPipelineStatus("validating");try{let a={type:jt.RENDER_A2UI,payload:n},r=[];if(!dv.validateOutgoingMessage(a,r))throw new Error(`Outgoing message envelope validation failed:
${r.join(`
`)}`);pe(n,this.catalogManagement.activeCatalog()?.components)&&this.chatState.setPipelineStatus("healing"),this.chatState.setPipelineStatus("ready");let c=p(n);this.chatState.updateChatHistory(u=>{let l=[...u],p=l.length-1;return l[p]?.role==="model"&&(l[p]=y$1(f({},l[p]),{content:c})),l}),this.stateSync.commitLayoutFromLlm(c),this.chatState.setProgrammaticStreamActive(!1);}catch(a){throw this.chatState.setPipelineStatus("failed"),this.chatState.setProgrammaticStreamActive(false),a}}handleConnectivityError(e,t,n=[],a){let r=e instanceof Error?e.message:String(e),s=r.toLowerCase(),i=me(r);this.errorPresenter.isConnectivityError(s)?this.chatState.setPipelineStatus("idle"):this.chatState.setPipelineStatus("failed"),this.chatState.setProgrammaticStreamActive(false);let c=this.errorPresenter.parseError(s,i,!!t),u="";e instanceof Error?u="Exception: "+e.message+`
Stack: `+(e.stack||"None"):u="Unknown Exception: "+JSON.stringify(e);let l="";c.errorDetails&&(l+=c.errorDetails+`

`),l+=u;let p=L(c.errorMessage),h=c.showDetails?L(l):void 0,d=c.showDetails?L(c.errorTip):void 0;console.error("Gemini chat execution failed:",e),this.chatState.updateChatHistory(g=>{let f$1=[...g],I=f$1.length-1,H=f({role:"error",content:p,errorTitle:c.errorTitle,errorMessage:p,errorDetails:h,errorTip:d,promptId:a},c.isRetryable?{isRetryable:true,originalPrompt:t,attachments:n}:{});return I>=0&&f$1[I].role==="model"?(f$1[I]=H,f$1):(f$1.push(H),f$1)});}systemPrompt=this.promptFactory.systemPrompt;static \u0275fac=function(t){return new(t||o)};static \u0275prov=pe$1({token:o,factory:o.\u0275fac,providedIn:"root"})};export{P,de as d,he as h,ue as u,w};