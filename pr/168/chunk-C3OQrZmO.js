...
`],encapsulation:2,changeDetection:1})}return r})(),kt=new g("mat-snack-bar-default-options",{providedIn:"root",factory:()=>new A}),It=(()=>{class r{_live=f(_A);_injector=f(k);_breakpointObserver=f(lp);_parentSnackBar=f(r,{optional:true,skipSelf:true});_defaultConfig=f(kt);_animationsDisabled=Jt();_snackBarRefAtThisLevel=null;simpleSnackBarComponent=it;snackBarContainerComponent=St;handsetCssClass="mat-mdc-snack-bar-handset";get _openedSnackBarRef(){let e=this._parentSnackBar;return e?e._openedSnackBarRef:this._snackBarRefAtThisLevel}set _openedSnackBarRef(e){this._parentSnackBar?this._parentSnackBar._openedSnackBarRef=e:this._snackBarRefAtThisLevel=e;}openFromComponent(e,t){return this._attach(e,t)}openFromTemplate(e,t){return this._attach(e,t)}open(e,t="",a){let i=E$1(E$1({},this._defaultConfig),a);return i.data={message:e,action:t},i.announcementMessage===e&&(i.announcementMessage=void 0),this.openFromComponent(this.simpleSnackBarComponent,i)}dismiss(){this._openedSnackBarRef&&this._openedSnackBarRef.dismiss();}ngOnDestroy(){this._snackBarRefAtThisLevel&&this._snackBarRefAtThisLevel.dismiss();}_attachSnackBarContainer(e,t){let a=t&&t.viewContainerRef&&t.viewContainerRef.injector,i=k.create({parent:a||this._injector,providers:[{provide:A,useValue:t}]}),o=new wo(this.snackBarContainerComponent,t.viewContainerRef,i),s=e.attach(o);return s.instance.snackBarConfig=t,s.instance}_attach(e,t){let a=E$1(E$1(E$1({},new A),this._defaultConfig),t),i=this._createOverlay(a),o=this._attachSnackBarContainer(i,a),s=new E(o,i);if(e instanceof $e){let c=new Dr(e,null,{$implicit:a.data,snackBarRef:s});s.instance=o.attachTemplatePortal(c);}else {let c=this._createInjector(a,s),l=new wo(e,void 0,c),m=o.attachComponentPortal(l);s.instance=m.instance;}return this._breakpointObserver.observe(m3.HandsetPortrait).pipe(dn(i.detachments())).subscribe(c=>{i.overlayElement.classList.toggle(this.handsetCssClass,c.matches);}),a.announcementMessage&&o._onAnnounce.subscribe(()=>{this._live.announce(a.announcementMessage,a.politeness);}),this._animateSnackBar(s,a),this._openedSnackBarRef=s,this._openedSnackBarRef}_animateSnackBar(e,t){e.afterDismissed().subscribe(()=>{this._openedSnackBarRef==e&&(this._openedSnackBarRef=null),t.announcementMessage&&this._live.clear();}),t.duration&&t.duration>0&&e.afterOpened().subscribe(()=>e._dismissAfter(t.duration)),this._openedSnackBarRef?(this._openedSnackBarRef.afterDismissed().subscribe(()=>{e.containerInstance.enter();}),this._openedSnackBarRef.dismiss()):e.containerInstance.enter();}_createOverlay(e){let t=new Ir;t.direction=e.direction;let a=To(this._injector),i=e.direction==="rtl",o=e.horizontalPosition==="left"||e.horizontalPosition==="start"&&!i||e.horizontalPosition==="end"&&i,s=!o&&e.horizontalPosition!=="center";return o?a.left("0"):s?a.right("0"):a.centerHorizontally(),e.verticalPosition==="top"?a.top("0"):a.bottom("0"),t.positionStrategy=a,t.disableAnimations=this._animationsDisabled,es(this._injector,t)}_createInjector(e,t){let a=e&&e.viewContainerRef&&e.viewContainerRef.injector;return k.create({parent:a||this._injector,providers:[{provide:E,useValue:t},{provide:at,useValue:e.data}]})}static \u0275fac=function(t){return new(t||r)};static \u0275prov=C({token:r,factory:r.\u0275fac})}return r})();var Zt=(()=>{class r{static \u0275fac=function(t){return new(t||r)};static \u0275mod=Q({type:r});static \u0275inj=K({providers:[It],imports:[ts,wr,a_,it,st$1]})}return r})();var rt=`[
  {
    "version": "v0.9",
    "createSurface": {
