import {g,k as Qg,l as tn,M as M1,J as Jd,h as hI,z as zi$1,H as Hh,O as Ou,T as Tw,a as qh,n as dg,p as kh,F as FI,r as rg,V as VD,b as Vh,u as ug,s as lg,L as LI,v as Jh,w as nw,A as O1,C as RC,y as ys,G as Gw,E as G,I as j,x as xn,P as T,S as Le,U as ee,Z as mg,$ as zm,a0 as se$1,a1 as Vt,a2 as _E,a3 as ME,a4 as qw,a5 as Wm,a6 as ku,a7 as Pu,o as os,D as Dr$1,a8 as tp,_ as _u,a9 as Rh,aa as Ow,ab as Kn,ac as $c,ad as x1,K as KI,ae as Ph,B as Bh,af as Kh,d as ew,t as tw,Q as Qh,ag as zn$1,Y as Yn,ah as gC,ai as K,aj as H,ak as xi$2,al as We,am as ey,an as Um,ao as R1,ap as VI,aq as jh,ar as HI,c as hw,as as ng,at as ah,W,au as Tn$1,X as XI,av as yg,aw as jt,ax as e,N,ay as re,az as Vm,aA as Ve,aB as xC,aC as Gd$1,aD as Wd,aE as zh,f as rw,q as qI,R as Rd,aF as YI,i as Od,aG as Jm,aH as mD,aI as Uh,aJ as Fu,aK as Lu,aL as kw,aM as cr$1,aN as Gh,aO as II,aP as jI,aQ as $s,aR as ty,aS as rd,aT as x,aU as fr$1,aV as Lw,aW as Bw,j as ju,aX as BI,aY as Hw,aZ as Nw}from'./main.js';import {n as no$1,A as Ae,F as Fe,B,Y as Ye,u as ue,J as Jt,a as ae,_ as _e,s as st,q as q$1,b as J$1,V,R as Rt,G as G$1}from'./chunk-Cr2-CVMU.js';import {i as it$1,J,I as Ii$1,v as vi$1,k as ki$1,F as Fi$1,S as Si$1,b as bi$1,T as Ti$1,x as xi$1,M as Mi$1,E as Ei$1,O as Oi}from'./chunk-BCdAyVD3.js';import {H as H$1,K as Ke,X as Xe}from'./chunk-Dv7ARnqF.js';import {s as se,i as it$2,r as rn$1,o as on$1,V as Ve$1}from'./chunk-D3bcLhWK.js';import {X as Xt,$ as $i$1,D,G as Gd,H as Hd,w as wd,U as Uo$1,o as oo$1,E as Ed,f as fu,C as Ci$1,l as lu,a as Rs,T as Tu,q,r as ri$1,x as xe,R,b as Cn,c as ao$1,d as Gc,e as ac,z as zr,g as St,A as At,h as Gr,Q as Qt,i as To$1,j as ll,k as jo$1,m as Ao$1,S as Se,n as wn,p as Co$1,s as so,t as bn}from'./chunk-C7DFiyEa.js';var Ea=`
...
`.trim()+`
`;function nt(a){let i=a.trim();if(i.startsWith("[")&&i.endsWith("]"))try{let e=JSON.parse(i);if(Array.isArray(e))return e}catch{}return null}var on="updateComponents",Mn="components",Ci="registerMockRules",wi="mockRulesConfig",Mi="rules",ki="id",Di="children",Ia="mock_rules_container",at=class a{destroyRef=g(Le);chatState=g(J);catalogManagement=g(oo$1);_activeDraft=tn("");activeDraft=this._activeDraft.asReadonly();_draftInput=tn("");constructor(){Jd(()=>{let i=this.catalogManagement.activeCatalog();if(i){let e=i.catalogId||"";mg(()=>{let t=this._activeDraft(),n=this.getCatalogIdFromDraft(t);(t===""||n!==e)&&this._activeDraft.set(this.getInitialDraft(e));});}}),Tu(this._draftInput).pipe(Jm(1),zm(300),Wm(),$i$1(this.destroyRef)).subscribe(i=>{this.syncLayoutToHistory(i);});}updateDraft(i){this._activeDraft.set(i),this._draftInput.set(i);}hydrateActiveDraft(){return this._activeDraft()}commitLayoutFromLlm(i){this._activeDraft.set(i);}flushDraft(){let e=this.catalogManagement.activeCatalog()?.catalogId||"";this._activeDraft.set(this.getInitialDraft(e));}getInitialDraft(i){return i==="https://a2ui.org/specification/v0_9/basic_catalog.json"?Ea:i?JSON.stringify({version:"v0.9",createSurface:{surfaceId:"sample-surface",catalogId:i,sendDataModel:true}})+`
...
`);for(let n of t){let o=n.trim();if(o)try{let s=JSON.parse(o);if(s?.createSurface?.catalogId)return s.createSurface.catalogId}catch{}}return null}syncLayoutToHistory(i){let e=this.sanitizeLayout(i),t=this.chatState.chatHistory();if(t.length===0){this.chatState.setChatHistory([{role:"user",content:e}]);return}let n=t[t.length-1];if(n.role==="user"&&n.content.trim().startsWith('{"version"')){let s=[...t];s[s.length-1]={role:"user",content:e},this.chatState.setChatHistory(s);}else this.chatState.updateChatHistory(s=>[...s,{role:"user",content:e}]);}sanitizeLayout(i){let e=i.trim();if(!e)return "";let t=nt(e);if(t)return t.map(l=>l&&typeof l=="object"&&!Array.isArray(l)?this.sanitizeBlock(l):l).filter(Boolean).map(l=>JSON.stringify(l)).join(`
`)+`
`;let n=e.split(`
...
`).map(l=>l.trim()).filter(l=>l.length>0),s=[];for(let l of o)if(!(l.startsWith("```")||!l.startsWith("{")&&!l.startsWith("[")))try{s.push(JSON.parse(l));}catch{this.chatState.setPipelineStatus("healing");let b=this.attemptSyntaxHealing(l);if(b!==null)s.push(b);else if(l.includes('"version"')||l.includes('"createSurface"'))throw new Error(`Syntax recovery failed for corrupted JSON Line:
"${l}"`)}if(s.length===0)throw new Error("No valid A2UI JSON layout command block could be parsed or recovered.");return s}attemptSyntaxHealing(i){let e=i.trim();e=e.replace(/,\s*([\]}])/g,"$1");try{return JSON.parse(e)}catch{for(let n=1;n<=5;n++)try{return JSON.parse(e+"}".repeat(n))}catch{}for(let n=1;n<=3;n++)for(let o=1;o<=3;o++)try{return JSON.parse(e+"]".repeat(n)+"}".repeat(o))}catch{}}return null}runCatalogComponentSchemaCheck(i){let e=this.catalogManagement.activeCatalog(),t={};if(e&&e.components)for(let o of Object.keys(e.components)){let s=o.toLowerCase().replace(/[^a-z]/g,"");t[s]=o;}let n={textbox:"textfield",textinput:"textfield",rowlayout:"row",columnlayout:"column",choice:"choicepicker",datepicker:"datetimeinput",datetimepicker:"datetimeinput"};for(let o of i){if(!o||typeof o!="object")continue;let l=o.updateComponents;if(!l||typeof l!="object"||!Array.isArray(l.components))continue;let u=[];for(let b of l.components){if(!b||typeof b!="object"||Array.isArray(b)){u.push(b);continue}let j=b,ee=j.component;if(j.name&&!j.component&&(this.chatState.setPipelineStatus("healing"),ee=j.name,j.component=ee,delete j.name),typeof ee!="string")throw new Error("Component declaration is missing component type name string.");let $=ee;if(e&&e.components&&!e.components[ee]){let _e=ee.toLowerCase().replace(/[^a-z]/g,""),st=t[_e];if(!st){let lt=n[_e];lt&&(st=t[lt]);}if(st&&e.components[st])this.chatState.setPipelineStatus("healing"),$=st;else {let lt=_e?Object.keys(e.components).find(Wn=>Wn.toLowerCase().includes(_e)||_e.includes(Wn.toLowerCase())):void 0;if(lt)this.chatState.setPipelineStatus("healing"),$=lt;else throw new Error(`Validation failure: Component type "${ee}" is not registered in the active custom catalog.`)}}let Re=this.sanitizeComponentObject(j);Re.component=$,u.push(Re);}l.components=u;}}sanitizeValue(i){if(i===null||typeof i!="object")return i;if(Array.isArray(i))return i.map(n=>this.sanitizeValue(n));let e=i,t={};for(let[n,o]of Object.entries(e))n==="rules"||/^mock/i.test(n)||(t[n]=this.sanitizeValue(o));return t}sanitizeComponentObject(i){return this.sanitizeValue(i)}TEST_ONLY={sanitizeComponentObject:i=>this.sanitizeComponentObject(i)};handleConnectivityError(i,e){let t=i instanceof Error?i.message:String(i);t.includes("Failed to fetch")||t.includes("fetch")||t.includes("Timeout")||t.includes("timeout")||t.includes("504")||t.includes("Proxy")||t.includes("proxy")||t.includes("NetworkError")||t.includes("TypeError")||t.includes("connection")||t.includes("Connection")||t.includes("401")||t.includes("403")||t.includes("credential")||t.includes("quota")||t.includes("blocked")||t.includes("503")||t.includes("UNAVAILABLE")?this.chatState.setPipelineStatus("idle"):this.chatState.setPipelineStatus("failed"),this.chatState.setProgrammaticStreamActive(false);let o;i instanceof Error?o=`Exception: ${i.message}
Stack: ${i.stack||"None"}`:o=`Unknown Exception: ${JSON.stringify(i)}`;let s=t.includes("validation")||t.includes("Syntax recovery")||t.includes("Validation failure"),l=s?"\u26A0\uFE0F Validation Failure. The generated layout contains invalid components or structure.":"\u26A0\uFE0F Connectivity Failure. Remote gateway communication drop.",u=!!e,b=t.includes("503")||t.includes("UNAVAILABLE")||t.includes("high demand")||t.includes("experiencing high demand");b?(l="\u26A0\uFE0F This model is currently experiencing high demand. Spikes in demand are usually temporary. Please try again later.",u=true):t.includes("Timeout")||t.includes("504")?l=`\u26A0\uFE0F REST Gateway Timeout. Remote generation service did not respond.
...
Details: `+t);let j$1=l;if(!b){let ee=s?"[A2UI Schema Validation or Parsing Exception]":"[REST Gateway Timeout or Connectivity Exception]",$=s?"Tip: Try rephrasing your prompt to guide the model to generate valid components.":"Tip: Please check your network proxy configurations or supply your third-party Gemini developer token key on the settings page to restore connections.";j$1+=`
...
`+$;}this.chatState.updateChatHistory(ee=>{let $=[...ee],Re=$.length-1,_e=j({role:"error",content:j$1},u?{isRetryable:true,originalPrompt:e}:{});return Re>=0&&$[Re].role==="model"?($[Re]=_e,$):($.push(_e),$)});}systemPrompt=Gw(()=>{let i=this.catalogManagement.activeCatalog();return i?this.generateSystemPrompt(JSON.stringify(i,null,2)):`You are an AI assistant designed to help model mock screens inside A2UI Composer shell.
Status: Awaiting renderer dynamic handshake settlement...`});generateSystemPrompt(i){return `
  ...
  `}static \u0275fac=function(e){return new(e||a)};static \u0275prov=N({token:a,factory:a.\u0275fac,providedIn:"root"})};var Ti=["determinateSpinner"];function Si(a,i){if(a&1&&(Gd$1(),zi$1(0,"svg",11),Hh(1,"circle",12),Ou()),a&2){let e=YI();Bh("viewBox",e._viewBox()),VD(),ng("stroke-dasharray",e._strokeCircumference(),"px")("stroke-dashoffset",e._strokeCircumference()/2,"px")("stroke-width",e._circleStrokeWidth(),"%"),Bh("r",e._circleRadius());}}var Ei=new T("mat-progress-spinner-default-options",{providedIn:"root",factory:()=>({diameter:Aa})}),Aa=100,Ii=10,Ra=(()=>{class a{_elementRef=g(Yn);_noopAnimations;get color(){return this._color||this._defaultColor}set color(e){this._color=e;}_color;_defaultColor="primary";_determinateCircle;constructor(){let e=g(Ei),t=To$1(),n=this._elementRef.nativeElement;this._noopAnimations=t==="di-disabled"&&!!e&&!e._forceAnimations,this.mode=n.nodeName.toLowerCase()==="mat-spinner"?"indeterminate":"determinate",!this._noopAnimations&&t==="reduced-motion"&&n.classList.add("mat-progress-spinner-reduced-motion"),e&&(e.color&&(this.color=this._defaultColor=e.color),e.diameter&&(this.diameter=e.diameter),e.strokeWidth&&(this.strokeWidth=e.strokeWidth));}mode;get value(){return this.mode==="determinate"?this._value:0}set value(e){this._value=Math.max(0,Math.min(100,e||0));}_value=0;get diameter(){return this._diameter}set diameter(e){this._diameter=e||0;}_diameter=Aa;get strokeWidth(){return this._strokeWidth??this.diameter/10}set strokeWidth(e){this._strokeWidth=e||0;}_strokeWidth;_circleRadius(){return (this.diameter-Ii)/2}_viewBox(){let e=this._circleRadius()*2+this.strokeWidth;return `0 0 ${e} ${e}`}_strokeCircumference(){return 2*Math.PI*this._circleRadius()}_strokeDashOffset(){return this.mode==="determinate"?this._strokeCircumference()*(100-this._value)/100:null}_circleStrokeWidth(){return this.strokeWidth/this.diameter*100}static \u0275fac=function(t){return new(t||a)};static \u0275cmp=hI({type:a,selectors:[["mat-progress-spinner"],["mat-spinner"]],viewQuery:function(t,n){if(t&1&&Kh(Ti,5),t&2){let o;ew(o=tw())&&(n._determinateCircle=o.first);}},hostAttrs:["role","progressbar","tabindex","-1",1,"mat-mdc-progress-spinner","mdc-circular-progress"],hostVars:18,hostBindings:function(t,n){t&2&&(Bh("aria-valuemin",0)("aria-valuemax",100)("aria-valuenow",n.mode==="determinate"?n.value:null)("mode",n.mode),hw("mat-"+n.color),ng("width",n.diameter,"px")("height",n.diameter,"px")("--mat-progress-spinner-size",n.diameter+"px")("--mat-progress-spinner-active-indicator-width",n.diameter+"px"),rg("_mat-animation-noopable",n._noopAnimations)("mdc-circular-progress--indeterminate",n.mode==="indeterminate"));},inputs:{color:"color",mode:"mode",value:[2,"value","value",R1],diameter:[2,"diameter","diameter",R1],strokeWidth:[2,"strokeWidth","strokeWidth",R1]},exportAs:["matProgressSpinner"],decls:14,vars:11,consts:[["circle",""],["determinateSpinner",""],["aria-hidden","true",1,"mdc-circular-progress__determinate-container"],["xmlns","http://www.w3.org/2000/svg","focusable","false",1,"mdc-circular-progress__determinate-circle-graphic"],["cx","50%","cy","50%",1,"mdc-circular-progress__determinate-circle"],["aria-hidden","true",1,"mdc-circular-progress__indeterminate-container"],[1,"mdc-circular-progress__spinner-layer"],[1,"mdc-circular-progress__circle-clipper","mdc-circular-progress__circle-left"],[3,"ngTemplateOutlet"],[1,"mdc-circular-progress__gap-patch"],[1,"mdc-circular-progress__circle-clipper","mdc-circular-progress__circle-right"],["xmlns","http://www.w3.org/2000/svg","focusable","false",1,"mdc-circular-progress__indeterminate-circle-graphic"],["cx","50%","cy","50%"]],template:function(t,n){if(t&1&&(kh(0,Si,2,8,"ng-template",null,0,Hw),zi$1(2,"div",2,1),Gd$1(),zi$1(4,"svg",3),Hh(5,"circle",4),Ou()(),Wd(),zi$1(6,"div",5)(7,"div",6)(8,"div",7),zh(9,8),Ou(),zi$1(10,"div",9),zh(11,8),Ou(),zi$1(12,"div",10),zh(13,8),Ou()()()),t&2){let o=rw(1);VD(4),Bh("viewBox",n._viewBox()),VD(),ng("stroke-dasharray",n._strokeCircumference(),"px")("stroke-dashoffset",n._strokeDashOffset(),"px")("stroke-width",n._circleStrokeWidth(),"%"),Bh("r",n._circleRadius()),VD(4),Vh("ngTemplateOutlet",o),VD(2),Vh("ngTemplateOutlet",o),VD(2),Vh("ngTemplateOutlet",o);}},dependencies:[xC],styles:[`.mat-mdc-progress-spinner {
...
`],encapsulation:2,changeDetection:1})}return a})(),_t=class{overlayRef;config;componentInstance=null;componentRef=null;containerInstance;disableClose;closed=new ee;backdropClick;keydownEvents;outsidePointerEvents;id;_detachSubscription;constructor(i,e){this.overlayRef=i,this.config=e,this.disableClose=e.disableClose,this.backdropClick=i.backdropClick(),this.keydownEvents=i.keydownEvents(),this.outsidePointerEvents=i.outsidePointerEvents(),this.id=e.id,this.keydownEvents.subscribe(t=>{t.keyCode===27&&!this.disableClose&&!Gr(t)&&(t.preventDefault(),this.close(void 0,{focusOrigin:"keyboard"}));}),this.backdropClick.subscribe(()=>{!this.disableClose&&this._canClose()?this.close(void 0,{focusOrigin:"mouse"}):this.containerInstance._recaptureFocus?.();}),this._detachSubscription=i.detachments().subscribe(()=>{e.closeOnOverlayDetachments!==false&&this.close();});}close(i,e){if(this._canClose(i)){let t=this.closed;this.containerInstance._closeInteractionType=e?.focusOrigin||"program",this._detachSubscription.unsubscribe(),this.overlayRef.dispose(),t.next(i),t.complete(),this.componentInstance=this.containerInstance=null;}}updatePosition(){return this.overlayRef.updatePosition(),this}updateSize(i="",e=""){return this.overlayRef.updateSize({width:i,height:e}),this}addPanelClass(i){return this.overlayRef.addPanelClass(i),this}removePanelClass(i){return this.overlayRef.removePanelClass(i),this}_canClose(i){let e=this.config;return !!this.containerInstance&&(!e.closePredicate||e.closePredicate(i,e,this.componentInstance))}},Ri=new T("DialogScrollStrategy",{providedIn:"root",factory:()=>{let a=g(re);return ()=>ae(a)}}),Li=new T("DialogData"),Bi=new T("DefaultDialogConfig");function Ni(a){let i=tn(a),e=new We;return {valueSignal:i,get value(){return i()},change:e,ngOnDestroy(){e.complete();}}}var Pn=(()=>{class a{_injector=g(re);_defaultOptions=g(Bi,{optional:true});_parentDialog=g(a,{optional:true,skipSelf:true});_overlayContainer=g(_e);_idGenerator=g(Cn);_openDialogsAtThisLevel=[];_afterAllClosedAtThisLevel=new ee;_afterOpenedAtThisLevel=new ee;_ariaHiddenElements=new Map;_scrollStrategy=g(Ri);get openDialogs(){return this._parentDialog?this._parentDialog.openDialogs:this._openDialogsAtThisLevel}get afterOpened(){return this._parentDialog?this._parentDialog.afterOpened:this._afterOpenedAtThisLevel}afterAllClosed=Vm(()=>this.openDialogs.length?this._getAfterAllClosed():this._getAfterAllClosed().pipe(ey(void 0)));open(e,t){let n=this._defaultOptions||new Pe;t=j(j({},n),t),t.id=t.id||this._idGenerator.getId("cdk-dialog-"),t.id&&this.getDialogById(t.id);let o=this._getOverlayConfig(t),s=st(this._injector,o),l=new _t(s,t),u=this._attachContainer(s,l,t);if(l.containerInstance=u,!this.openDialogs.length){let b=this._overlayContainer.getContainerElement();u._focusTrapped?u._focusTrapped.pipe(Tn$1(1)).subscribe(()=>{this._hideNonDialogContentFromAssistiveTechnology(b);}):this._hideNonDialogContentFromAssistiveTechnology(b);}return this._attachDialogContent(e,l,u,t),this.openDialogs.push(l),l.closed.subscribe(()=>this._removeOpenDialog(l,true)),this.afterOpened.next(l),l}closeAll(){kn(this.openDialogs,e=>e.close());}getDialogById(e){return this.openDialogs.find(t=>t.id===e)}ngOnDestroy(){kn(this._openDialogsAtThisLevel,e=>{e.config.closeOnDestroy===false&&this._removeOpenDialog(e,false);}),kn(this._openDialogsAtThisLevel,e=>e.close()),this._afterAllClosedAtThisLevel.complete(),this._afterOpenedAtThisLevel.complete(),this._openDialogsAtThisLevel=[];}_getOverlayConfig(e){let t=new q$1({positionStrategy:e.positionStrategy||ue().centerHorizontally().centerVertically(),scrollStrategy:e.scrollStrategy||this._scrollStrategy(),panelClass:e.panelClass,hasBackdrop:e.hasBackdrop,direction:e.direction,minWidth:e.minWidth,minHeight:e.minHeight,maxWidth:e.maxWidth,maxHeight:e.maxHeight,width:e.width,height:e.height,disposeOnNavigation:e.closeOnNavigation,disableAnimations:e.disableAnimations});return e.backdropClass&&(t.backdropClass=e.backdropClass),t}_attachContainer(e,t,n){let o=n.injector||n.viewContainerRef?.injector,s=[{provide:Pe,useValue:n},{provide:_t,useValue:t},{provide:J$1,useValue:e}],l;n.container?typeof n.container=="function"?l=n.container:(l=n.container.type,s.push(...n.container.providers(n))):l=Dn;let u=new V(l,n.viewContainerRef,re.create({parent:o||this._injector,providers:s}));return e.attach(u).instance}_attachDialogContent(e,t,n,o){if(e instanceof zn$1){let s=this._createInjector(o,t,n,void 0),l={$implicit:o.data,dialogRef:t};o.templateContext&&(l=j(j({},l),typeof o.templateContext=="function"?o.templateContext():o.templateContext)),n.attachTemplatePortal(new B(e,null,l,s));}else {let s=this._createInjector(o,t,n,this._injector),l=n.attachComponentPortal(new V(e,o.viewContainerRef,s,null,o.bindings));t.componentRef=l,t.componentInstance=l.instance;}}_createInjector(e,t,n,o){let s=e.injector||e.viewContainerRef?.injector,l=[{provide:Li,useValue:e.data},{provide:_t,useValue:t}];return e.providers&&(typeof e.providers=="function"?l.push(...e.providers(t,e,n)):l.push(...e.providers)),e.direction&&(!s||!s.get(jo$1,null,{optional:true}))&&l.push({provide:jo$1,useValue:Ni(e.direction)}),re.create({parent:s||o,providers:l})}_removeOpenDialog(e,t){let n=this.openDialogs.indexOf(e);n>-1&&(this.openDialogs.splice(n,1),this.openDialogs.length||(this._ariaHiddenElements.forEach((o,s)=>{o?s.setAttribute("aria-hidden",o):s.removeAttribute("aria-hidden");}),this._ariaHiddenElements.clear(),t&&this._getAfterAllClosed().next()));}_hideNonDialogContentFromAssistiveTechnology(e){if(e.parentElement){let t=e.parentElement.children;for(let n=t.length-1;n>-1;n--){let o=t[n];o!==e&&o.nodeName!=="SCRIPT"&&o.nodeName!=="STYLE"&&!o.hasAttribute("aria-live")&&!o.hasAttribute("popover")&&(this._ariaHiddenElements.set(o,o.getAttribute("aria-hidden")),o.setAttribute("aria-hidden","true"));}}}_getAfterAllClosed(){let e=this._parentDialog;return e?e._getAfterAllClosed():this._afterAllClosedAtThisLevel}static \u0275fac=function(t){return new(t||a)};static \u0275prov=Ve({token:a,factory:a.\u0275fac})}return a})();function kn(a,i){let e=a.length;for(;e--;)i(a[e]);}var Na=(()=>{class a{static \u0275fac=function(t){return new(t||a)};static \u0275mod=os({type:a});static \u0275inj=Dr$1({providers:[Pn],imports:[Rt,Jt,Ao$1,Jt]})}return a})();function Fi(a,i){}var ln=class{viewContainerRef;injector;id;role="dialog";panelClass="";hasBackdrop=true;backdropClass="";disableClose=false;closePredicate;width="";height="";minWidth;minHeight;maxWidth;maxHeight;position;data=null;direction;ariaDescribedBy=null;ariaLabelledBy=null;ariaLabel=null;ariaModal=false;autoFocus="first-tabbable";restoreFocus=true;delayFocusTrap=true;scrollStrategy;closeOnNavigation=true;enterAnimationDuration;exitAnimationDuration;bindings},Tn="mdc-dialog--open",Fa="mdc-dialog--opening",za="mdc-dialog--closing",zi=150,Hi=75,ji=(()=>{class a extends Dn{_animationStateChanged=new We;_animationsEnabled=!xe();_actionSectionCount=0;_hostElement=this._elementRef.nativeElement;_enterAnimationDuration=this._animationsEnabled?ja(this._config.enterAnimationDuration)??zi:0;_exitAnimationDuration=this._animationsEnabled?ja(this._config.exitAnimationDuration)??Hi:0;_animationTimer=null;_contentAttached(){super._contentAttached(),this._startOpenAnimation();}_startOpenAnimation(){this._animationStateChanged.emit({state:"opening",totalTime:this._enterAnimationDuration}),this._animationsEnabled?(this._hostElement.style.setProperty(Ha,`${this._enterAnimationDuration}ms`),this._requestAnimationFrame(()=>this._hostElement.classList.add(Fa,Tn)),this._waitForAnimationToComplete(this._enterAnimationDuration,this._finishDialogOpen)):(this._hostElement.classList.add(Tn),Promise.resolve().then(()=>this._finishDialogOpen()));}_startExitAnimation(){this._animationStateChanged.emit({state:"closing",totalTime:this._exitAnimationDuration}),this._hostElement.classList.remove(Tn),this._animationsEnabled?(this._hostElement.style.setProperty(Ha,`${this._exitAnimationDuration}ms`),this._requestAnimationFrame(()=>this._hostElement.classList.add(za)),this._waitForAnimationToComplete(this._exitAnimationDuration,this._finishDialogClose)):Promise.resolve().then(()=>this._finishDialogClose());}_updateActionSectionCount(e){this._actionSectionCount+=e,this._changeDetectorRef.markForCheck();}_finishDialogOpen=()=>{this._clearAnimationClasses(),this._openAnimationDone(this._enterAnimationDuration);};_finishDialogClose=()=>{this._clearAnimationClasses(),this._animationStateChanged.emit({state:"closed",totalTime:this._exitAnimationDuration});};_clearAnimationClasses(){this._hostElement.classList.remove(Fa,za);}_waitForAnimationToComplete(e,t){this._animationTimer!==null&&clearTimeout(this._animationTimer),this._animationTimer=setTimeout(t,e);}_requestAnimationFrame(e){this._ngZone.runOutsideAngular(()=>{typeof requestAnimationFrame=="function"?requestAnimationFrame(e):e();});}_captureInitialFocus(){this._config.delayFocusTrap||this._trapFocus();}_openAnimationDone(e){this._config.delayFocusTrap&&this._trapFocus(),this._animationStateChanged.next({state:"opened",totalTime:e});}ngOnDestroy(){super.ngOnDestroy(),this._animationTimer!==null&&clearTimeout(this._animationTimer);}attachComponentPortal(e){let t=super.attachComponentPortal(e);return t.location.nativeElement.classList.add("mat-mdc-dialog-component-host"),t}static \u0275fac=(()=>{let e;return function(n){return (e||(e=tp(a)))(n||a)}})();static \u0275cmp=hI({type:a,selectors:[["mat-dialog-container"]],hostAttrs:["tabindex","-1",1,"mat-mdc-dialog-container","mdc-dialog"],hostVars:10,hostBindings:function(t,n){t&2&&(Gh("id",n._config.id),Bh("aria-modal",n._config.ariaModal)("role",n._config.role)("aria-labelledby",n._config.ariaLabel?null:n._ariaLabelledByQueue[0])("aria-label",n._config.ariaLabel)("aria-describedby",n._config.ariaDescribedBy||null),rg("_mat-animation-noopable",!n._animationsEnabled)("mat-mdc-dialog-container-with-actions",n._actionSectionCount>0));},features:[Rh],decls:3,vars:0,consts:[[1,"mat-mdc-dialog-inner-container","mdc-dialog__container"],[1,"mat-mdc-dialog-surface","mdc-dialog__surface"],["cdkPortalOutlet",""]],template:function(t,n){t&1&&(zi$1(0,"div",0)(1,"div",1),kh(2,Fi,0,0,"ng-template",2),Ou()());},dependencies:[Ye],styles:[`.mat-mdc-dialog-container {
  width: 100%;
  height: 100%;
  display: block;
  box-sizing: border-box;
...
`]})};var Xa=new T("IS_EXTENSION_MODE",{providedIn:"root",factory:()=>tn(false)});function oo(a,i){a&1&&(zi$1(0,"div",1),Tw(1,"\u26A0\uFE0F Invalid JSON syntax detected."),Ou());}var pn=class a{isExtensionMode=g(Xa);layoutJson;isJsonInvalid=tn(false);TEST_ONLY={layoutJson:()=>this.layoutJson,isJsonInvalid:()=>this.isJsonInvalid};hostCommunication=g(Xt);catalogManagement=g(oo$1);stateSync=g(at);chatState=g(J);destroyRef=g(Le);layoutInput$=new ee;isLocked=this.chatState.isProgrammaticStreamActive;constructor(){this.layoutJson=tn(this.stateSync.hydrateActiveDraft()),Jd(()=>{if(this.catalogManagement.activeCatalog()){let e=mg(()=>this.layoutJson());try{let t=this.parseLayoutString(e);t!==null&&this.hostCommunication.sendRenderA2UI(t);}catch{}}}),Jd(()=>{let i=this.stateSync.activeDraft();mg(()=>{this.layoutJson()!==i&&queueMicrotask(()=>{this.layoutJson.set(i);try{let e=this.parseLayoutString(i);e!==null?(this.isJsonInvalid.set(!1),this.hostCommunication.sendRenderA2UI(e)):this.isJsonInvalid.set(!0);}catch{this.isJsonInvalid.set(true);}});});}),this.layoutInput$.pipe(zm(300),se$1(i=>{try{let e=this.parseLayoutString(i);return e!==null?(this.isJsonInvalid.set(!1),e):(this.isJsonInvalid.set(!0),null)}catch{return this.isJsonInvalid.set(true),null}}),Vt(i=>i!==null),$i$1(this.destroyRef)).subscribe(i=>{this.hostCommunication.sendRenderA2UI(i);});}onLayoutChange(i){this.layoutJson.set(i),this.layoutInput$.next(i),this.stateSync.updateDraft(i);}parseLayoutString(i){let e=i.trim();if(!e)return [];if(e.startsWith("[")){let n=nt(e);if(n===null)throw new SyntaxError("Invalid JSON Array");return n}return e.split(`
`).map(n=>n.trim()).filter(n=>n.length>0).map(n=>JSON.parse(n))}static \u0275fac=function(e){return new(e||a)};static \u0275cmp=hI({type:a,selectors:[["a2ui-composer-raw-frame"]],decls:4,vars:7,consts:[[1,"raw-frame-container"],[1,"invalid-json-badge"],["appearance","outline","subscriptSizing","dynamic",1,"raw-json-field"],["matInput","","aria-label","Raw layout JSON","placeholder","Enter raw JSON here...",3,"ngModelChange","ngModel","readOnly"]],template:function(e,t){e&1&&(zi$1(0,"div",0),FI(1,oo,2,0,"div",1),zi$1(2,"mat-form-field",2)(3,"textarea",3),qh("ngModelChange",function(o){return t.onLayoutChange(o)}),Ou(),_E(),Ou()()),e&2&&(rg("is-collapsed",t.isExtensionMode())("is-locked",t.isLocked()),VD(),LI(t.isJsonInvalid()?1:-1),VD(2),Vh("ngModel",t.layoutJson())("readOnly",t.isLocked()),ME());},dependencies:[se,it$2,rn$1,on$1,fu,Ci$1,lu,Rs],styles:["[_nghost-%COMP%]{flex:1;display:block;width:100%;height:100%}.raw-frame-container[_ngcontent-%COMP%]{display:flex;flex-direction:column;padding:0;height:100%;box-sizing:border-box;transition:all .3s ease}.raw-frame-container.is-locked[_ngcontent-%COMP%]{opacity:.55;pointer-events:none;cursor:not-allowed}.raw-frame-container.is-locked[_ngcontent-%COMP%]   textarea[_ngcontent-%COMP%]{cursor:not-allowed}.raw-frame-container[_ngcontent-%COMP%]   .invalid-json-badge[_ngcontent-%COMP%]{color:#f44336;font-weight:700;padding:8px 0}.raw-frame-container[_ngcontent-%COMP%]   .raw-json-field[_ngcontent-%COMP%]{width:100%;height:100%;flex:1 1 auto;display:block}.raw-frame-container[_ngcontent-%COMP%]   .raw-json-field[_ngcontent-%COMP%]     .mdc-notched-outline{display:none!important}.raw-frame-container[_ngcontent-%COMP%]   .raw-json-field[_ngcontent-%COMP%]     .mat-mdc-text-field-wrapper{height:100%;padding-right:0}.raw-frame-container[_ngcontent-%COMP%]   .raw-json-field[_ngcontent-%COMP%]     .mat-mdc-form-field-flex{height:100%;background-color:transparent;padding:0}.raw-frame-container[_ngcontent-%COMP%]   .raw-json-field[_ngcontent-%COMP%]     .mat-mdc-form-field-infix{height:100%;display:flex;flex-direction:column;box-sizing:border-box;padding-top:0}.raw-frame-container[_ngcontent-%COMP%]   .raw-json-field[_ngcontent-%COMP%]   textarea[_ngcontent-%COMP%]{font-family:monospace;resize:none;flex:1 1 auto;height:100%;width:100%;box-sizing:border-box;border:none;outline:none;background:transparent}.raw-frame-container.is-collapsed[_ngcontent-%COMP%]   .raw-json-field[_ngcontent-%COMP%]{font-size:12px}.raw-frame-container.is-collapsed[_ngcontent-%COMP%]   .raw-json-field[_ngcontent-%COMP%]     .mat-mdc-form-field-flex{padding:0}.raw-frame-container.is-collapsed[_ngcontent-%COMP%]   .raw-json-field[_ngcontent-%COMP%]     .mat-mdc-form-field-infix{padding-top:0}"]})};function ro(a,i){a&1&&(zi$1(0,"div",1),Tw(1,"\u26A0\uFE0F Invalid JSON syntax detected."),Ou());}var un=class a{hostComm=g(Xt);lastSurfaceId="sample-surface";lastPath=void 0;latestModelValue=tn(null);dataModelJson=qw({source:this.latestModelValue,computation:i=>i===null?"":typeof i=="string"?i:JSON.stringify(i,null,2)});isJsonInvalid=Gw(()=>{let i=this.dataModelJson();if(!i)return  false;try{return JSON.parse(i),!1}catch{return  true}});constructor(){Jd(()=>{let i=this.hostComm.messageStream();if(i?.type===D.DATA_MODEL_CHANGE){let t=i?.payload?.updateDataModel;if(t){typeof t.surfaceId=="string"&&(this.lastSurfaceId=t.surfaceId),typeof t.path=="string"?this.lastPath=t.path:this.lastPath=void 0;let n=t.value;mg(()=>this.latestModelValue.set(n));}}}),Tu(this.dataModelJson).pipe(zm(300),Wm(),Vt(i=>{try{return JSON.parse(i),!0}catch{return  false}})).subscribe(i=>{let e=JSON.parse(i),t=this.latestModelValue(),n=t?JSON.stringify(t):"",o=JSON.stringify(e);n!==o&&this.hostComm.sendMessage({type:D.DATA_MODEL_CHANGE,payload:{updateDataModel:{surfaceId:this.lastSurfaceId,path:this.lastPath,value:e}}});});}static \u0275fac=function(e){return new(e||a)};static \u0275cmp=hI({type:a,selectors:[["a2ui-composer-data-model"]],decls:4,vars:2,consts:[[1,"data-model-container"],[1,"invalid-json-badge"],["appearance","outline","subscriptSizing","dynamic",1,"data-model-field"],["matInput","","aria-label","Data model JSON","placeholder","Enter data model JSON here...",3,"ngModelChange","ngModel"]],template:function(e,t){e&1&&(zi$1(0,"div",0),FI(1,ro,2,0,"div",1),zi$1(2,"mat-form-field",2)(3,"textarea",3),qh("ngModelChange",function(o){return t.dataModelJson.set(o)}),Ou(),_E(),Ou()()),e&2&&(VD(),LI(t.isJsonInvalid()?1:-1),VD(2),Vh("ngModel",t.dataModelJson()),ME());},dependencies:[se,it$2,rn$1,on$1,fu,Ci$1,lu,Rs],styles:["[_nghost-%COMP%]{display:flex;flex-direction:column;height:100%;width:100%}.data-model-container[_ngcontent-%COMP%]{display:flex;flex-direction:column;height:100%;width:100%;flex:1}.data-model-container[_ngcontent-%COMP%]   .invalid-json-badge[_ngcontent-%COMP%]{color:#f44336;font-weight:700;padding:8px 0}.data-model-container[_ngcontent-%COMP%]   .data-model-field[_ngcontent-%COMP%]{width:100%;flex:1;min-height:0;display:block}.data-model-container[_ngcontent-%COMP%]   .data-model-field[_ngcontent-%COMP%]     .mdc-notched-outline{display:none!important}.data-model-container[_ngcontent-%COMP%]   .data-model-field[_ngcontent-%COMP%]     .mat-mdc-text-field-wrapper{height:100%;padding-right:0}.data-model-container[_ngcontent-%COMP%]   .data-model-field[_ngcontent-%COMP%]     .mat-mdc-form-field-flex{height:100%;background-color:transparent;padding:0}.data-model-container[_ngcontent-%COMP%]   .data-model-field[_ngcontent-%COMP%]     .mat-mdc-form-field-infix{height:100%;display:flex;flex-direction:column;box-sizing:border-box;padding-top:0}.data-model-container[_ngcontent-%COMP%]   .data-model-field[_ngcontent-%COMP%]   textarea[_ngcontent-%COMP%]{font-family:monospace;resize:none;flex:1 1 auto;height:100%;width:100%;box-sizing:border-box;border:none;outline:none;background:transparent}"]})};function ge(a){let i=new Date(a),e=String(i.getHours()).padStart(2,"0"),t=String(i.getMinutes()).padStart(2,"0"),n=String(i.getSeconds()).padStart(2,"0"),o=String(i.getMilliseconds()).padStart(3,"0");return `${e}:${t}:${n}.${o}`}function lo(a,i){a&1&&(zi$1(0,"th",12),Tw(1,"Time"),Ou());}function co(a,i){if(a&1&&(zi$1(0,"td",13),Tw(1),Ou()),a&2){let e=i.$implicit;VD(),ug(e.time);}}function mo(a,i){a&1&&(zi$1(0,"th",12),Tw(1,"Action Name"),Ou());}function po(a,i){if(a&1&&(zi$1(0,"td",13),Tw(1),Ou()),a&2){let e=i.$implicit;VD(),ug(e.action);}}function uo(a,i){a&1&&(zi$1(0,"th",12),Tw(1,"Surface ID"),Ou());}function go(a,i){if(a&1&&(zi$1(0,"td",13),Tw(1),Ou()),a&2){let e=i.$implicit;VD(),ug(e.surface);}}function ho(a,i){a&1&&(zi$1(0,"th",12),Tw(1,"Source Component"),Ou());}function bo(a,i){if(a&1&&(zi$1(0,"td",13),Tw(1),Ou()),a&2){let e=i.$implicit;VD(),ug(e.component);}}function fo(a,i){a&1&&(zi$1(0,"th",12),Tw(1,"Context"),Ou());}function _o(a,i){if(a&1&&(zi$1(0,"td",13)(1,"pre",14),Tw(2),Lw(3,"json"),Ou()()),a&2){let e=i.$implicit;VD(2),ug(Bw(3,1,e.context));}}function yo(a,i){a&1&&Hh(0,"tr",15);}function vo(a,i){a&1&&Hh(0,"tr",16);}function xo(a,i){if(a&1&&(zi$1(0,"table",1),Fu(1,3),kh(2,lo,2,0,"th",4)(3,co,2,1,"td",5),Lu(),Fu(4,6),kh(5,mo,2,0,"th",4)(6,po,2,1,"td",5),Lu(),Fu(7,7),kh(8,uo,2,0,"th",4)(9,go,2,1,"td",5),Lu(),Fu(10,8),kh(11,ho,2,0,"th",4)(12,bo,2,1,"td",5),Lu(),Fu(13,9),kh(14,fo,2,0,"th",4)(15,_o,4,3,"td",5),Lu(),kh(16,yo,1,0,"tr",10)(17,vo,1,0,"tr",11),Ou()),a&2){let e=YI();Vh("dataSource",e.eventsLog()),VD(16),Vh("matHeaderRowDef",e.displayedColumns),VD(),Vh("matRowDefColumns",e.displayedColumns);}}function Co(a,i){a&1&&(zi$1(0,"div",2),Tw(1,"No events captured yet"),Ou());}var it=class a{hostComm=g(Xt);eventsLog=tn([]);displayedColumns=["time","action","surface","component","context"];constructor(){Jd(()=>{let i=this.hostComm.messageStream();if(i?.type===D.SEND_TO_SERVER){let e=i?.payload;if(e&&e.action){let t=e.action;if(typeof t=="string")try{t=JSON.parse(t);}catch{}if(t&&typeof t=="object"){let n=t,o=n.timestamp||i.timestamp,s={time:ge(o),action:n.name||"",surface:n.surfaceId||"",component:n.sourceComponentId||n.sourceComponent||"",context:n.context||n.contextParameters||null};mg(()=>{this.eventsLog.update(l=>{let u=[s,...l];return u.length>100&&(u.length=100),u});});}}}});}clearLogs(){this.eventsLog.set([]);}static \u0275fac=function(e){return new(e||a)};static \u0275cmp=hI({type:a,selectors:[["a2ui-composer-events"]],decls:3,vars:1,consts:[[1,"events-container"],["mat-table","",1,"mat-elevation-z1",3,"dataSource"],[1,"events-placeholder"],["matColumnDef","time"],["mat-header-cell","",4,"matHeaderCellDef"],["mat-cell","",4,"matCellDef"],["matColumnDef","action"],["matColumnDef","surface"],["matColumnDef","component"],["matColumnDef","context"],["mat-header-row","",4,"matHeaderRowDef"],["mat-row","","class","element-row",4,"matRowDef","matRowDefColumns"],["mat-header-cell",""],["mat-cell",""],[1,"context-preview"],["mat-header-row",""],["mat-row","",1,"element-row"]],template:function(e,t){e&1&&(zi$1(0,"div",0),FI(1,xo,18,3,"table",1)(2,Co,2,0,"div",2),Ou()),e&2&&(VD(),LI(t.eventsLog().length>0?1:2));},dependencies:[Ii$1,vi$1,ki$1,Fi$1,Si$1,bi$1,Ti$1,xi$1,Mi$1,Ei$1,Oi,RC],styles:["[_nghost-%COMP%]{display:block;height:100%;width:100%}.events-container[_ngcontent-%COMP%]{height:100%;width:100%;overflow:auto;box-sizing:border-box;padding:8px}.events-placeholder[_ngcontent-%COMP%]{display:flex;align-items:center;justify-content:center;height:100%;color:var(--mat-sys-on-surface-variant);font-size:14px}table[_ngcontent-%COMP%]{width:100%;background:var(--mat-sys-surface);border-radius:6px;overflow:hidden}table[_ngcontent-%COMP%]   th[_ngcontent-%COMP%]{font-weight:700;color:var(--mat-sys-on-surface-variant);font-size:12px}table[_ngcontent-%COMP%]   td[_ngcontent-%COMP%]{font-size:12px;color:var(--mat-sys-on-surface);vertical-align:middle}table[_ngcontent-%COMP%]   pre.context-preview[_ngcontent-%COMP%]{margin:0;font-family:monospace;font-size:11px;white-space:pre-wrap;background:var(--mat-sys-surface-container-lowest);padding:4px 8px;border-radius:4px;max-width:300px;overflow-x:auto}"]})};var wo=()=>["expandedDetail"];function Mo(a,i){a&1&&(zi$1(0,"th",13),Tw(1,"Time"),Ou());}function ko(a,i){if(a&1&&(zi$1(0,"td",14),Tw(1),Ou()),a&2){let e=i.$implicit;VD(),ug(e.time);}}function Do(a,i){a&1&&(zi$1(0,"th",13),Tw(1,"Level"),Ou());}function Po(a,i){if(a&1&&(zi$1(0,"td",14)(1,"span",15),Tw(2),Ou()()),a&2){let e=i.$implicit;VD(),hw(e.level),VD(),ug(e.level);}}function To(a,i){a&1&&(zi$1(0,"th",13),Tw(1,"Source"),Ou());}function So(a,i){if(a&1&&(zi$1(0,"td",14)(1,"span",16),Tw(2),Ou()()),a&2){let e=i.$implicit;VD(),hw(e.source),VD(),ug(e.source);}}function Eo(a,i){a&1&&(zi$1(0,"th",13),Tw(1,"Message"),Ou());}function Io(a,i){if(a&1){let e=qI();zi$1(0,"button",20),qh("click",function(n){Rd(e);let o=YI().$implicit;return YI(2).toggleRow(o),Od(n.stopPropagation())}),zi$1(1,"mat-icon",21),Tw(2),Ou()();}if(a&2){let e=YI().$implicit,t=YI(2);VD(2),ug(t.isRowExpanded(e)?"keyboard_arrow_up":"keyboard_arrow_down");}}function Oo(a,i){if(a&1&&(zi$1(0,"td",14)(1,"div",17)(2,"span",18),Tw(3),Ou(),FI(4,Io,3,1,"button",19),Ou()()),a&2){let e=i.$implicit;VD(3),ug(e.message),VD(),LI(e.stack?4:-1);}}function Ao(a,i){if(a&1&&(zi$1(0,"pre",23),Tw(1),Ou()),a&2){let e=YI().$implicit;VD(),ug(e.stack);}}function Ro(a,i){if(a&1&&(zi$1(0,"td",14)(1,"div",22),FI(2,Ao,2,1,"pre",23),Ou()()),a&2){let e=i.$implicit,t=YI(2);Bh("colspan",t.columnsToDisplay.length),VD(2),LI(e.stack?2:-1);}}function Lo(a,i){a&1&&Hh(0,"tr",24);}function Bo(a,i){if(a&1&&Hh(0,"tr",25),a&2){let e=i.dataIndex;Bh("data-row-index",e);}}function No(a,i){if(a&1&&Hh(0,"tr",26),a&2){let e=i.$implicit,t=YI(2);rg("expanded",t.isRowExpanded(e));}}function Fo(a,i){if(a&1&&(zi$1(0,"table",1),Fu(1,3),kh(2,Mo,2,0,"th",4)(3,ko,2,1,"td",5),Lu(),Fu(4,6),kh(5,Do,2,0,"th",4)(6,Po,3,3,"td",5),Lu(),Fu(7,7),kh(8,To,2,0,"th",4)(9,So,3,3,"td",5),Lu(),Fu(10,8),kh(11,Eo,2,0,"th",4)(12,Oo,5,2,"td",5),Lu(),Fu(13,9),kh(14,Ro,3,2,"td",5),Lu(),kh(15,Lo,1,0,"tr",10)(16,Bo,1,1,"tr",11)(17,No,1,2,"tr",12),Ou()),a&2){let e=YI();Vh("dataSource",e.errorsLog()),VD(15),Vh("matHeaderRowDef",e.columnsToDisplay),VD(),Vh("matRowDefColumns",e.columnsToDisplay),VD(),Vh("matRowDefColumns",kw(4,wo));}}function zo(a,i){a&1&&(zi$1(0,"div",2),Tw(1,"No errors captured yet"),Ou());}var ot=class a{hostComm=g(Xt);errorsLog=tn([]);columnsToDisplay=["time","level","source","message"];expandedRows=tn(new Set);constructor(){Jd(()=>{let i=this.hostComm.messageStream();if(!i)return;let e=i.payload;if(e){if(i.type===D.CONSOLE_LOG){let t=e.message||"",n=t.includes("Unhandled Rejection")||t.includes("Uncaught")||!!e.stack,o=n?"exception":"console",s=n?"error":e.level||"log",l={time:ge(i.timestamp),source:o,level:s,message:t,stack:e.stack||void 0};mg(()=>{this.errorsLog.update(u=>{let b=[l,...u];return b.length>100&&(b.length=100),b});});}else if(i.type===D.DATA_MODEL_CHANGE&&e.validationErrors){let t=e.validationErrors;if(Array.isArray(t)?t.length>0:typeof t=="object"&&t!==null?Object.keys(t).length>0:!!t){let o="";Array.isArray(t)?o=t.map(l=>typeof l=="string"?l:JSON.stringify(l)).join(", "):typeof t=="object"?o=JSON.stringify(t):o=String(t);let s={time:ge(i.timestamp),source:"validation",level:"error",message:o,stack:void 0};mg(()=>{this.errorsLog.update(l=>{let u=[s,...l];return u.length>100&&(u.length=100),u});});}}}});}toggleRow(i){this.expandedRows.update(e=>{let t=new Set(e);return t.has(i)?t.delete(i):t.add(i),t});}isRowExpanded(i){return this.expandedRows().has(i)}clearLogs(){this.errorsLog.set([]),this.expandedRows.set(new Set);}static \u0275fac=function(e){return new(e||a)};static \u0275cmp=hI({type:a,selectors:[["a2ui-composer-errors"]],decls:3,vars:1,consts:[[1,"errors-container"],["mat-table","","multiTemplateDataRows","",1,"mat-elevation-z1",3,"dataSource"],[1,"errors-placeholder"],["matColumnDef","time"],["mat-header-cell","",4,"matHeaderCellDef"],["mat-cell","",4,"matCellDef"],["matColumnDef","level"],["matColumnDef","source"],["matColumnDef","message"],["matColumnDef","expandedDetail"],["mat-header-row","",4,"matHeaderRowDef"],["mat-row","","class","element-row",4,"matRowDef","matRowDefColumns"],["mat-row","","class","detail-row",3,"expanded",4,"matRowDef","matRowDefColumns"],["mat-header-cell",""],["mat-cell",""],[1,"level-badge"],[1,"source-badge"],[1,"message-cell"],[1,"error-message-text"],["mat-icon-button","","aria-label","Toggle Stack Trace"],["mat-icon-button","","aria-label","Toggle Stack Trace",3,"click"],["aria-hidden","true"],[1,"element-detail"],[1,"stack-preview"],["mat-header-row",""],["mat-row","",1,"element-row"],["mat-row","",1,"detail-row"]],template:function(e,t){e&1&&(zi$1(0,"div",0),FI(1,Fo,18,5,"table",1)(2,zo,2,0,"div",2),Ou()),e&2&&(VD(),LI(t.errorsLog().length>0?1:2));},dependencies:[Ii$1,vi$1,ki$1,Fi$1,Si$1,bi$1,Ti$1,xi$1,Mi$1,Ei$1,Oi,wd,Uo$1,Gd,Hd],styles:["[_nghost-%COMP%]{display:block;height:100%;width:100%}.errors-container[_ngcontent-%COMP%]{height:100%;width:100%;overflow:auto;box-sizing:border-box;padding:2px 0 2px 8px}.errors-placeholder[_ngcontent-%COMP%]{display:flex;align-items:center;justify-content:center;height:100%;color:var(--mat-sys-on-surface-variant);font-size:14px}table[_ngcontent-%COMP%]{width:100%;background:var(--mat-sys-surface);border-radius:6px;overflow:hidden}table[_ngcontent-%COMP%]   th[_ngcontent-%COMP%]{font-weight:700;color:var(--mat-sys-on-surface-variant);font-size:12px}table[_ngcontent-%COMP%]   td[_ngcontent-%COMP%]{font-size:12px;color:var(--mat-sys-on-surface);vertical-align:middle}table[_ngcontent-%COMP%]   .source-badge[_ngcontent-%COMP%]{padding:2px 6px;border-radius:4px;font-size:10px;font-weight:700;text-transform:uppercase}table[_ngcontent-%COMP%]   .source-badge.exception[_ngcontent-%COMP%]{background-color:#ffdad6;color:#ba1a1a}table[_ngcontent-%COMP%]   .source-badge.console[_ngcontent-%COMP%]{background-color:#ffe082;color:#ff8f00}table[_ngcontent-%COMP%]   .source-badge.validation[_ngcontent-%COMP%]{background-color:#e8f5e9;color:#2e7d32}table[_ngcontent-%COMP%]   .level-badge[_ngcontent-%COMP%]{padding:2px 6px;border-radius:4px;font-size:10px;font-weight:700;text-transform:uppercase}table[_ngcontent-%COMP%]   .level-badge.error[_ngcontent-%COMP%]{background-color:#ffdad6;color:#ba1a1a}table[_ngcontent-%COMP%]   .level-badge.warn[_ngcontent-%COMP%]{background-color:#ffe082;color:#ff8f00}table[_ngcontent-%COMP%]   .level-badge.info[_ngcontent-%COMP%]{background-color:#e8f0fe;color:#1a73e8}table[_ngcontent-%COMP%]   .level-badge.debug[_ngcontent-%COMP%], table[_ngcontent-%COMP%]   .level-badge.log[_ngcontent-%COMP%]{background-color:#f1f3f4;color:#5f6368}table[_ngcontent-%COMP%]   .message-cell[_ngcontent-%COMP%]{display:flex;align-items:center;justify-content:space-between;gap:8px;width:100%}table[_ngcontent-%COMP%]   .message-cell[_ngcontent-%COMP%]   .error-message-text[_ngcontent-%COMP%]{flex:1;white-space:normal;word-break:break-word}table[_ngcontent-%COMP%]   .message-cell[_ngcontent-%COMP%]   button[_ngcontent-%COMP%]{width:28px;height:28px;line-height:28px}table[_ngcontent-%COMP%]   .message-cell[_ngcontent-%COMP%]   button[_ngcontent-%COMP%]     .mat-mdc-button-touch-target{display:none}table[_ngcontent-%COMP%]   .message-cell[_ngcontent-%COMP%]   button[_ngcontent-%COMP%]   mat-icon[_ngcontent-%COMP%]{font-size:18px;width:18px;height:18px}table[_ngcontent-%COMP%]   .detail-row[_ngcontent-%COMP%]{height:0;display:none}table[_ngcontent-%COMP%]   .detail-row.expanded[_ngcontent-%COMP%]{display:table-row;height:auto}table[_ngcontent-%COMP%]   .detail-row[_ngcontent-%COMP%]   td[_ngcontent-%COMP%]{border-bottom-width:0;padding:0}table[_ngcontent-%COMP%]   .element-detail[_ngcontent-%COMP%]{overflow:hidden;box-sizing:border-box;background:var(--mat-sys-surface-container-lowest)}table[_ngcontent-%COMP%]   .element-detail[_ngcontent-%COMP%]   pre.stack-preview[_ngcontent-%COMP%]{margin:8px;font-family:monospace;font-size:11px;white-space:pre-wrap;word-break:break-all;color:var(--mat-sys-error);padding:8px;border-left:3px solid var(--mat-sys-error);background:#ba1a1a0d;border-radius:0 4px 4px 0}"]})};var ei=new T("CdkAccordion");var ti=(()=>{class a{accordion=g(ei,{optional:true,skipSelf:true});_changeDetectorRef=g(gC);_expansionDispatcher=g(H$1);_openCloseAllSubscription=H.EMPTY;closed=new We;opened=new We;destroyed=new We;expandedChange=new We;id=g(Cn).getId("cdk-accordion-child-");get expanded(){return this._expanded}set expanded(e){if(this._expanded!==e){if(this._expanded=e,this.expandedChange.emit(e),e){this.opened.emit();let t=this.accordion?this.accordion.id:this.id;this._expansionDispatcher.notify(this.id,t);}else this.closed.emit();this._changeDetectorRef.markForCheck();}}_expanded=false;get disabled(){return this._disabled()}set disabled(e){this._disabled.set(e);}_disabled=tn(false);_removeUniqueSelectionListener=()=>{};ngOnInit(){this._removeUniqueSelectionListener=this._expansionDispatcher.listen((e,t)=>{this.accordion&&!this.accordion.multi&&this.accordion.id===t&&this.id!==e&&(this.expanded=false);}),this.accordion&&(this._openCloseAllSubscription=this._subscribeToOpenCloseAllActions());}ngOnDestroy(){this.opened.complete(),this.closed.complete(),this.destroyed.emit(),this.destroyed.complete(),this._removeUniqueSelectionListener(),this._openCloseAllSubscription.unsubscribe();}toggle(){this.disabled||(this.expanded=!this.expanded);}close(){this.disabled||(this.expanded=false);}open(){this.disabled||(this.expanded=true);}_subscribeToOpenCloseAllActions(){return this.accordion._openCloseAllActions.subscribe(e=>{this.disabled||(this.expanded=e);})}static \u0275fac=function(t){return new(t||a)};static \u0275dir=_u({type:a,selectors:[["cdk-accordion-item"],["","cdkAccordionItem",""]],inputs:{expanded:[2,"expanded","expanded",x1],disabled:[2,"disabled","disabled",x1]},outputs:{closed:"closed",opened:"opened",destroyed:"destroyed",expandedChange:"expandedChange"},exportAs:["cdkAccordionItem"],features:[Ow([{provide:ei,useValue:void 0}])]})}return a})(),ni=(()=>{class a{static \u0275fac=function(t){return new(t||a)};static \u0275mod=os({type:a});static \u0275inj=Dr$1({})}return a})();var Ho=["body"],jo=["bodyWrapper"],Vo=[[["mat-expansion-panel-header"]],"*",[["mat-action-row"]]],Wo=["mat-expansion-panel-header","*","mat-action-row"];function Go(a,i){}var Jo=[[["mat-panel-title"]],[["mat-panel-description"]],"*"],Uo=["mat-panel-title","mat-panel-description","*"];function Qo(a,i){a&1&&(ku(0,"span",1),Gd$1(),ku(1,"svg",2),Uh(2,"path",3),Pu()());}var ai=new T("MAT_ACCORDION"),ii=new T("MAT_EXPANSION_PANEL"),$o=(()=>{class a{_template=g(zn$1);_expansionPanel=g(ii,{optional:true});static \u0275fac=function(t){return new(t||a)};static \u0275dir=_u({type:a,selectors:[["ng-template","matExpansionPanelContent",""]]})}return a})(),oi=new T("MAT_EXPANSION_PANEL_DEFAULT_OPTIONS"),An=(()=>{class a extends ti{_viewContainerRef=g(Kn);_animationsDisabled=xe();_document=g(W);_ngZone=g(K);_elementRef=g(Yn);_renderer=g(ah);_cleanupTransitionEnd;get hideToggle(){return this._hideToggle||this.accordion&&this.accordion.hideToggle}set hideToggle(e){this._hideToggle=e;}_hideToggle=false;get togglePosition(){return this._togglePosition||this.accordion&&this.accordion.togglePosition}set togglePosition(e){this._togglePosition=e;}_togglePosition;afterExpand=new We;afterCollapse=new We;_inputChanges=new ee;accordion=g(ai,{optional:true,skipSelf:true});_lazyContent;_body;_bodyWrapper;_portal;_headerId=g(Cn).getId("mat-expansion-panel-header-");constructor(){super();let e=g(oi,{optional:true});this._expansionDispatcher=g(H$1),e&&(this.hideToggle=e.hideToggle);}_hasSpacing(){return this.accordion?this.expanded&&this.accordion.displayMode==="default":false}_getExpandedState(){return this.expanded?"expanded":"collapsed"}toggle(){this.expanded=!this.expanded;}close(){this.expanded=false;}open(){this.expanded=true;}ngAfterContentInit(){this._lazyContent&&this._lazyContent._expansionPanel===this&&this.opened.pipe(ey(null),Vt(()=>this.expanded&&!this._portal),Tn$1(1)).subscribe(()=>{this._portal=new B(this._lazyContent._template,this._viewContainerRef);}),this._setupAnimationEvents();}ngOnChanges(e){this._inputChanges.next(e);}ngOnDestroy(){super.ngOnDestroy(),this._cleanupTransitionEnd?.(),this._inputChanges.complete();}_containsFocus(){if(this._body){let e=this._document.activeElement,t=this._body.nativeElement;return e===t||t.contains(e)}return  false}_transitionEndListener=({target:e,propertyName:t})=>{e===this._bodyWrapper?.nativeElement&&t==="grid-template-rows"&&this._ngZone.run(()=>{this.expanded?this.afterExpand.emit():this.afterCollapse.emit();});};_setupAnimationEvents(){this._ngZone.runOutsideAngular(()=>{this._animationsDisabled?(this.opened.subscribe(()=>this._ngZone.run(()=>this.afterExpand.emit())),this.closed.subscribe(()=>this._ngZone.run(()=>this.afterCollapse.emit()))):setTimeout(()=>{let e=this._elementRef.nativeElement;this._cleanupTransitionEnd=this._renderer.listen(e,"transitionend",this._transitionEndListener),e.classList.add("mat-expansion-panel-animations-enabled");},200);});}static \u0275fac=function(t){return new(t||a)};static \u0275cmp=hI({type:a,selectors:[["mat-expansion-panel"]],contentQueries:function(t,n,o){if(t&1&&Qh(o,$o,5),t&2){let s;ew(s=tw())&&(n._lazyContent=s.first);}},viewQuery:function(t,n){if(t&1&&Kh(Ho,5)(jo,5),t&2){let o;ew(o=tw())&&(n._body=o.first),ew(o=tw())&&(n._bodyWrapper=o.first);}},hostAttrs:[1,"mat-expansion-panel"],hostVars:4,hostBindings:function(t,n){t&2&&rg("mat-expanded",n.expanded)("mat-expansion-panel-spacing",n._hasSpacing());},inputs:{hideToggle:[2,"hideToggle","hideToggle",x1],togglePosition:"togglePosition"},outputs:{afterExpand:"afterExpand",afterCollapse:"afterCollapse"},exportAs:["matExpansionPanel"],features:[Ow([{provide:ai,useValue:void 0},{provide:ii,useExisting:a}]),Rh,$c],ngContentSelectors:Wo,decls:9,vars:4,consts:[["bodyWrapper",""],["body",""],[1,"mat-expansion-panel-content-wrapper"],["role","region",1,"mat-expansion-panel-content",3,"id"],[1,"mat-expansion-panel-body"],[3,"cdkPortalOutlet"]],template:function(t,n){t&1&&(KI(Vo),XI(0),zi$1(1,"div",2,0)(3,"div",3,1)(5,"div",4),XI(6,1),kh(7,Go,0,0,"ng-template",5),Ou(),XI(8,2),Ou()()),t&2&&(VD(),Bh("inert",n.expanded?null:""),VD(2),Vh("id",n.id),Bh("aria-labelledby",n._headerId),VD(4),Vh("cdkPortalOutlet",n._portal));},dependencies:[Ye],styles:[`.mat-expansion-panel {
...
`],encapsulation:2,changeDetection:1})}return a})(),Fn=class{index;tab};function Ln(a){let i=a+"";return /^\d+$/.test(i)?a+"ms":i}var bi=(()=>{class a{static \u0275fac=function(t){return new(t||a)};static \u0275mod=os({type:a});static \u0275inj=Dr$1({imports:[Se]})}return a})();var Ir=new T("MAT_BADGE_CONFIG"),fi="mat-badge-content",Or=(()=>{class a{static \u0275fac=function(t){return new(t||a)};static \u0275cmp=hI({type:a,selectors:[["ng-component"]],decls:0,vars:0,template:function(t,n){},styles:[`.mat-badge {
  position: relative;
}
.mat-badge.mat-badge {
  overflow: visible;
