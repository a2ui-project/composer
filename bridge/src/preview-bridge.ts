...
export class PreviewBridge {
  ...
  private async resolveCatalog(renderer: ActiveRenderer | null): Promise<{
    ...
    if (!this.isListening || this.activeRenderer !== renderer) return null;
  ...
  private async handleGetCatalog(): Promise<void> {
    ...
    try {
      ...
      if (!this.isListening || this.activeRenderer !== renderer || !resolved) return;
      ...
      if (!this.isListening || this.activeRenderer !== renderer) return;
