import {f,n as ne$1,au as Mv,I as K$1,i as qa,r as Q,Y,be as dh,t as st,bf as MG,bg as yr,bh as rt,e as ue,bi as fh,ba as De,z as io,A as Ae,B as Tt,j as He,a3 as vf,S as St,bj as mf,m as $e,v as vi,o as bi,k as wt,aV as y,E as rv,G as Ya,K as Ka,bk as gb,bl as Bb,bm as aW,Q as Qy,bb as wi,x as U,bn as Dc,bo as Bi,J,b7 as R,bp as Ct,bq as Ec,d as O,q,aj as S,br as W,ak as ce$1,al as oe$1,bs as _l,aT as P,a8 as tc,a$ as an,bt as In,aw as Ut$1,bu as Se,bv as Xt$1,aW as Zt$1,bw as ur,bx as vo,by as sn,ae as zn,bz as vl,aC as tS,at as oS,bA as aE,bB as V,bC as We,bD as Fb,bE as ah,bF as Ui,aD as tm,aE as nm}from'./main.js';import {h}from'./chunk-BHstN4fR.js';var Ft=class n{trackingService=f(ne$1);a2uiComposerTrackEvent=Mv.required();a2uiComposerTrackParams=Mv();onClick(){let v=this.a2uiComposerTrackEvent(),t=this.a2uiComposerTrackParams();v&&typeof this.trackingService[v]=="function"&&this.trackingService[v](t);}static \u0275fac=function(t){return new(t||n)};static \u0275dir=K$1({type:n,selectors:[["","a2uiComposerTrackEvent",""]],hostBindings:function(t,e){t&1&&qa("click",function(){return e.onClick()});},inputs:{a2uiComposerTrackEvent:[1,"a2uiComposerTrackEvent"],a2uiComposerTrackParams:[1,"a2uiComposerTrackParams"]}})};var Ot=(()=>{class n{static \u0275fac=function(e){return new(e||n)};static \u0275mod=Q({type:n});static \u0275inj=Y({imports:[st]})}return n})();var Vt=["*"],Nt=`.mdc-list {
  margin: 0;
  padding: 8px 0;
