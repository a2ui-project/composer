import {o as ot,I as It,z as zt,q as qt,V as Vt}from'./chunk-CbzCrFyO.js';import {Q as Qe,e as eC,I as Is,g,E as Es,C as Cs,W,c as cf,w as wI,s as sr,N as Nt,a as Co,Z as Zi,K as Kh,k as kw,V as Vu,z as zh,G as GI,b as GD,$ as $h,d as Gh,f as zu,h as fg,i as sg,U as Uw,j as zI,l as N,m as as,D as Dr,n as Zn,o as sw,p as aw,q as Cw,J as Jh,u as uw,r as lw,t as K,v as re$1,x as Qn,y as ph,A as w,B as ee$1,F as ry,L,H as ED,O as Ou,M as bC,P as Hu,X as Xh,R as Uu,S as eg}from'./main.js';import {M as Me,W as Wt$1,C as Ce,A as At,l as li,d as di,s as si,n as ne$1}from'./chunk-BDXooWr3.js';import {j,P}from'./chunk-DMkFCjSt.js';import {i as io,G as Gt$1,b as bd,h as hd,L as Lo,a as Ld,V as Vd,R,e as ec,f as fn,B as Bo,A as At$1,I as Ie,c as Ic,m as mn,H as Hi,x as xe,C as Co$1}from'./chunk-BmEFlPUu.js';var Qt=["*",[["mat-toolbar-row"]]],Zt=["*","mat-toolbar-row"],Wt=(()=>{class o{static \u0275fac=function(e){return new(e||o)};static \u0275dir=Ou({type:o,selectors:[["mat-toolbar-row"]],hostAttrs:[1,"mat-toolbar-row"],exportAs:["matToolbarRow"]})}return o})(),Gt=(()=>{class o{_elementRef=g(Zn);_platform=g(R);_document=g(W);color;_toolbarRows;ngAfterViewInit(){this._platform.isBrowser&&(this._checkToolbarMixedModes(),this._toolbarRows.changes.subscribe(()=>this._checkToolbarMixedModes()));}_checkToolbarMixedModes(){this._toolbarRows.length;}static \u0275fac=function(e){return new(e||o)};static \u0275cmp=wI({type:o,selectors:[["mat-toolbar"]],contentQueries:function(e,i,n){if(e&1&&Jh(n,Wt,5),e&2){let s;uw(s=lw())&&(i._toolbarRows=s);}},hostAttrs:[1,"mat-toolbar"],hostVars:6,hostBindings:function(e,i){e&2&&(Cw(i.color?"mat-"+i.color:""),sg("mat-toolbar-multiple-rows",i._toolbarRows.length>0)("mat-toolbar-single-row",i._toolbarRows.length===0));},inputs:{color:"color"},exportAs:["matToolbar"],ngContentSelectors:Zt,decls:2,vars:0,template:function(e,i){e&1&&(sw(Qt),aw(0),aw(1,1));},styles:[`.mat-toolbar {
