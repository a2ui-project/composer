import {o as ot,I as It,z as zt$1,q as qt$1,V as Vt}from'./chunk-Cdtm7uZd.js';import {V as Vw,g,h as hs,a as gs,W,X as Xd,u as uI,e as er,x as xn,U as UI,$ as $i,H as Hh,I as Iw,R as Ru,P as Ph,b as RD,k as kh,L as Lu,O as Oh,n as ng,N,c as ns,m as mr,q as qn,d as qI,Z as ZI,l as lw,Q as Qh,f as $h,i as QI,K as KI,j as K,r as re,Y as Yn,o as rh,T,p as ee$1,s as Wm,t as L,v as cD,w as Tu,y as lC,z as Ou,A as Uh,B as ku,C as zh,D as xd,J as JI,E as Rd}from'./main.js';import {M as Me,W as Wt$1,C as Ce,A as At,l as li,d as di,s as si}from'./chunk-C3RO6YYP.js';import {j,P}from'./chunk-DnVRgn41.js';import {l as lo,Y as Yt$1,D as Dd,S as Sd,H as Ho,Z as Zd,a as Yd,R,m as mc,_ as _n,$ as $o,b as Dt,x as xe,V as Vc,c as bn,K as Kr,d as Se,e as Do}from'./chunk-DqaqL8N7.js';var Gt=["*",[["mat-toolbar-row"]]],Ut=["*","mat-toolbar-row"],$t=(()=>{class o{static \u0275fac=function(e){return new(e||o)};static \u0275dir=Tu({type:o,selectors:[["mat-toolbar-row"]],hostAttrs:[1,"mat-toolbar-row"],exportAs:["matToolbarRow"]})}return o})(),jt=(()=>{class o{_elementRef=g(qn);_platform=g(R);_document=g(W);color;_toolbarRows;ngAfterViewInit(){this._platform.isBrowser&&(this._checkToolbarMixedModes(),this._toolbarRows.changes.subscribe(()=>this._checkToolbarMixedModes()));}_checkToolbarMixedModes(){this._toolbarRows.length;}static \u0275fac=function(e){return new(e||o)};static \u0275cmp=uI({type:o,selectors:[["mat-toolbar"]],contentQueries:function(e,i,n){if(e&1&&$h(n,$t,5),e&2){let s;QI(s=KI())&&(i._toolbarRows=s);}},hostAttrs:[1,"mat-toolbar"],hostVars:6,hostBindings:function(e,i){e&2&&(lw(i.color?"mat-"+i.color:""),Qh("mat-toolbar-multiple-rows",i._toolbarRows.length>0)("mat-toolbar-single-row",i._toolbarRows.length===0));},inputs:{color:"color"},exportAs:["matToolbar"],ngContentSelectors:Ut,decls:2,vars:0,template:function(e,i){e&1&&(qI(Gt),ZI(0),ZI(1,1));},styles:[`.mat-toolbar {
