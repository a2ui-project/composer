...
The defect is tracked upstream in [a2ui#1307](https://github.com/a2ui-project/a2ui/issues/1307). The proposed package-level repair is [a2ui#2639](https://github.com/a2ui-project/a2ui/pull/2639); as of September 18, 2026 it has not been merged or released. Composer needs that fix in a compatible official release (a 0.10.x backport would avoid an unrelated web_core migration) before this temporary patch can be removed. The upstream dependency remains open; this patch is not the long-term fix.
